...
- Implemented foundation: reusable Pi protocol client, browser-safe surface client, and
  ...
  through the existing encrypted relay allowlist. Protocol v6 now projects Pi session trees,
...
- Implemented protocol v6 recovery capability discovery, unrestricted scoped plugin settings, and
  extension-owned JSON configuration documents. Pi-native conversation rollback preserves
