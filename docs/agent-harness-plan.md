...
阶段 Q、D-296 旧 companion 清理及 D-303 本机实验/协作收口已完成。下一步按 **7G → 7H → 7I** 推进
请求前上下文、工具并行/长任务、受管远程/多机器执行。D-304 明确自然生长实验与按需运维角色，Slurm 暂缓；
...
受管远程、多目标资源与批量便利操作排在 7G/7H 之后，由独立 7I 接续，不把原生集群或未做完的测试矩阵作为本机交付门槛。
...
D-303 已收口本机生产链。D-304 调整后，以下远程/多目标余项转入 7G、7H 之后的 7I；Slurm 不在当前范围。
...
不阻断已完善的本机代码/功能交付；受管远程余项按 7I 单独交付，Slurm 暂不实施。

后续顺序固定为 **7G → 7H → 7I**；各阶段只声明实际接线，不用后续目标追溯扩大 D-303 的验收范围。

**7G：请求前上下文统一准备与完整实时现状表（D-301，D-303 之后）。**

状态：设计已接受，尚未实施/验收。D-303 本机与协作返工已收口；本阶段在其成果上实施。
...
状态：2026-09-20 设计已接受，尚未实施/验收。本阶段接在 7G 之后，
...
状态：2026-09-20 设计已接受，尚未实施。接在 7G 的请求前上下文和 7H 的工具/长任务之后，承接 7D 的远程余项。
...
以下按 D-304 调整当前功能范围；D-301 / 7G、D-302 / 7H 与 D-304 / 7I 单独按 7.11 交付，
...
- 本机纵切按 D-303 收口；7I 接通受管远程、多机器资源、取消/重连与产物路径，能力如实显示，Slurm 留待明确需求；
