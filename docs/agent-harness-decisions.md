...
| D-161 | planned（3.15/3.16 联合设计采纳：arrival/assessment/purpose、focusRanges、文件级 RRF 限读取调度、重排替掉 windowScore、三类身份、生命周期轴、捕获时 overlay；四片串行；起点修正：embedding.ts 七家适配器已有、AFT 切块是反例、.tdb 单维度） | — | 设计 6.1 / 7.1 / 8.5；plan 3.15④ / 3.16 |
