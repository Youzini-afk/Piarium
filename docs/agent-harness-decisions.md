...
���ͣ�ƫ��
������TriviumDB TQL ��ѯ�﷨�� v0.8.5 �ϲ��ȶ���FIND �﷨���ַ���/����������������һ�£�WHERE �Ӿ䱨����ת�����󣩡�֪ʶ�� store.ts ���� `allNodeIds()` + `getPayload()` �� JS ����ˣ���ʹ�� TQL��
ԭ��TQL �� `FIND {type: "block", sessionId: "s1"} RETURN *` �� "Failed to convert napi value String into rust type `f64`" ����˵�� TQL �������� payload �ֶ������ƶ��� bug��JS �������Ȼ�ڴ����ݼ��Ͻ��������׶� 2 �����ݹ�ģ�����Ự���� event����ȫ�ɽ��ܡ�
���ǹ��������(1) �޸� TriviumDB �� TQL ������������ͬһά���ߵ���Ŀ�������ȼ������ƽ��׶� 2��(2) �� `tql` �� MATCH �﷨����ͬ�����ȶ���
Ӱ�죺`packages/web/application-host/lib/knowledge/store.ts`��scanNodes ��������������� TQL ��ѯ����������createIndex/createOrderedIndex���Դ��������� JS ��ʹ�ã�������δ�� TQL �޸������á�
״̬����ʵʩ

### D-020 �� 2026-09-03 �� 2.1
���ͣ�ƫ��
������ռλ����ģʽ�� `recall` ��ʹ�� `searchHybrid`����Ϊ JS ��ɨ�� accepted knowledge �ڵ� + �򵥴���ƥ�����֡�`searchHybrid` ��ȫ�������� v0.8.5 �Ϸ��ؿս�����������ƶ�Ϊ 0/NaN����
ԭ�򣺼ƻ�Ҫ��"ʵʩǰ���� TriviumDB ����֤ȫ�������� search ������"������֤���ֲ����������ؿս�����޷������ٻء�JS �����ƥ����Ȼ�ֲڣ�������׶� 2 �Ļ������󣨰� trigger/content ƥ�䣩��
���ǹ��������(1) �õ�λ����ռλ����������������ƶȣ�(2) ֻ�� TQL �ı���ѯ����TQL ���ȶ����� D-019����
Ӱ�죺`packages/web/application-host/lib/knowledge/store.ts`��recall ������ `!embedding` ��֧��Ϊ JS ɨ�裩��embedding ģʽ��ʹ�� `searchHybrid`��
״̬����ʵʩ

### D-021 �� 2026-09-03 �� 3b.3
���ͣ�ƫ��
�������� `FOUNDATIONAL_PI_PACKAGE_MANIFEST` �Ƴ� `@gotgenes/pi-permission-system`��revision 2��3���������� `FoundationalPiPackageId` ���������е� `"permission-system"` ���������Ա��Ѱ�װʵ����״̬����������ȷ���롣
ԭ�򣺼ƻ�Ҫ��"�Ѱ�װʵ����ɾ��Ǩ"������������������ protocol ���ѷ����ܴ����ɿ����е� permission-system ��Ŀ���������Զ� provision��
���ǹ��������(1) ��ȫ�Ƴ����͡����ᵼ�¾ɿ��շ����л�ʧ�ܣ�(2) ���� manifest ��Ŀ����� deprecated����manifest �� `as const` ������չ��
Ӱ�죺`packages/protocol/src/foundational-pi-packages.ts`��manifest revision 3��IDS ����ֻ�� mcp����`packages/protocol/test/foundational-pi-packages.test.ts`�����¶��ԣ���`packages/runtime-broker/test/foundational-package-provisioner.test.ts`���Ƴ� permission-system ��ز�����������
״̬����ʵʩ
