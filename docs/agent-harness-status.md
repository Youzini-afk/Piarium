...
顺序见 plan 0.7；D-082–D-086 已完成窗口 snapshot 到 explore/grep/read/find/ls、持久线程基线及显式 ignored 结果范围，下一步是带正文 revision 的隔离 LSP/符号来源。
以下区分已接线行为与仍缺证据。
