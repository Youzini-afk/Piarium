...
turn trusted extensions into a complete sandbox. Read the [security policy](SECURITY.md) and
...
Before contributing, read [CONTRIBUTING.md](CONTRIBUTING.md) and the repository-specific rules in
[AGENTS.md](AGENTS.md).
