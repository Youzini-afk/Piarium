---
name: theme-system
description: Use when creating or modifying Piarium UI components, styling, colors, buttons, visual states, themes, or icons.
---
...
- Use semantic Piarium theme tokens; never hardcode hex colors or generic Tailwind palette colors.
