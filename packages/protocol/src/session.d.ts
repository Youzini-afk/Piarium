...
export declare const PIARIUM_RECOVERY_NAVIGATION_MARKER_SCHEMA_VERSION: 1;
export declare const PIARIUM_RECOVERY_NAVIGATION_MARKER_TYPE = "piarium.recovery.navigation/v1";
...
export type PiMessage = PiUserMessage | PiAssistantMessage | PiToolResultMessage | PiBashExecutionMessage | PiCustomMessage | PiBranchSummaryMessage | PiCompactionSummaryMessage | PiUnknownMessage;
...
export type PiSessionEntry = PiSessionMessageEntry | PiThinkingLevelChangeEntry | PiModelChangeEntry | PiCompactionEntry | PiBranchSummaryEntry | PiCustomEntry | PiCustomMessageEntry | PiLabelEntry | PiSessionInfoEntry | PiUnknownSessionEntry;
...
export type PiAgentEvent = ({
    ...
    message: PiMessage;
    type: "message_update";
    update: PiAssistantStreamUpdate;
} | {
    message: PiMessage;
    type: "message_end";
} | {
