...
export declare const PIARIUM_PROTOCOL_VERSION: 1;
...
export type RuntimeSourceKind = "bundled" | "system" | "standalone" | "custom" | "development" | "source";
export type PiRuntimeInstallationSource = "bundled" | "system" | "standalone" | "custom" | "development";
...
export type PiRuntimeManagerStatus = "discovering" | "missing" | "installing" | "probing" | "ready" | "upgrade-required" | "upgrading" | "failed";
export declare const PI_RUNTIME_ISSUE_HOST_ENTRY_UNAVAILABLE: "host-entry-unavailable";
export declare const PI_RUNTIME_ISSUE_CODES: readonly ["host-entry-unavailable"];
...
export declare const RUNTIME_SOURCE_KINDS: readonly ["bundled", "system", "standalone", "custom", "development", "source"];
...
export type PiAgentKind = "delegatable" | "internal" | "primary" | "profile" | "service" | "workflow";
export type PiAgentStatus = "available" | "disabled" | "error" | "unavailable" | "unconfigured";
...
export type RecoveryAction = "navigate" | "undo" | "redo" | "checkpoint" | "repair" | "repair-typo" | "repair-destructive";
...
export type ExtensionUiMethod = "select" | "confirm" | "input" | "editor" | "custom" | "notify" | "setStatus" | "setWidget" | "setTitle" | "setEditorText" | "setWorkingMessage" | "setWorkingVisible" | "setWorkingIndicator" | "setHiddenThinkingLabel";
...
export type PiConfigTextAuthorityId = "aft-user" | "hermes-memory-user" | "pi-lens-global" | "pi-lens-project";
