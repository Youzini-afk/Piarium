...
| `related.query` | `{ anchor }` | file-level defines / imports / importers / connection endpoints + source status | Symbol-graph topology for a path or name; not `lsp.references` |
