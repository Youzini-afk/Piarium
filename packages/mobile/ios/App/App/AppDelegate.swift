...
class BridgeViewController: CAPBridgeViewController {
    override func capacitorDidLoad() {
        ...
        let source = "window.__VARIN_APNS_ENV__ = '\(apnsEnvironment)';"
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private static let widgetAppGroup = "group.dev.varin.mobile"
    private static let widgetSnapshotKey = "widgetSnapshot"

    /// Pulls the session overview JSON from the web layer (window.__VARIN_WIDGET_SNAPSHOT__),
    ...
    private func writeWidgetSnapshot() {
        ...
        let js = "(typeof window.__VARIN_WIDGET_SNAPSHOT__ === 'function') ? window.__VARIN_WIDGET_SNAPSHOT__() : null"
