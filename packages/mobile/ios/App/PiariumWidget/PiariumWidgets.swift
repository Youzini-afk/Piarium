...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Piarium")
...
@main
struct PiariumWidgetBundle: WidgetBundle {
