...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Varin")
...
@main
struct VarinWidgetBundle: WidgetBundle {
