...
Desactiva la compresión de respuestas de la API si vale `true` o `1`. Tiene prioridad sobre `PIARIUM_COMPRESS_API`.
...
Override alternativo para el ejecutable de Git. Para ajustes específicos de OpenChamber, prefiere `PIARIUM_GIT_BINARY`.
