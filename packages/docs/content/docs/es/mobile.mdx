...
description: Instala la app de Varin en iOS o Android y conéctala a tu servidor.
---

# Apps móviles y PWA

Varin tiene apps nativas para iPhone y Android, para que puedas seguir sesiones, responder a los agentes y gestionar el trabajo desde tu teléfono, en casa por Wi-Fi o desde cualquier lugar a través del [Private Relay](/es/private-relay/).

## Instala la app

- **iPhone/iPad** — únete a la [beta de TestFlight](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — el APK de Varin aún no está publicado; usa la PWA o compílalo desde el código fuente.

## Conéctala a tu servidor

1. En la computadora donde se ejecuta Varin, abre **Settings → Remote Instances → Conectarse a este servidor** y pulsa **Añadir un dispositivo**.
...
En **Settings → Varin**, unas cuantas opciones ajustan la experiencia móvil e instalada: el nombre de la app instalada, la orientación de la pantalla y el comportamiento del teclado en pantalla.
