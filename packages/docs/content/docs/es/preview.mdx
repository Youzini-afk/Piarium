...
description: Abre un servidor de desarrollo en marcha dentro de Piarium.
---

# Vista previa y servidores de desarrollo

Cuando inicias un servidor de desarrollo, Piarium puede abrirlo dentro de la propia app en lugar de en una pestaña de navegador aparte, para que veas tu sitio junto al chat, captures su consola y señales elementos para preguntar sobre ellos.

## Abre una vista previa

Piarium observa la salida de la terminal en busca de una dirección local (la línea `Local:` que imprimen herramientas como Vite, Next.js o Astro). Cuando detecta una:
