...
Una tarea programada ejecuta un prompt por ti según una programación; por ejemplo, un "resume los cambios de ayer" diario o una limpieza semanal. Cuando se ejecuta, Varin inicia una sesión nueva y envía el prompt por su cuenta. Abre el programador desde el botón en la parte superior de la barra lateral de sesiones.
...
Las tareas solo se disparan mientras el servidor de Varin está en funcionamiento. Si lo cierras, las ejecuciones programadas se pausan hasta que vuelva a estar activo.
