...
如果想安装现成的 skill 而不是自己编写，请参阅 [Skills 目录](/skills-catalog/)。
...
位于消息最开头的 `/` 会改为打开 [命令](/commands-snippets/)。

## 相关内容

- [Skills 目录](/skills-catalog/) — 安装他人发布的 skill
- [命令与代码片段](/commands-snippets/) — 在聊天中复用文本的其他方式
