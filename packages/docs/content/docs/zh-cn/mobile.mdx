---
title: 移动应用与 PWA
description: 在 iOS 或 Android 上安装 Varin 应用，并把它连接到你的服务器。
---

# 移动应用与 PWA

Varin 提供 iPhone 和 Android 原生应用，让你可以在手机上查看会话、回复代理并管理工作 — 在家通过 Wi-Fi，外出时通过 [Private Relay](/zh-cn/private-relay/)。

## 安装应用

- **iPhone/iPad** — 加入 [TestFlight 测试版](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — Varin APK 尚未发布；请使用 PWA 或从源码构建。

## 连接到你的服务器

1. 在运行 Varin 的电脑上，打开 **Settings → Remote Instances → 连接到此服务器**，然后按 **添加设备**。
...
在 **Settings → Varin** 下，有几个选项可以调整移动端和已安装应用的体验 — 应用的安装名称、屏幕方向，以及屏幕键盘的行为方式。
