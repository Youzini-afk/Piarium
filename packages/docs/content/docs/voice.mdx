---
title: 语音模式
description: 对 Piarium 说话，并听它朗读回复。
---

# 语音模式

语音模式让你可以口述消息，并让回复朗读给你听。在 **Settings → Piarium → Voice** 中开启它。
...
- [通知](/notifications/) — 改为收到提醒而不是聆听
- [提供商、模型与智能体](/providers/) — 你的 OpenAI 密钥可能已经存放在这里
