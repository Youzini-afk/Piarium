...
A project is a folder on your computer that Varin keeps track of — usually one codebase. Switching projects switches the folder the agent works in, along with that project's sessions and settings.
...
Point it at a folder and Varin remembers it. The name comes from the folder; you can change it later.
...
Open **Settings → Projects** to give a project a custom name, color, or icon. Varin tries to find an icon automatically — see [Project icons](/project-icons/).
