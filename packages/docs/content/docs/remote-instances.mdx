...
> Remote instances are a **desktop-only** feature. On the web, connect to a remote Piarium server with a [tunnel](/tunnels/), a [reverse proxy](/reverse-proxy/), or [pairing](/connect-devices/).
...
- [Tunnels](/tunnels/) — connect to a remote Piarium server on the web
