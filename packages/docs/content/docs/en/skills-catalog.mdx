...
For writing your own skills, see [Skills](/en/skills/).
...
If a skill with the same name already exists, Piarium asks what to do — skip it, overwrite it, or decide per skill.
...
- [Skills](/en/skills/) — create and manage installed skills
