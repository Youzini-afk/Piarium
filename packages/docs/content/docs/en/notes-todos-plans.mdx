...
- start a new [worktree session](/en/worktrees/) with it (only when the project is a git repo)
...
- [Worktree Sessions](/en/worktrees/) — run a todo in its own branch
- [Projects](/en/projects/) — these belong to the active project
