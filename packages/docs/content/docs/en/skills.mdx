...
To install ready-made skills instead of writing your own, see [Skills Catalog](/en/skills-catalog/).
...
A `/` at the very start of the message opens [commands](/en/commands-snippets/) instead.

## Related

- [Skills Catalog](/en/skills-catalog/) — install skills others have published
- [Commands & Snippets](/en/commands-snippets/) — other ways to reuse text in chat
