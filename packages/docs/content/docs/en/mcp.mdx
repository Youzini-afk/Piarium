...
2. Add a server and choose its type:
   - **local** — Piarium runs a command on your machine. You give it the command to run and, if needed, environment variables.
   - **remote** — Piarium connects to a URL someone else hosts. You give it the URL and any headers it needs (for example an auth token).
...
- [Providers, Models & Agents](/en/providers/) — connect a model first
- [Skills](/en/skills/) — another way to extend what agents can do
