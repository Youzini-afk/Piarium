...
Notifications tell you when something needs your attention so you don't have to watch the screen — a session finished, hit an error, asked a question, or needs permission to do something. Set them up at **Settings → Piarium → Notifications**.

## Turn them on

1. Open **Settings → Piarium → Notifications**.
...
- [Voice Mode](/en/voice/) — hear replies read aloud instead
