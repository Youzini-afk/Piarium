---
title: Voice Mode
description: Speak to Piarium and hear replies read aloud.
---

# Voice Mode

Voice mode lets you dictate messages and have replies read back to you. Turn it on at **Settings → Piarium → Voice**.
...
- [Notifications](/en/notifications/) — get pinged instead of listening
- [Providers, Models & Agents](/en/providers/) — where your OpenAI key may already live
