...
You can import identities Piarium discovers from your existing git credentials and save them as token identities.

## Related

- [Git & GitHub Workflows](/en/git/) — commit using the identity you set
- [GitHub Issues & PRs](/en/github/) — connect a GitHub account for PRs
