...
worktree는 폴더가 사라졌거나, 브랜치가 detached 상태이거나, 병합 또는 리베이스가 절반만 끝난 경우 주의가 필요할 수 있습니다. Piarium가 이를 표시하여 고칠 수 있게 합니다. [Worktree 및 Git](/ko/troubleshooting/worktrees-git/)을 참고하세요.

## 관련 항목

- [Multi-run](/ko/multi-run/) — 여러 worktree 세션을 한 번에 시작하세요
- [Git 및 GitHub 워크플로](/ko/git/) — Piarium 안에서 커밋하고 통합하세요
