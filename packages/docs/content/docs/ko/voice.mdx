---
title: 음성 모드
description: Piarium에 말하고 응답을 소리내어 들으세요.
---

# 음성 모드

음성 모드를 사용하면 메시지를 받아쓰게 하고 응답을 소리내어 들을 수 있습니다. **Settings → Piarium → Voice**에서 켭니다.
...
- [알림](/ko/notifications/) — 듣는 대신 알림을 받으세요
- [공급자, 모델, 에이전트](/ko/providers/) — OpenAI 키가 이미 저장되어 있을 수 있는 곳
