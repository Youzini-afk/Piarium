...
Вимикає стиснення API-відповідей, якщо встановлено `true` або `1`. Має пріоритет над `PIARIUM_COMPRESS_API`.
...
Альтернативний override для Git executable. Для OpenChamber-specific налаштувань краще використовуйте `PIARIUM_GIT_BINARY`.
