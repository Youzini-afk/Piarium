...
Connect your GitHub account and Varin can pull in issues and pull requests, start a session straight from one, and open or update PRs for you.

## Connect GitHub

1. Open **Settings → Git**.
2. Under GitHub, choose **Connect**. Varin shows a link and a short code.
...
- pick an **issue** and Varin names the branch after it and opens the session with the issue and its comments as the first message
...
From the **PR** tab in the [git view](/git/), you can create a pull request, update it, mark a draft as ready, or merge it. Varin can generate the PR title and description from your changes.
