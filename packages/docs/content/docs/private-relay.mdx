...
- Use a [tunnel](/tunnels/) when you need a plain **public URL** — for example to open Piarium in an ordinary browser on a machine you can't pair, or to share access behind a [UI password](/security/).
