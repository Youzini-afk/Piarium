...
description: Otwórz działający serwer deweloperski wewnątrz Piarium.
---

# Podgląd i serwery deweloperskie

Gdy uruchamiasz serwer deweloperski, Piarium może otworzyć go bezpośrednio w aplikacji zamiast w osobnej karcie przeglądarki — dzięki czemu widzisz swoją witrynę obok czatu, przechwytujesz jej konsolę i wskazujesz elementy, aby o nie zapytać.

## Otwórz podgląd

Piarium obserwuje wynik terminala pod kątem adresu lokalnego (wiersz `Local:`, który drukują narzędzia takie jak Vite, Next.js czy Astro). Gdy go wykryje:
