...
description: Otwórz działający serwer deweloperski wewnątrz Varin.
---

# Podgląd i serwery deweloperskie

Gdy uruchamiasz serwer deweloperski, Varin może otworzyć go bezpośrednio w aplikacji zamiast w osobnej karcie przeglądarki — dzięki czemu widzisz swoją witrynę obok czatu, przechwytujesz jej konsolę i wskazujesz elementy, aby o nie zapytać.

## Otwórz podgląd

Varin obserwuje wynik terminala pod kątem adresu lokalnego (wiersz `Local:`, który drukują narzędzia takie jak Vite, Next.js czy Astro). Gdy go wykryje:
