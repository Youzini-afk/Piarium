...
Cel zamienia jeden prompt w linię mety. Zamiast popychać agenta słowem „kontynuuj" po każdej odpowiedzi, ustawiasz cel raz — a Piarium automatycznie prowadzi sesję w jego stronę, sprawdzając postęp niezależnym audytorem po każdej turze. Praca trwa nawet pod twoją nieobecność.
...
- **Według harmonogramu**: zaznacz **Uruchom jako cel** w [zaplanowanym zadaniu](/pl/scheduled-tasks/), aby cykliczne uruchomienia doprowadzały prompt do końca.
...
Gdy agent się zatrzyma i sesja na chwilę ucichnie, Piarium:
...
- Pętla celu działa na serwerze Piarium, nie w karcie przeglądarki. Zamknij kartę, zablokuj telefon — agent pracuje dalej, a gdy cel się rozstrzygnie, dostaniesz powiadomienie. Serwer (aplikacja desktopowa lub proces `piarium`) musi pozostać uruchomiony.
...
- [Zaplanowane zadania](/pl/scheduled-tasks/) — uruchamianie promptu według harmonogramu; włącz tam „Uruchom jako cel", aby zaplanowane uruchomienie doprowadziło prompt do końca
- [Powiadomienia](/pl/notifications/) — jak dowiadujesz się o ukończonym celu
