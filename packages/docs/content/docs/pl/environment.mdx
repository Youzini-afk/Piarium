...
Wyłącza kompresję odpowiedzi API, gdy ma wartość `true` albo `1`. Ma pierwszeństwo przed `PIARIUM_COMPRESS_API`.
...
Alternatywny override dla Git executable. Dla konfiguracji specyficznej dla OpenChamber preferuj `PIARIUM_GIT_BINARY`.
