...
description: Zainstaluj aplikację Piarium na iOS lub Androidzie i połącz ją ze swoim serwerem.
---

# Aplikacje mobilne i PWA

Piarium ma natywne aplikacje na iPhone'a i Androida, więc możesz obserwować sesje, odpowiadać agentom i zarządzać pracą z telefonu — w domu przez Wi-Fi lub z dowolnego miejsca przez [Private Relay](/pl/private-relay/).

## Zainstaluj aplikację

- **iPhone/iPad** — dołącz do [bety TestFlight](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — pobierz APK z [najnowszego wydania](https://github.com/Youzini-afk/Piarium/releases/latest)

## Połącz ją ze swoim serwerem

1. Na komputerze z uruchomionym Piarium otwórz **Settings → Remote Instances → Połącz z tym serwerem** i naciśnij **Dodaj urządzenie**.
...
W **Settings → Piarium** kilka opcji dostraja działanie na telefonie i zainstalowanej aplikacji — nazwę zainstalowanej aplikacji, orientację ekranu i zachowanie klawiatury ekranowej.
