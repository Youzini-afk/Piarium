...
description: Zainstaluj aplikację Varin na iOS lub Androidzie i połącz ją ze swoim serwerem.
---

# Aplikacje mobilne i PWA

Varin ma natywne aplikacje na iPhone'a i Androida, więc możesz obserwować sesje, odpowiadać agentom i zarządzać pracą z telefonu — w domu przez Wi-Fi lub z dowolnego miejsca przez [Private Relay](/pl/private-relay/).

## Zainstaluj aplikację

- **iPhone/iPad** — dołącz do [bety TestFlight](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — APK Varin nie jest jeszcze opublikowany; użyj PWA albo zbuduj go ze źródeł.

## Połącz ją ze swoim serwerem

1. Na komputerze z uruchomionym Varin otwórz **Settings → Remote Instances → Połącz z tym serwerem** i naciśnij **Dodaj urządzenie**.
...
W **Settings → Varin** kilka opcji dostraja działanie na telefonie i zainstalowanej aplikacji — nazwę zainstalowanej aplikacji, orientację ekranu i zachowanie klawiatury ekranowej.
