...
Zaplanowane zadanie uruchamia za Ciebie prompt według harmonogramu — na przykład codzienne „podsumuj wczorajsze zmiany” albo cotygodniowe porządki. Gdy się uruchamia, Varin rozpoczyna nową sesję i sam wysyła prompt. Otwórz harmonogram z przycisku u góry paska bocznego sesji.
...
Zadania uruchamiają się tylko wtedy, gdy serwer Varin działa. Jeśli go zamkniesz, zaplanowane uruchomienia są wstrzymane, dopóki nie wróci.
