...
Możesz też ustawić je za pomocą zmiennej środowiskowej `PIARIUM_UI_PASSWORD`, zamiast podawać je w wierszu poleceń. Po zalogowaniu OpenChamber zapamiętuje urządzenie na pewien czas, więc nie pyta za każdym razem.
