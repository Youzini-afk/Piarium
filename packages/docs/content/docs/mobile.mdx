...
description: Install the Varin app on iOS or Android and connect it to your server.
---

# Mobile Apps & PWA

Varin has native apps for iPhone and Android, so you can watch sessions, reply to agents, and manage work from your phone — at home over Wi-Fi or from anywhere over the [Private Relay](/private-relay/).

## Install the app

- **iPhone/iPad** — join the [TestFlight beta](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — the Varin APK is not published yet; use the PWA or build it from source.

## Connect it to your server

1. On the computer running Varin, open **Settings → Remote Instances → Connect to this server** and press **Add a device**.
...
Under **Settings → Varin**, a few options tune the mobile and installed experience — the app's installed name, screen orientation, and how the on-screen keyboard behaves.
