...
> Les instances distantes sont une fonctionnalité **desktop uniquement**. Sur le web ou dans VS Code, connectez-vous à un serveur Piarium distant avec un [tunnel](/tunnels/), un [reverse proxy](/reverse-proxy/) ou une [association](/connect-devices/).
...
Vous décidez d’enregistrer les mots de passe SSH et UI ou de les saisir à chaque fois. Si la connexion tombe, Piarium indique l’étape qui a échoué pour vous aider à corriger — voir [Accès distant](/troubleshooting/remote-access/).
...
- [Tunnels](/tunnels/) — se connecter à un serveur Piarium distant sur web ou VS Code
