...
Vous pouvez aussi le définir avec la variable d’environnement `PIARIUM_UI_PASSWORD` au lieu de le mettre en ligne de commande. Après connexion, OpenChamber mémorise l’appareil pendant un moment pour ne pas vous le redemander à chaque fois.
