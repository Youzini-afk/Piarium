...
Pour écrire vos propres skills, voir [Skills](/fr/skills/).
...
Si un skill du même nom existe déjà, Piarium vous demande quoi faire — l’ignorer, l’écraser ou décider skill par skill.
...
- [Skills](/fr/skills/) — créer et gérer les skills installés
