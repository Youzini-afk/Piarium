...
Before Varin can do anything, it needs at least one AI provider connected. This page covers connecting a provider, choosing a model, and tailoring agents.
...
3. Sign in one of two ways, depending on the provider:
   ...
   - **Sign-in (device flow)** — Varin shows a link and a short code. Open the link, enter the code, and approve. Varin finishes connecting on its own.
