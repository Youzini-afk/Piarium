...
Você também pode defini-la com a variável de ambiente `PIARIUM_UI_PASSWORD` em vez de colocá-la na linha de comando. Após o login, o OpenChamber lembra o dispositivo por um tempo para que você não seja solicitado toda vez.
