...
description: Instale o app do Varin no iOS ou Android e conecte-o ao seu servidor.
---

# Apps Móveis e PWA

O Varin tem apps nativos para iPhone e Android, então você pode acompanhar sessões, responder aos agentes e gerenciar o trabalho pelo celular — em casa pelo Wi-Fi ou de qualquer lugar pelo [Private Relay](/pt-br/private-relay/).

## Instalar o app

- **iPhone/iPad** — participe do [beta no TestFlight](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — o APK do Varin ainda não foi publicado; use a PWA ou compile-o a partir do código-fonte.

## Conectar ao seu servidor

1. No computador que executa o Varin, abra **Settings → Remote Instances → Conectar a este servidor** e pressione **Adicionar um dispositivo**.
...
Em **Settings → Varin**, algumas opções ajustam a experiência móvel e instalada — o nome instalado do app, a orientação da tela e como o teclado na tela se comporta.
