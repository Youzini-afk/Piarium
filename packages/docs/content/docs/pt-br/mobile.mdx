...
description: Instale o app do Piarium no iOS ou Android e conecte-o ao seu servidor.
---

# Apps Móveis e PWA

O Piarium tem apps nativos para iPhone e Android, então você pode acompanhar sessões, responder aos agentes e gerenciar o trabalho pelo celular — em casa pelo Wi-Fi ou de qualquer lugar pelo [Private Relay](/pt-br/private-relay/).

## Instalar o app

- **iPhone/iPad** — participe do [beta no TestFlight](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — baixe o APK da [versão mais recente](https://github.com/Youzini-afk/Piarium/releases/latest)

## Conectar ao seu servidor

1. No computador que executa o Piarium, abra **Settings → Remote Instances → Conectar a este servidor** e pressione **Adicionar um dispositivo**.
...
Em **Settings → Piarium**, algumas opções ajustam a experiência móvel e instalada — o nome instalado do app, a orientação da tela e como o teclado na tela se comporta.
