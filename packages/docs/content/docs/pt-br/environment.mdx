...
Desativa a compressão das respostas da API quando definido como `true` ou `1`. Tem prioridade sobre `PIARIUM_COMPRESS_API`.
...
Override alternativo para o executável do Git. Para configuração específica do OpenChamber, prefira `PIARIUM_GIT_BINARY`.
