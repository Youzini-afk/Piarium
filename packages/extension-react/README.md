...
Optional React 19 adapter for Varin Surface extensions. React is a peer dependency and is bundled by
the extension artifact build rather than inherited from the Varin workbench. `defineReactContribution`
