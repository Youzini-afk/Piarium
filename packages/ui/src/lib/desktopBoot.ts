 ...
 * it as `window.__PIARIUM_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __PIARIUM_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__PIARIUM_DESKTOP_BOOT_OUTCOME__;
