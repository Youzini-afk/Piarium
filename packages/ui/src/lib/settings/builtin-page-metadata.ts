...
export const BUILTIN_SETTINGS_PAGE_SPECS: readonly BuiltinSettingsPageSpec[] = [
  ...
  spec({ slug: 'knowledge', title: 'Knowledge', titleKey: 'settings.page.knowledge.title', group: 'harness', kind: 'single', icon: 'brain', order: 6, keywords: ['knowledge', 'memory', 'recall', 'suggestion', 'supersede'] }, 'knowledge'),
