...
export const dict: Record<I18nKey, string> = {
  ...
  "contextSidebar.section.memory": "Memoria",
  "contextSidebar.memory.effective": "Modo efectivo: {mode}",
  "contextSidebar.memory.inherited": "Usa la configuración global",
  "contextSidebar.memory.override": "Anulación de la sesión",
  "contextSidebar.memory.mode.inherit": "Heredar configuración global",
  "contextSidebar.memory.mode.off": "Desactivado",
  "contextSidebar.memory.mode.assist": "Mantener e inyectar (asistencia)",
  "contextSidebar.memory.mode.takeover": "Mantener y asumir la compactación cuando esté listo (toma de control)",
  "contextSidebar.memory.status.updating": "Actualizando el modo de memoria…",
  "contextSidebar.memory.status.updateFailed": "No se pudo actualizar el modo de memoria.",
  "contextSidebar.memory.status.keeperFailed": "El mantenedor de memoria falló recientemente.",
  "contextSidebar.memory.status.compactionFailed": "La compactación de memoria falló recientemente.",
