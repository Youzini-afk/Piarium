...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.chooser.description': "Choose a local Pi runtime or connect to a remote Piarium server.",
  'onboarding.chooser.tabs.localInstall': "Local Pi",
  'onboarding.chooser.tabs.connectRemote': "Connect Remote",
  'onboarding.localSetup.title': "Local Pi runtime",
  'onboarding.localSetup.description': "Piarium usa el runtime de Pi instalado en este equipo. Instala o elige uno para continuar.",
  'onboarding.localSetup.status.ready': "El runtime de Pi está listo",
  ...
  'onboarding.localSetup.status.missing': "No se encontró un runtime de Pi",
  'onboarding.localSetup.status.missingDetail': "Instala Pi para este usuario o elige una instalación existente.",
  ...
  'onboarding.localSetup.status.failed': "El runtime de Pi no pudo iniciarse",
  'onboarding.localSetup.status.hostEntryUnavailable': "La instalación de Piarium necesita reparación",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "Faltan o no se puede acceder a los archivos Host necesarios para iniciar Pi. Descarga y reinstala Piarium; cambiar o actualizar Pi no los reparará.",
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "Detalles técnicos",
  'onboarding.localSetup.status.checking': "Conectando al runtime de Pi",
  'onboarding.localSetup.status.checkingDetail': "Negociando el protocolo de runtime de Piarium…",
  'onboarding.localSetup.status.installing': "Instalando Pi",
  'onboarding.localSetup.status.upgrading': "Actualizando Pi",
  'onboarding.localSetup.status.discovering': "Buscando un runtime de Pi",
  'onboarding.localSetup.status.probing': "Comprobando el runtime de Pi",
  'onboarding.localSetup.errors.timeout': 'El handshake del runtime de Pi agotó el tiempo. Reintenta o conéctate a un servidor remoto.',
  'onboarding.localSetup.errors.managerUnavailable': "Esta superficie no puede gestionar el runtime local de Pi.",
  ...
  'onboarding.localSetup.runtime.source.bundled': "Incluido",
  'onboarding.localSetup.runtime.commandPath': "Comando",
  'onboarding.localSetup.actions.continue': "Usar Pi local",
  ...
  'onboarding.desktopRecovery.localUnavailable.title': "Local Pi Runtime Unavailable",
  'onboarding.desktopRecovery.localUnavailable.description': "The local Pi runtime could not be started. Retry the runtime or connect to a remote server instead.",
  "onboarding.desktopRecovery.localUnavailable.retry": "Reintentar Local",
  'onboarding.desktopRecovery.localUnavailable.useLocal': "Check Local Pi",
  ...
  "splash.status.connectingRuntime": "Conectando con el runtime de Pi",
