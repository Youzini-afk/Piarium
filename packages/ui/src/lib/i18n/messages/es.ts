...
export const dict: Record<I18nKey, string> = {
  ...
  "workspace.sidebar.actions.chooseWorkspace": "Choose Workspace",
  "workspace.sidebar.actions.terminal": "Terminal",
  "workspace.sidebar.actions.newFolder": "New Folder",
  "workspace.sidebar.actions.upload": "Upload",
  "workspace.sidebar.actions.sort": "Sort",
  "workspace.sidebar.actions.refresh": "Refresh",
  "workspace.sidebar.sort.nameAsc": "Name A → Z",
  "workspace.sidebar.sort.nameDesc": "Name Z → A",
  "workspace.sidebar.sort.modifiedDesc": "Newest first",
  "workspace.sidebar.sort.modifiedAsc": "Oldest first",
  ...
  "workspace.sidebar.menu.newFile": "New File",
  "workspace.sidebar.menu.upload": "Upload",
  "workspace.sidebar.menu.refreshGitStatus": "Refresh Git Status",
  "workspace.sidebar.menu.addToSession": "Add to Session",
  "workspace.sidebar.menu.copyPath": "Copy Path",
  "workspace.sidebar.menu.download": "Download",
  "workspace.sidebar.menu.rename": "Rename",
  "workspace.sidebar.menu.moveToTrash": "Move to Trash",
  "workspace.sidebar.menu.permanentDelete": "Eliminar definitivamente",
  "workspace.sidebar.trash.title": "Papelera",
  "workspace.sidebar.trash.empty": "La papelera está vacía",
  "workspace.sidebar.state.empty": "Empty",
  "workspace.sidebar.state.loading": "Loading...",
  "workspace.sidebar.prompt.newFolderName": "New folder name",
  "workspace.sidebar.prompt.newFileName": "New file name",
  "workspace.sidebar.prompt.renameTo": "Rename to",
  "workspace.sidebar.dialog.create.cancel": "Cancel",
  "workspace.sidebar.dialog.create.confirm": "Create",
  "workspace.sidebar.dialog.create.failed": "Create failed",
  "workspace.sidebar.dialog.create.fileDescription": "Create a new file in {path}.",
  "workspace.sidebar.dialog.create.fileTitle": "New File",
  "workspace.sidebar.dialog.create.folderDescription": "Create a new folder in {path}.",
  "workspace.sidebar.dialog.create.folderTitle": "New Folder",
  "workspace.sidebar.dialog.create.invalidName": "Use a name without slashes.",
  "workspace.sidebar.dialog.create.namePlaceholder": "Name",
  "workspace.sidebar.dialog.rename.title": "Cambiar nombre",
  "workspace.sidebar.dialog.rename.description": "Introduce un nuevo nombre para \"{name}\".",
  "workspace.sidebar.dialog.rename.placeholder": "Nuevo nombre",
  "workspace.sidebar.dialog.rename.invalidName": "Usa un nombre sin barras.",
  "workspace.sidebar.dialog.rename.sameName": "Introduce un nombre diferente.",
  "workspace.sidebar.dialog.rename.cancel": "Cancelar",
  "workspace.sidebar.dialog.rename.submit": "Cambiar nombre",
  "workspace.sidebar.confirm.moveToTrash": "Move \"{name}\" to trash?",
  "workspace.sidebar.confirm.permanentDelete": "¿Eliminar \"{name}\" definitivamente? Esta acción no se puede deshacer.",
  "workspace.sidebar.toast.folderCreated": "Folder created",
  "workspace.sidebar.toast.fileCreated": "File created",
  "workspace.sidebar.toast.renamed": "Renamed",
  "workspace.sidebar.toast.movedToTrash": "Moved to trash",
  "workspace.sidebar.toast.permanentlyDeleted": "Eliminado definitivamente",
  "workspace.sidebar.toast.uploaded": "{count} uploaded",
  "workspace.sidebar.toast.uploadFailed": "Upload failed",
  "workspace.sidebar.toast.addedToSession": "Added \"{name}\" to session",
  "workspace.sidebar.toast.pathCopied": "Path copied",
  "workspace.sidebar.toast.copyFailed": "Copy failed",
  "workspace.sidebar.toast.downloadFailed": "Download failed",
  "workspace.sidebar.toast.workspaceSelected": "Workspace changed",
  "workspace.sidebar.toast.workspaceSelectFailed": "Failed to change workspace",
