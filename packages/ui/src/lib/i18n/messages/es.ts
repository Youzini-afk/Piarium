...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Piarium, el estado de OpenCode, directorios y proyectos.",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén Piarium abierto.",
