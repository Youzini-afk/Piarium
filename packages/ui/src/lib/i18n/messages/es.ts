...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.title': 'Estado del trabajo',
  'chat.workStatus.section.session': 'Sesión',
  'chat.workStatus.section.activity': 'Actividad',
  'chat.workStatus.section.pinned': 'Contexto fijado',
  'chat.workStatus.toolCalls': 'Llamadas a herramientas',
  'chat.workStatus.tokens': 'Tokens',
  'chat.workStatus.queue': 'Cola',
  'chat.workStatus.state.working': 'En curso',
  'chat.workStatus.state.compacting': 'Compactando',
  'chat.workStatus.state.retrying': 'Reintentando',
  'chat.workStatus.state.idle': 'Inactivo',
