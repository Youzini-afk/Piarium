...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala Piarium para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "Piarium se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a Piarium",
  ...
  "mobile.connect.password.placeholder": "Contraseña de Piarium",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de Piarium.",
  ...
  "mobile.connect.relay.badge": "a través de Piarium Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de Piarium.",
  ...
  "sessions.sidebar.footer.actions.aboutPiarium": "Acerca de Piarium",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Piarium: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "workbench.ide.run.emptyTasks": "No hay tareas definidas. Añade un archivo piarium.tasks.json con un script de node.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en Piarium. Descárgalo para abrirlo con otra aplicación.",
  ...
  "header.services.shutdownDev": "Detener Piarium",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Piarium necesita acceso a esta carpeta.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Piarium de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Piarium",
  "header.actions.openAppMenuAria": "Abrir menú de Piarium",
  ...
  'chat.recoveryDialog.description': 'Piarium will verify the message checkpoint before changing the conversation or workspace.',
  'chat.recoveryDialog.filesAffected': 'Affected paths',
  'chat.recoveryDialog.reviewRequired': 'Review required',
  'chat.recoveryDialog.incompleteCheckpoint': 'This message checkpoint is incomplete, so Piarium will not claim that workspace files can be restored safely.',
  ...
  "piariumDiagnosticsDialog.title": "Diagnósticos de Piarium",
  "piariumDiagnosticsDialog.description": "Inspecciona el entorno Pi activo y un resumen sin credenciales de paquetes, plugins, sesiones y proyecto.",
  "piariumDiagnosticsDialog.actions.copy": "Copiar",
  "piariumDiagnosticsDialog.actions.refresh": "Actualizar",
  "piariumDiagnosticsDialog.empty.noData": "No hay diagnósticos disponibles.",
  "piariumDiagnosticsDialog.state.collecting": "Recopilando diagnósticos...",
  "piariumDiagnosticsDialog.state.failed": "No se pudieron recopilar los diagnósticos: {error}",
  "piariumDiagnosticsDialog.toast.copiedTitle": "Copiado",
  "piariumDiagnosticsDialog.toast.copiedDescription": "Diagnósticos copiados al portapapeles",
  "piariumDiagnosticsDialog.toast.copyFailed": "No se pudieron copiar los diagnósticos",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres Piarium desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Piarium",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Piarium",
  ...
  "multiRun.window.description": "Ventana de Piarium Multi-Run.",
  ...
  'onboarding.chooser.title': "Welcome to Piarium",
  'onboarding.chooser.description': 'Usa el Pi incluido con Piarium, elige otra instalación local en Configuración o conéctate a un servidor Piarium remoto.',
  ...
  'onboarding.localSetup.description': 'Piarium incluye Pi, así que no necesitas instalarlo por separado. El runtime local predeterminado puede iniciarse directamente; también puedes elegir otra instalación local en Configuración.',
  ...
  'onboarding.localSetup.status.missingDetail': 'El runtime seleccionado no está disponible. Reintenta o elige otra instalación; si usabas el runtime incluido, reinstala Piarium para repararlo.',
  'onboarding.localSetup.status.upgradeRequired': "Este Pi es demasiado antiguo",
  'onboarding.localSetup.status.upgradeRequiredDetail': "La versión instalada {currentVersion} está por debajo del mínimo {targetVersion}. Actualiza esta instalación; Piarium no degradará un Pi más reciente.",
  'onboarding.localSetup.status.failed': 'El runtime del espacio de trabajo local no pudo iniciarse',
  'onboarding.localSetup.status.hostEntryUnavailable': "La instalación de Piarium necesita reparación",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': 'Faltan o no se puede acceder a los archivos Host necesarios para iniciar el runtime del espacio de trabajo. Descarga y reinstala Piarium; cambiar o actualizar Pi no los reparará.',
  ...
  'onboarding.localSetup.status.checkingDetail': 'Iniciando el runtime del espacio de trabajo de Piarium…',
  ...
  'onboarding.localSetup.runtime.hostVersion': "Host de Piarium",
  ...
  'onboarding.localSetup.runtime.source.bundled': 'Incluido con Piarium',
  ...
  'onboarding.localSetup.actions.downloadPiariumAgain': "Descargar Piarium de nuevo",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Piarium para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Piarium o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Piarium. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Piarium pero no es compatible con esta versión de la app. Actualiza Piarium en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Piarium. Verifica que la dirección apunte a un servidor Piarium.",
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': "The server at \"{host}\" is not running Piarium. Verify the address points to a Piarium server.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  'onboarding.desktopRecovery.remoteIncompatible.description': "The Piarium server at \"{host}\" is not compatible with this app version. Update Piarium on the server, then try again.",
  ...
  "startup.initRecovery.description": "Piarium no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Piarium...",
  "updateDialog.header.restarting": "Reiniciando Piarium…",
  ...
  "updateDialog.status.desktopRestartingHint": "Piarium está cerrando los servicios en segundo plano y transfiriendo el control al instalador. Puede tardar un momento.",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: piarium update",
  "mobileUpdate.toast.available.title": "Actualización de Piarium disponible",
  ...
  "piariumLogo.aria.logo": "Logo de Piarium",
  "splash.aria.loading": "Cargando Piarium",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor Piarium conectado no respondió a la API del recorrido. Actualiza Piarium y vuelve a intentarlo.",
