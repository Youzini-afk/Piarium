...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.recoveryDialog.noFileChanges': 'Este punto de control no tiene cambios de archivos respecto al espacio de trabajo actual.',
  'chat.recoveryDialog.confirmSelection': 'Continuar con la recuperación seleccionada',
  'chat.recoveryDialog.modeConflict': 'Esta recuperación ya se inició con otra opción. Cierra este cuadro de diálogo y vuelve a elegir.',
  ...
  'chat.recoveryDialog.preparing': 'Inspecting the checkpoint and current workspace…',
  'chat.recoveryDialog.filesAffected': 'Affected paths',
  'chat.recoveryDialog.dataSize': 'Snapshot data',
  'chat.recoveryDialog.reviewRequired': 'Review required',
  'chat.recoveryDialog.noCheckpoint': 'This older message has no native workspace checkpoint. You can still return the Pi conversation only.',
  ...
  'chat.recoveryDialog.inPlace': 'Return the conversation and this workspace',
  'chat.recoveryDialog.inPlaceDescription': 'Restore the checkpoint here, then atomically move the Pi conversation. A safety checkpoint is kept first.',
  'chat.recoveryDialog.newWorkspace': 'Restore into a new workspace',
  'chat.recoveryDialog.newWorkspaceDescription': 'Leave this workspace and conversation unchanged, and materialize the checkpoint at the path below.',
  'chat.recoveryDialog.destination': 'Recovered workspace destination',
  'chat.recoveryDialog.applying': 'Applying recovery…',
  'chat.recoveryDialog.operationState': 'Recovery state: {state}',
  'chat.recoveryDialog.compensatedDescription': 'The conversation changed before navigation. Piarium restored the original workspace safety checkpoint.',
  'chat.recoveryDialog.retry': 'Retry',
  'chat.recoveryDialog.completed': 'Conversation and workspace restored',
  'chat.recoveryDialog.newWorkspaceReady': 'Recovered workspace created at {path}; the current conversation was not changed',
  ...
  'contextPanel.recovery.native.description': 'Workspace checkpoints, combined recovery operations, and crash-safe undo.',
  'contextPanel.recovery.native.checkpointDescription': 'Pin the current workspace revision with a name. It uses the same immutable snapshot engine as message recovery.',
  ...
  'contextPanel.recovery.native.noSnapshots': 'No workspace snapshots yet.',
  ...
  'contextPanel.recovery.native.undoNeedsWorkspace': 'This recovery can only be undone into a new workspace. Use the message recovery chooser to review the destination.',
