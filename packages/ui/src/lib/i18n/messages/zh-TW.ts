...
export const dict: Record<I18nKey, string> = {
  ...
  'workbench.patch.written': '已依目前檔案版本寫入修補。',
  ...
  'workspace.sidebar.actions.chooseWorkspace': '選擇工作區',
  ...
  'workspace.sidebar.toast.workspaceSelected': '已切換工作區',
  'workspace.sidebar.toast.workspaceSelectFailed': '切換工作區失敗',
  ...
  'chat.workStatus.title': '工作狀態',
  'chat.workStatus.section.session': '工作階段',
  'chat.workStatus.section.activity': '目前活動',
  'chat.workStatus.section.pinned': '固定內容',
  'chat.workStatus.toolCalls': '工具呼叫',
  'chat.workStatus.tokens': '權杖',
  'chat.workStatus.queue': '佇列',
  'chat.workStatus.state.working': '工作中',
  'chat.workStatus.state.compacting': '壓縮中',
  'chat.workStatus.state.retrying': '重試中',
  'chat.workStatus.state.idle': '閒置',
