...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 Piarium 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'Piarium 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 Piarium',
  ...
  'mobile.connect.password.placeholder': 'Piarium 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Piarium 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 Piarium Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Piarium 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Piarium。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Piarium，但與此應用程式版本不相容。請更新伺服器上的 Piarium 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Piarium 伺服器與此應用程式版本不相容。請更新伺服器上的 Piarium 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutPiarium': '關於 Piarium',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Piarium 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'workbench.ide.run.emptyTasks': '尚未定義工作。請新增包含 node 指令碼的 piarium.tasks.json 檔案。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 Piarium 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'header.services.shutdownDev': '停止 Piarium',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Piarium 需要存取此資料夾。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Piarium',
  ...
  'header.actions.openAppMenu': 'Piarium 選單',
  'header.actions.openAppMenuAria': '開啟 Piarium 選單',
  ...
  'piariumDiagnosticsDialog.title': 'Piarium 診斷',
  'piariumDiagnosticsDialog.description': '查看目前 Pi 執行環境，以及不含憑證的套件、外掛、會話與專案狀態摘要。',
  'piariumDiagnosticsDialog.actions.copy': '複製',
  'piariumDiagnosticsDialog.actions.refresh': '重新整理',
  'piariumDiagnosticsDialog.empty.noData': '目前沒有診斷資訊。',
  'piariumDiagnosticsDialog.state.collecting': '正在收集診斷資訊...',
  'piariumDiagnosticsDialog.state.failed': '收集診斷資訊失敗：{error}',
  'piariumDiagnosticsDialog.toast.copiedTitle': '已複製',
  'piariumDiagnosticsDialog.toast.copiedDescription': '診斷資訊已複製到剪貼簿',
  'piariumDiagnosticsDialog.toast.copyFailed': '複製診斷資訊失敗',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 Piarium，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Piarium',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Piarium 伺服器之間切換',
  ...
  'multiRun.window.description': 'Piarium 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Piarium',
  'onboarding.chooser.description': '使用 Piarium 內建的 Pi、在設定中選擇其他本機安裝，或連線至遠端 Piarium 伺服器。',
  ...
  'onboarding.localSetup.description': 'Piarium 已內建 Pi，不需要另外安裝。預設本機執行環境可以直接啟動；你也可以在設定中選擇其他本機安裝。',
  ...
  'onboarding.localSetup.status.missingDetail': '所選執行環境無法使用。請重試或選擇其他安裝；若使用的是內建執行環境，可重新安裝 Piarium 進行修復。',
  'onboarding.localSetup.status.upgradeRequired': '目前的 Pi 版本過舊',
  'onboarding.localSetup.status.upgradeRequiredDetail': '已安裝的 {currentVersion} 低於最低要求 {targetVersion}。請升級此安裝；Piarium 不會降級較新的 Pi。',
  'onboarding.localSetup.status.failed': '本機工作區執行環境無法啟動',
  'onboarding.localSetup.status.hostEntryUnavailable': 'Piarium 安裝需要修復',
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '啟動工作區執行環境所需的應用程式 Host 檔案遺失或無法存取。請重新下載並安裝 Piarium；升級或改選 Pi 無法修復這些應用程式檔案。',
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': '技術詳情',
  'onboarding.localSetup.status.checking': '正在啟動工作區執行環境',
  'onboarding.localSetup.status.checkingDetail': '正在啟動 Piarium 工作區執行環境…',
  ...
  'onboarding.localSetup.runtime.hostVersion': 'Piarium 主機',
  ...
  'onboarding.localSetup.runtime.source.bundled': 'Piarium 內建',
  ...
  'onboarding.localSetup.actions.downloadPiariumAgain': '重新下載 Piarium',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Piarium 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Piarium 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Piarium。請確認位址是否指向 Piarium 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Piarium。請確認位址是否指向 Piarium 伺服器。',
  ...
  'startup.initRecovery.description': 'Piarium 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Piarium...',
  'updateDialog.header.restarting': '正在重新啟動 Piarium…',
  ...
  'updateDialog.status.desktopRestartingHint': 'Piarium 正在關閉背景服務並交由安裝程式處理，請稍候。',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：piarium update',
  'mobileUpdate.toast.available.title': 'Piarium 更新可用',
  ...
  'piariumLogo.aria.logo': 'Piarium 標誌',
  'splash.aria.loading': '正在載入 Piarium',
  ...
  'walkthrough.blocked.serverUnsupported.description': '目前連線的 Piarium 伺服器未回應導讀 API。請更新 Piarium 後重新整理。',
