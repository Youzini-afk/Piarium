...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.workspacePicker.chooseAria': '選擇工作區',
  'sessions.sidebar.workspacePicker.generalChat': '一般對話',
  'sessions.sidebar.workspacePicker.addWorkspace': '新增工作區',
  'sessions.sidebar.workspacePicker.recent': '最近',
