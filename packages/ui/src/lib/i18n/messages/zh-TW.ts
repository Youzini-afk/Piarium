...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.chooser.description': '使用本機 Pi 執行環境，或連線至遠端 Piarium 伺服器。',
  'onboarding.chooser.tabs.localInstall': '本機 Pi',
  'onboarding.chooser.tabs.connectRemote': '連線遠端',
  'onboarding.localSetup.title': '本機 Pi 執行環境',
  'onboarding.localSetup.description': 'Piarium 使用這台電腦上已安裝的 Pi 執行環境。請安裝或選擇一個後繼續。',
  'onboarding.localSetup.status.ready': 'Pi 執行環境已就緒',
  ...
  'onboarding.localSetup.status.missing': '找不到 Pi 執行環境',
  'onboarding.localSetup.status.missingDetail': '可為目前使用者安裝 Pi，或選擇既有安裝。',
  ...
  'onboarding.localSetup.status.failed': 'Pi 執行環境無法啟動',
  'onboarding.localSetup.status.hostEntryUnavailable': 'Piarium 安裝需要修復',
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '啟動 Pi 所需的應用程式 Host 檔案遺失或無法存取。請重新下載並安裝 Piarium；升級或改選 Pi 無法修復這些應用程式檔案。',
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': '技術詳情',
  'onboarding.localSetup.status.checking': '正在連線至 Pi 執行環境',
  'onboarding.localSetup.status.checkingDetail': '正在協商 Piarium 執行環境協定…',
  'onboarding.localSetup.status.installing': '正在安裝 Pi',
  'onboarding.localSetup.status.upgrading': '正在升級 Pi',
  'onboarding.localSetup.status.discovering': '正在尋找 Pi 執行環境',
  'onboarding.localSetup.status.probing': '正在檢查 Pi 執行環境',
  'onboarding.localSetup.errors.timeout': 'Pi 執行環境交握逾時。請重試，或連線至遠端伺服器。',
  'onboarding.localSetup.errors.managerUnavailable': '目前介面無法管理本機 Pi 執行環境。',
  ...
  'onboarding.localSetup.runtime.source.bundled': '內建',
  'onboarding.localSetup.runtime.commandPath': '命令',
  'onboarding.localSetup.actions.continue': '使用本機 Pi',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '本機 Pi 執行環境無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': '本機 Pi 執行環境無法啟動。請重試執行環境，或改為連線至遠端伺服器。',
  'onboarding.desktopRecovery.localUnavailable.retry': '重試本地',
  'onboarding.desktopRecovery.localUnavailable.useLocal': '檢查本機 Pi',
  ...
  'splash.status.connectingRuntime': '正在連線 Pi 執行期',
