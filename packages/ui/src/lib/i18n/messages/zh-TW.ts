...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.openChamberVersionLabel': 'Piarium 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Piarium 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Piarium 開啟。',
