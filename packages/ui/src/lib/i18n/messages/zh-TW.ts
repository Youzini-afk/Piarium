...
export const dict: Record<I18nKey, string> = {
  ...
  'contextSidebar.section.memory': '記憶',
  'contextSidebar.memory.effective': '目前生效模式：{mode}',
  'contextSidebar.memory.inherited': '使用全域設定',
  'contextSidebar.memory.override': '會話覆寫',
  'contextSidebar.memory.mode.inherit': '沿用全域設定',
  'contextSidebar.memory.mode.off': '關閉',
  'contextSidebar.memory.mode.assist': '維護並注入（assist）',
  'contextSidebar.memory.mode.takeover': '維護並在就緒時接管壓縮（takeover）',
  'contextSidebar.memory.status.updating': '正在更新記憶模式…',
  'contextSidebar.memory.status.updateFailed': '無法更新記憶模式。',
  'contextSidebar.memory.status.keeperFailed': '記憶維護器最近失敗。',
  'contextSidebar.memory.status.compactionFailed': '記憶壓縮最近失敗。',
