...
export const dict: Record<I18nKey, string> = {
  ...
  'tasksHub.paused': "已暫停",
  'tasksHub.completed': "已完成",
  'tasksHub.scheduledDescription': "讓智慧體按計畫執行任務。",
  'followupEditor.create': "建立接續任務",
  'followupEditor.edit': "編輯接續任務",
  'followupEditor.description': "屆時在所選對話中繼續。若條件已滿足，可能立即接續。",
  'followupEditor.session': "接續哪個對話",
  'followupEditor.chooseSession': "選擇對話",
  'followupEditor.noSessions': "請選擇一條關聯專案的既有對話。",
  'followupEditor.instruction': "屆時要做什麼",
  'followupEditor.condition': "何時接續",
  'followupEditor.at': "日期與時間",
  'followupEditor.path': "工作區相對檔案路徑",
  'followupEditor.branch': "分支（留空使用目前分支）",
  'followupEditor.invalidTime': "請選擇有效的日期與時間。",
  'followupEditor.keepSource': "保留原觸發條件",
  'followupEditor.chooseExperiment': "選擇實驗",
  'followupEditor.kind.time': "指定時間",
  'followupEditor.kind.file': "檔案狀態",
  'followupEditor.kind.experiment': "實驗結束",
  'followupEditor.kind.external': "Pull Request 狀態",
  'followupEditor.kind.manual': "手動喚醒",
  'followupEditor.file.exists': "檔案出現",
  'followupEditor.file.changed': "每次檔案變更",
  'followupEditor.file.ready': "檔案就緒",
  'followupEditor.pr.exists': "PR 已存在",
  'followupEditor.pr.open': "PR 已開啟",
  'followupEditor.pr.merged': "PR 已合併",
  'followupEditor.pr.closed': "PR 已關閉",
  'tasksHub.title': "定時與接續",
  'tasksHub.scheduled': "定時任務",
  'tasksHub.followUps': "接續任務",
  'tasksHub.followUpsDescription': "集中查看本實例各對話的等待任務；時間到達或條件滿足後，接著原對話繼續。",
  'tasksHub.active': "等待中",
  'tasksHub.history': "歷史記錄",
  'tasksHub.search': "搜尋條件、指令或對話",
  'tasksHub.refresh': "重新整理",
  'tasksHub.empty': "暫無待接續任務。可在對話中讓智慧體在指定時間或條件滿足時繼續工作。",
  'tasksHub.emptyHistory': "暫無接續記錄。",
  ...
  'research-workbench.branchesAndMaterials': "研究分支與材料",
  'research-workbench.retry': "重試",
  'research-facts.summary': "{attempts} 個實驗嘗試 · {machines} 台機器 · {sources} 個來源",
  'research-facts.attempts': "實驗",
  'research-facts.machines': "機器",
  'research-facts.sources': "來源",
  'research-facts.emptyAttempts': "沒有記錄實驗嘗試。",
  'research-facts.emptyMachines': "沒有註冊執行目標。",
  'research-facts.cancel': "取消",
  'research-facts.collect': "收集",
  'research-facts.capacity': "容量",
  'research-facts.capacityUnknown': "容量未知",
  'research-facts.usage': "使用情況",
  'research-facts.usageUnread': "使用情況未讀取",
  'research-facts.stale': "已過期",
  'research-facts.commitments': "{count} 個佔用",
  'research-facts.queued': "排隊中",
  'research-facts.sourceRetired': "已停用",
  'research-facts.attempt.submitted': "已提交",
  'research-facts.attempt.queued': "排隊中",
  'research-facts.attempt.running': "執行中",
  'research-facts.attempt.stopping': "停止中",
  'research-facts.attempt.completed': "已完成",
  'research-facts.attempt.failed': "失敗",
  'research-facts.attempt.cancelled': "已取消",
  'research-facts.attempt.lost': "已遺失",
  'research-facts.attempt.unknown': "未知狀態",
  'research-facts.machine.available': "可用",
  'research-facts.machine.degraded': "降級",
  'research-facts.machine.offline': "離線",
  'research-facts.machine.retired': "已停用",
  'research-facts.connection.connected': "已連線",
  'research-facts.connection.degraded': "連線降級",
  'research-facts.connection.offline': "連線離線",
  'research-facts.connection.unknown': "連線未知",
  'research-facts.collection.pending': "收集中",
  'research-facts.collection.done': "已收集",
  'research-facts.collection.failed': "收集失敗",
  'research-facts.source': "來源",
  'research-facts.observedAt': "觀測於 {time}",
  'research-facts.checkedAt': "檢查於 {time}",
  'research-facts.viewDetails': "檢視詳情",
  'research-facts.hideDetails': "隱藏詳情",
  'research-facts.loadingDetails': "正在載入嘗試詳情…",
  'research-facts.detailsUnavailable': "嘗試詳情無法使用。",
  'research-facts.logs': "記錄",
  'research-facts.log.stdout': "標準輸出",
  'research-facts.log.stderr': "標準錯誤",
  'research-facts.loadLog': "載入",
  'research-facts.loadMore': "載入更多",
  'research-facts.noLog': "沒有記錄輸出。",
  'research-facts.artifacts': "產物",
  'research-facts.noArtifacts': "沒有已收集的產物。",
  'research-facts.download': "下載",
  'research-facts.artifactUnavailable': "無法使用",
  'research-facts.refreshFailed': "重新整理失敗；正在顯示先前的事實。",
  'research-facts.target': "目標",
  'research-facts.targetSource.desktop-host': "桌面 Host",
  'research-facts.targetSource.ssh-instance': "SSH 實例",
  'research-facts.targetSource.configured-host': "已設定 Host",
  'research-facts.capabilities': "能力",
  'research-facts.coordinator': "協調 Host",
  'research-facts.coordinatorUnavailable': "協調 Host 無法使用；排隊中的工作需要它保持在線。",
  'research-facts.backend': "後端",
  'research-facts.sourceThread': "來源 Thread",
  'research-facts.sourceRun': "來源 Run",
  'research-facts.awaitingCoordinator': "等待協調者",
  'research-facts.remoteAccepted': "遠端已接收；關閉此桌面後仍可繼續執行。",
  'research-facts.remoteArtifact': "遠端",
  'research-facts.remoteUnreachable': "遠端產物無法使用",
  'research-facts.remoteExpired': "遠端產物已過期",
  'research-facts.targetDetails': "目標詳情",
  'research-facts.resourceDetails': "資源詳情",
  'research-facts.remoteJobsSurviveDisconnect': "已接收工作可在用戶端中斷後繼續",
  'research-facts.remoteJobsMayStopWithClient': "已接收工作可能隨用戶端停止",
  'research-facts.unassignedNeedsCoordinator': "未派發工作需要協調者在線",
  'research-facts.unassignedCoordinatorOptional': "未派發工作不需要此協調者",
  'research-facts.gpuProbe': "GPU 探測",
  'research-facts.selectAttempt': "選取嘗試 {attempt}",
  'research-facts.executionCwd': "工作目錄",
  'research-facts.executionRoot': "執行根目錄",
  'research-facts.technicalDetails': "技術詳情",
  'research-facts.jobState': "工作狀態",
  'research-facts.retryOf': "補跑自",
  'research-facts.rerun': "補跑",
  'research-facts.selectedCount': "已選取 {count} 項",
  'research-facts.cancelSelected': "取消已選取",
  'research-facts.rerunSelected': "補跑已選取",
  'research-facts.actionFailed': "操作失敗",
  'research-facts.unknownTarget': "未知目標",
  'workFocus.label': "工作側重",
  'workFocus.code': "通用",
  'workFocus.research': "科研",
  'workFocus.codeDescription': "處理程式開發與日常任務，按需要使用工具。",
  'workFocus.researchDescription': "調查問題、比較解釋，設計並推進實驗。",
  'workFocus.pending': "待下次啟動生效",
  'workFocus.nextTurn': "修改在下次啟動執行時生效；目前執行及其追問佇列保留原側重。",
  'workFocus.fromProject': "建立對話時採用的專案預設值。",
  'workFocus.failed': "套用失敗，仍使用{focus}。再次傳送可重試。",
  'workFocus.useProjectDefault': "使用專案預設：{focus}",
  'workFocus.projectDefault': "預設工作側重",
  'workFocus.projectDefaultDescription': "用於新對話；既有對話保留各自的工作側重。",
  ...
  'harness.overview.description': '集中查看計畫、變更、子任務、來源和目前會話脈絡。',
  'harness.overview.review': '待確認',
  'harness.overview.reviewCount': '{count} 項待確認',
  'harness.overview.plan': '計畫',
  'harness.overview.planProgress': '{done}/{total}',
  'harness.overview.outputs': '產出與變更',
  'harness.overview.workspaceChanges': '目前工作區',
  'harness.overview.outputFiles': '{count} 個檔案',
  'harness.overview.outputDiff': '{files} 個檔案 · +{insertions} −{deletions}',
  'harness.overview.moreItems': '另有 {count} 項',
  'harness.overview.viewChanges': '查看變更',
  'harness.overview.pendingThreadChanges': '子任務產出',
  'harness.overview.pendingThreadChangesDescription': '來自隔離子任務、尚未合併到目前工作區的變更。',
  'harness.overview.threads': '子任務',
  'harness.overview.threadsSummary': '{active} 進行中 · {completed} 已完成',
  'harness.overview.sources': '來源',
  'harness.overview.memory': '記憶與決定',
  'harness.overview.memoryProgress': '目前進展',
  'harness.overview.memoryDecisions': '關鍵決定',
  'harness.overview.runDetails': '執行詳情',
  'harness.overview.summary.attention': '{count} 個子任務需要處理',
  'harness.overview.summary.blocked': '計畫有 {count} 項受阻',
  'harness.overview.summary.running': '{count} 個子任務正在執行',
  'harness.overview.summary.plan': '進行中 · {done}/{total} 項',
  'harness.overview.summary.review': '{count} 項等待確認',
  'harness.overview.summary.done': '計畫已完成 · {done}/{total}',
  'harness.overview.summary.changed': '{count} 個檔案有變更',
  'harness.overview.summary.context': '目前工作脈絡',
  'harness.blocks.title': '記憶與計畫',
  'harness.blocks.edit': '編輯狀態區塊',
  'harness.blocks.cancel': '取消',
  'harness.blocks.save': '儲存',
  'harness.blocks.conflict': '這個狀態區塊已在背景更新，現已載入最新版本；請檢查後再儲存。',
  'harness.knowledge.title': '知識審閱',
  'harness.knowledge.scope.workspace': '工作區',
  'harness.knowledge.scope.user': '使用者',
  'harness.knowledge.content': '知識內容',
  'harness.knowledge.trigger': '召回條件',
  'harness.knowledge.triggerPlaceholder': '何時應該想起它？',
  'harness.knowledge.supersedes': '取代已接受知識',
  'harness.knowledge.dismiss': '駁回',
  'harness.knowledge.save': '儲存',
  'harness.knowledge.accept': '接受',
  'harness.knowledge.rememberWorkspace': '記到專案',
  'harness.knowledge.rememberUser': '記到使用者',
  'harness.knowledge.created': '已加入知識審閱',
  ...
  'harness.sources.remove': '移除來源',
  'harness.pdf.openReader': '閱讀 PDF',
  'harness.pdf.readerTitle': 'PDF 閱讀器',
  'harness.pdf.readerDescription': '檢視頁面、搜尋文字，並將選取區域加入目前對話草稿。',
  'harness.pdf.views': 'PDF 檢視方式',
  'harness.pdf.pageView': '原始頁面',
  'harness.pdf.textView': '目前頁面文字',
  'harness.pdf.structureView': '結構',
  'harness.pdf.cellsView': '儲存格',
  'harness.pdf.openOriginal': '開啟原始檔案',
  'harness.pdf.loading': '正在讀取文件…',
  'harness.pdf.loadingPage': '正在轉譯頁面…',
  'harness.pdf.analyzing': '正在解析文件…',
  'harness.pdf.analyzeStructure': '解析結構',
  'harness.pdf.search': '搜尋文字',
  'harness.pdf.searchPlaceholder': '尋找文件內容',
  'harness.pdf.searchResults': '搜尋結果（{count}）',
  'harness.pdf.noSearchResults': '找不到相符文字。',
  'harness.pdf.textUnavailable': '此文件沒有可擷取的文字。',
  'harness.pdf.noStructure': '目前沒有可用的結構資料。',
  'harness.pdf.headings': '標題',
  'harness.pdf.pages': '頁面',
  'harness.pdf.tables': '表格',
  'harness.pdf.tablesFound': '偵測到 {count} 個表格。',
  'harness.pdf.pageLayouts': '頁面版面',
  'harness.pdf.layoutsFound': '偵測到 {count} 個頁面版面。',
  'harness.pdf.figures': '圖示',
  'harness.pdf.figureNumber': '圖 {index}',
  'harness.pdf.formulas': '公式候選',
  'harness.pdf.pageAlt': '{title}，第 {page} 頁',
  'harness.pdf.pageNumber': '第 {page} 頁',
  'harness.pdf.previousPage': '上一頁',
  'harness.pdf.goToPage': '跳至頁面',
  'harness.pdf.nextPage': '下一頁',
  'harness.pdf.zoomOut': '縮小',
  'harness.pdf.zoomIn': '放大',
  'harness.pdf.selectedRegion': '已選取頁面區域',
  'harness.pdf.regionSelected': '已選取區域',
  'harness.pdf.askAboutSelection': '針對此處提問',
  'harness.pdf.addingToDraft': '正在加入草稿…',
  'harness.pdf.addedToDraft': '已加入目前對話草稿。',
  'harness.pdf.hitHasNoRegion': '此文字匹配沒有頁面座標。',
  'harness.pdf.sessionMissing': '請先開啟對話，再閱讀或引用此 PDF。',
  'harness.pdf.sessionChanged': '請切回擁有此 PDF 的工作階段，再閱讀或引用。',
  'harness.pdf.sessionWorkspaceRequired': '請在此工作區開啟對話後搜尋或引用 PDF。下方仍可檢視原始檔案。',
  'harness.pdf.sourceUnavailable': '此工作階段無法讀取這份 PDF。',
  'harness.pdf.sourceHashUnavailable': '缺少原始檔案雜湊，無法引用此區域。',
  'harness.pdf.pageImageUnavailable': '無法讀取此頁影像。',
  'harness.pdf.analysisUnavailable': '無法使用結構解析：{reason}',
  'harness.pdf.ocrUnavailable': '無法對此文件執行 OCR。',
  'harness.pdf.readCurrentPageWithOcr': '辨識目前頁面的文字（OCR）',
  'harness.pdf.ocrUsed': '已辨識目前頁面的文字。',
  'harness.pdf.ocrNotNeeded': '此頁已有可擷取文字，不需要 OCR。',
  'harness.pdf.sourceHashMismatch': '此引用對應的 PDF 原件不同。請重新載入材料後再引用。',
  'harness.pdf.runtimeChanged': '連線的 Host 已切換。請在目前工作階段中重新開啟 PDF。',
  'harness.pdf.analysisRange': '結構解析範圍',
  'harness.pdf.currentPage': '目前頁面',
  'harness.pdf.wholeDocument': '整份文件',
  'harness.pdf.readingOrder': '閱讀順序（{count}）',
  'harness.pdf.elements': '偵測到的元素',
  'harness.pdf.tableCells': '{count} 個儲存格',
  'harness.pdf.element.section': '章節',
  'harness.pdf.element.table': '表格',
  'harness.pdf.element.figure': '圖示',
  'harness.pdf.element.formula': '公式',
  'harness.sources.originalSource': '原始來源',
  'harness.threads.discussion': '討論線',
  'harness.threads.userThread': '使用者執行緒',
  'harness.threads.kind.discussion': '討論',
  'harness.threads.kind.implementation': '實作',
  'harness.threads.convert': '轉為實作執行緒',
  'harness.threads.converting': '正在轉換…',
  'harness.threads.convertFailed': '無法轉換討論線',
  'harness.threads.ask': '提問',
  'harness.threads.askPlaceholder': '向該執行緒提問或下達指令…',
  'harness.threads.fresh': '全新',
  'harness.threads.note': '留言',
  'harness.threads.sendFailed': '無法送達訊息',
  'harness.threads.peer.user': '使用者',
  'harness.threads.peer.session': '父會話',
  'harness.threads.msg.inform': '留言',
  'harness.threads.msg.request': '請求',
  'harness.threads.msg.held': '已保留待下次執行',
  'harness.threads.merge': '合併結果',
  'harness.threads.merging': '正在合併…',
  'harness.threads.mergeFailed': '無法合併執行緒結果',
  'harness.threads.undoMerge': '復原編輯器合併',
  'harness.threads.undoUnavailable': '編輯器合併已無法復原',
  'harness.threads.chooseParent': '保留父內容',
  'harness.threads.chooseChild': '使用子結果',
  'harness.threads.chooseBase': '使用基線',
  'harness.threads.unavailable': '目標不可用',
  'harness.threads.surfacePending': '編輯器草稿',
  'harness.threads.previewStale': '此預覽已失效',
  'harness.threads.previewApplicability': '合併預覽只說明能否套用，不代表測試通過。',
  'harness.threads.verification.child': '結果檢查（r{revision}）',
  'harness.threads.verification.childEmpty': '該結果尚未記錄命令',
  'harness.threads.verification.childUncertain': '綁定不確定：{reason}',
  'harness.threads.verification.command': '退出 {code} · {command}',
  'harness.threads.verification.merge': '合併可套用性',
  'harness.threads.verification.parent': '合併後的父狀態檢查',
  'harness.threads.verification.parentUnsaved': '草稿合併未儲存；磁碟命令不能驗證未儲存緩衝',
  'harness.threads.verification.parentNone': '此次合併尚未記錄父工作階段檢查',
  'harness.threads.verification.review': '審閱（r{revision}）',
  'harness.threads.verification.reviewRunning': '正在審閱',
  'harness.threads.verification.reviewNone': '尚未審閱',
  'harness.threads.state.dirty': '有未發佈結果',
  'chat.messageBody.actions.openThreadAria': '從這條訊息開一條討論線',
  'chat.messageBody.actions.openThread': '從這裡開一條線',
  'chat.messageBody.actions.openThreadWithoutBlocks': '開一條不含記憶區塊的討論線',
  'chat.messageBody.actions.openThreadFailed': '無法從這條訊息建立討論線',
  ...
  'harness.threads.state.completed': '已完成',
  'harness.threads.state.failed': '失敗',
  'harness.threads.state.cancelled': '已取消',
  'harness.threads.state.interrupted': '已中斷',
  'harness.threads.state.merge-ready': '待合併',
  'harness.threads.state.conflict': '有衝突',
  'harness.threads.state.merged': '已合併',
  'harness.threads.state.archived': '已封存',
  'harness.threads.archive': '封存',
  'harness.threads.archiving': '正在封存…',
  'harness.threads.archiveFailed': '無法封存該執行緒',
  'harness.threads.restore': '還原',
  'harness.threads.restoring': '正在還原…',
  'harness.threads.restoreFailed': '無法還原該執行緒',
  'harness.threads.reclaim': '回收目錄',
  'harness.threads.reclaiming': '正在回收…',
  'harness.threads.reclaimFailed': '無法回收執行緒目錄',
  'harness.threads.keepWorktree': '保留目錄',
  ...
  'harness.threads.hideArchived': '隱藏已封存',
  'harness.threads.space.title': '占用',
  'harness.threads.space.bytes': '{bytes} B',
  'harness.threads.space.unknownSize': '未知',
  'harness.threads.space.logical': '目錄 {bytes}',
  'harness.threads.space.overBudget': '已超過設定的工作樹預算',
  'harness.threads.space.lowFree': '剩餘空間低於設定的最低比例',
  'harness.threads.space.enospc': '磁碟空間不足',
  'harness.threads.space.kept': '保留原因：{reason}',
  'harness.threads.empty': '此檢視沒有執行緒',
  'harness.threads.history.open': '歷史結果',
  'harness.threads.history.title': '執行緒結果歷史',
  'harness.threads.history.loading': '正在載入歷史結果…',
  'harness.threads.history.loadFailed': '無法載入執行緒結果歷史',
  'harness.threads.history.retry': '重試',
  'harness.threads.history.empty': '此執行緒沒有原生結果。',
  'harness.threads.history.revision': '結果 r{revision}',
  'harness.threads.history.select': '選取要釋放的結果 r{revision}',
  'harness.threads.history.bytes': '{bytes} B',
  'harness.threads.history.retainedBytesNote': '顯示此版本引用的內容大小；共用內容在所有引用釋放後才會回收。',
  'harness.threads.history.protected': '受保護：{reasons}',
  'harness.threads.history.protected.branchHead': '分支頭',
  'harness.threads.history.protected.currentResult': '目前結果',
  'harness.threads.history.protected.runInput': '作用中 Run 輸入',
  'harness.threads.history.protected.review': '正在審閱',
  'harness.threads.history.protected.integration': '待處理 Integration',
  'harness.threads.history.release': '釋放已選 {count} 項',
  'harness.threads.history.releasing': '正在釋放…',
  'harness.threads.history.releaseFailed': '無法釋放所選結果',
  'harness.threads.history.confirmTitle': '釋放所選結果？',
  'harness.threads.history.confirmDescription': '要釋放此執行緒中的 {count} 個所選結果嗎？',
  'harness.threads.history.confirmWarning': '釋放後將無法再讀取或合併這些版本。報告、工作階段轉錄及其他所有者引用的內容會保留。',
  'harness.threads.history.cancel': '取消',
  'harness.threads.history.confirm': '釋放結果',
  'harness.threads.history.released': '已釋放 {count} 個結果。',
  'harness.threads.history.missing': '所選結果中有 {count} 個已不存在。',
  'harness.threads.history.cleanupComplete': '清理已刪除 {objects} 個物件，回收 {bytes} B。',
  'harness.threads.history.cleanupFailed': '歷史版本已移除，清理尚未完成：{message}',
  'harness.threads.history.retryCleanup': '重試清理',
  ...
  'mobile.connect.welcome.title': '連線至 Varin',
  ...
  'mobile.connect.password.placeholder': 'Varin 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Varin 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 Varin Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Varin 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Varin。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Varin，但與此應用程式版本不相容。請更新伺服器上的 Varin 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Varin 伺服器與此應用程式版本不相容。請更新伺服器上的 Varin 後重試。',
  ...
  'sessions.sidebar.grouping.generalChat': '一般對話',
  'sessions.sidebar.grouping.recent': '最近',
  ...
  'sessions.scheduledTasks.dialog.confirm.deleteLoopFile': '刪除「{taskName}」對應的循環檔案？',
  'sessions.scheduledTasks.dialog.loopFile.project': '專案循環',
  'sessions.scheduledTasks.dialog.loopFile.user': '使用者循環',
  'sessions.scheduledTasks.loopEditor.title': '編輯循環',
  'sessions.scheduledTasks.loopEditor.description': '編輯作為權威來源的 Markdown 循環檔案。',
  'sessions.scheduledTasks.loopEditor.confirmDiscard': '放棄尚未儲存的循環修改？',
  ...
  'sessions.scheduledTasks.editor.goal.budgetLabel': 'token 預算',
  'sessions.scheduledTasks.editor.goal.budgetAria': '以 token 預算限制該目標',
  ...
  'sessions.sidebar.footer.actions.aboutVarin': '關於 Varin',
  ...
  'sessions.sidebar.project.actions.pin': '釘選到頂端',
  'sessions.sidebar.project.actions.archiveChats': '封存聊天',
  'sessions.sidebar.project.actions.remove': '移除專案',
  'sessions.sidebar.project.reveal.error': '無法開啟專案目錄',
  'sessions.sidebar.dialogs.removeProject.title': '移除專案？',
  'sessions.sidebar.dialogs.removeProject.description': '「{projectTitle}」將從側邊欄移除。聊天和檔案都會保留。',
  'sessions.sidebar.project.actions.newDraftSession': '新增草稿會話',
  'sessions.sidebar.session.menu.rename': '重新命名',
  'sessions.sidebar.session.menu.restore': '恢復會話',
  ...
  'sessions.sidebar.session.unarchive.success': '會話已恢復',
  'sessions.sidebar.session.unarchive.error': '恢復會話失敗',
  ...
  'contextRail.surface.git.changesCountAria': '{label}，{count} 個變更的檔案',
  'contextRail.surface.git.changesCountTooltip': '{count} 個變更的檔案',
  ...
  'contextRail.surface.context.description': '工作階段情境與 token 用量',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Varin 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.splitEditor': '分割編輯器',
  'filesView.editor.pinTab': '釘選分頁',
  'filesView.editor.unpinTab': '取消釘選分頁',
  'filesView.editor.moveTab': '移至其他群組',
  'filesView.editor.splitHorizontal': '向下分割編輯器',
  'filesView.editor.providerAmbiguous': '選擇編輯器',
  'filesView.editor.providerUnavailable': '沒有可用於此檔案的已啟用編輯器。',
  'filesView.editor.syncRecovered': '編輯器同步衝突後已保留你的輸入。請在儲存前檢查內容。',
  'filesView.editor.languageStarting': '正在啟動語言功能…',
  'filesView.editor.languageDegraded': '部分語言功能暫時無法使用：{message}',
  'filesView.editor.languageFailed': '語言功能啟動失敗：{message}',
  'filesView.workspaceEdit.renameTitle': '預覽重新命名',
  'filesView.workspaceEdit.actionTitle': '預覽變更',
  'filesView.workspaceEdit.descriptionSingle': '將變更 {count} 個檔案，請在套用前檢查。',
  'filesView.workspaceEdit.descriptionMany': '將變更 {count} 個檔案，請在套用前逐一檢查。',
  'filesView.workspaceEdit.files': '待變更檔案',
  'filesView.workspaceEdit.editCountSingle': '{count} 處編輯',
  'filesView.workspaceEdit.editCountMany': '{count} 處編輯',
  'filesView.workspaceEdit.showFocused': '只顯示變更區域',
  'filesView.workspaceEdit.showFull': '顯示完整檔案',
  'filesView.workspaceEdit.before': '變更前',
  'filesView.workspaceEdit.after': '變更後',
  'filesView.workspaceEdit.noChanges': '沒有文字變更',
  'filesView.workspaceEdit.apply': '套用變更',
  'filesView.workspaceEdit.renameDescription': '重新命名為 {name}。套用前請檢查所有受影響的檔案。',
  'filesView.workspaceEdit.unavailable': '此位置沒有可用的重新命名或程式碼操作。',
  'filesView.workspaceEdit.stale': '文件或語言服務已變更，請重試。',
  'filesView.workspaceEdit.cancelled': '未套用變更。',
  'filesView.workspaceEdit.failed': '無法套用語言服務變更',
  'filesView.workspaceEdit.appliedSingle': '已變更 {count} 個檔案',
  'filesView.workspaceEdit.appliedMany': '已變更 {count} 個檔案',
  'filesView.workspaceEdit.undo': '復原',
  'filesView.workspaceEdit.undone': '已復原變更',
  'filesView.workspaceEdit.undoUnavailable': '這些變更已無法作為單一操作復原。',
  'filesView.editor.useProvider': '使用 {provider}',
  'filesView.editor.diffAgainstDisk': '工作複本與上次儲存內容的對照',
  'workbench.panel.terminal': '終端機',
  'workbench.panel.problems': '問題',
  'workbench.panel.output': '輸出',
  'workbench.panel.problemsEmpty': '此工作區沒有問題。',
  'workbench.panel.outputEmpty': '沒有輸出通道。',
  'workbench.panel.problemsFailed': '無法載入問題：{message}',
  'workbench.panel.problemsItem': '{resourceId}: {message}',
  'workbench.panel.problemsItemAtLine': '{resourceId}:{line}: {message}',
  'workbench.panel.problemsOpenAria': '開啟 {resourceId}',
  'workbench.panel.outputFailed': '無法載入輸出：{message}',
  'workbench.panel.changes': '變更',
  'workbench.panel.changesEmpty': '此工作區沒有 Agent 或未儲存的檔案變更。',
  'workbench.panel.changesOpenAria': '開啟 {resourceId}',
  'workbench.panel.changesConflict': '衝突',
  'workbench.panel.changesDirty': '未儲存',
  'workbench.panel.changesAgent': 'Agent',
  'workbench.panel.changesOpen': '已開啟',
  'workbench.panel.changesItem': '{resourceId} · {state} · {revision}',
  'workbench.attachment.chipUnsaved': '未儲存快照：{name}',
  'workbench.attachment.chipSaved': '已儲存檔案：{name}',
  'workbench.attachment.chipSelection': '選取範圍：{name}',
  'workbench.attachment.chipDiagnostic': '問題：{name}',
  'workbench.attachment.chipDiff': '差異：{name}',
  'workbench.attachment.attachDiff': '將差異附加至智能體',
  'workbench.attachment.removeAria': '從 Agent 內容中移除 {name}',
  'workbench.attachment.unsavedBadge': '未儲存快照',
  'workbench.attachment.missing-editor': '沒有可附加的作用中編輯器。',
  'workbench.attachment.missing-selection': '請先在編輯器中選取文字。',
  'workbench.attachment.missing-document': '該文件未在工作台中開啟。',
  'workbench.attachment.wrong-runtime': '此附件屬於另一個 Agent 執行階段。',
  'workbench.attachment.no-session': '請先開啟 Agent 工作階段再附加編輯器內容。',
  'workbench.patch.acceptHunk': '保留此區塊',
  'workbench.patch.rejectHunk': '還原此區塊',
  'workbench.patch.applyAccepted': '套用保留的區塊',
  'workbench.patch.revertRejected': '還原已拒絕的區塊',
  'workbench.patch.written': '修補已套用至編輯器緩衝區，確認後再儲存。',
  'workbench.patch.conflict': '檔案有未儲存的編輯或更新的版本。請先解決編輯器衝突。',
  'workbench.patch.failed': '無法套用修補：{message}',
  'workbench.ide.title': 'IDE 工作台',
  'workbench.ide.activity.explorer': '檔案總管',
  'workbench.ide.activity.search': '搜尋',
  'workbench.ide.activity.git': 'Git',
  'workbench.ide.activity.run': '執行與測試',
  'workbench.ide.activity.extensions': '擴充功能',
  'workbench.ide.activity.explorerAria': '顯示檔案總管',
  'workbench.ide.activity.searchAria': '顯示搜尋',
  'workbench.ide.activity.gitAria': '顯示 Git',
  'workbench.ide.activity.runAria': '顯示執行與測試',
  'workbench.ide.activity.extensionsAria': '顯示擴充功能',
  'workbench.ide.sidebar.hideSecondary': '隱藏代理程式側欄',
  'workbench.ide.sidebar.showSecondary': '顯示代理程式側欄',
  'workbench.ide.sessions': '工作階段',
  'workbench.ide.sessionsAria': '開啟工作階段清單',
  'workbench.ide.search.placeholder': '依檔名搜尋',
  'workbench.ide.search.empty': '沒有符合的檔案。',
  'workbench.ide.search.failed': '搜尋失敗：{message}',
  'workbench.ide.search.noWorkspace': '請先開啟工作區再搜尋檔案。',
  'workbench.ide.search.searching': '正在搜尋...',
  'workbench.ide.search.filesTab': '檔案',
  'workbench.ide.search.contentTab': '文字',
  'workbench.ide.search.contentPlaceholder': '在工作區中搜尋文字',
  'workbench.ide.search.contentEmpty': '沒有符合的文字。',
  'workbench.ide.search.contentFailed': '文字搜尋失敗：{message}',
  'workbench.ide.search.contentNoWorkspace': '請先開啟工作區再搜尋文字。',
  'workbench.ide.search.filesAria': '依檔名搜尋',
  'workbench.ide.search.contentAria': '在檔案中搜尋文字',
  'workbench.ide.run.unavailableTitle': '執行與測試尚不可用',
  'workbench.ide.run.unavailableDescription': '偵錯配接器和測試提供者會在後續工作台更新中提供。編輯、搜尋、Git、終端機和代理程式仍可使用。',
  'workbench.ide.run.noWorkspace': '開啟工作區以執行、偵錯和測試。',
  'workbench.ide.run.tasks': '工作',
  'workbench.ide.run.runTask': '執行 {label}',
  'workbench.ide.run.emptyTasks': '尚未定義工作。請新增包含 node 指令碼的 varin.tasks.json 檔案。',
  'workbench.ide.run.tasksFailed': '無法載入工作：{message}',
  'workbench.ide.run.unsupported': '此執行階段不支援執行、偵錯和測試。',
  'workbench.ide.debug.title': '偵錯',
  'workbench.ide.debug.start': '開始',
  'workbench.ide.debug.stop': '停止',
  'workbench.ide.debug.continue': '繼續',
  'workbench.ide.debug.stepOver': '逐步略過',
  'workbench.ide.debug.stepInto': '逐步進入',
  'workbench.ide.debug.stepOut': '逐步跳出',
  'workbench.ide.debug.programAria': '要偵錯的程式',
  'workbench.ide.debug.paused': '已暫停',
  'workbench.ide.debug.running': '正在執行',
  'workbench.ide.debug.failed': '偵錯失敗：{message}',
  'workbench.ide.debug.absent': '沒有偵錯工作階段',
  'workbench.ide.debug.breakpoints': '中斷點',
  'workbench.ide.debug.breakpointsEmpty': '沒有中斷點。可在編輯器中切換中斷點。',
  'workbench.ide.debug.callStack': '呼叫堆疊',
  'workbench.ide.debug.variables': '變數',
  'workbench.ide.debug.watch': '監看',
  'workbench.ide.debug.watchAdd': '新增',
  'workbench.ide.debug.watchRemove': '移除',
  'workbench.ide.debug.console': '偵錯主控台',
  'workbench.ide.debug.consolePlaceholder': '求值運算式',
  'workbench.ide.debug.evaluate': '求值',
  'workbench.ide.tests.title': '測試',
  'workbench.ide.tests.run': '執行測試',
  'workbench.ide.tests.discover': '探索',
  'workbench.ide.tests.empty': '找不到測試。',
  'workbench.ide.tests.failedLoad': '無法載入測試：{message}',
  'workbench.ide.tests.failedItem': '{label} 失敗',
  'workbench.ide.tests.passedItem': '{label} 通過',
  'workbench.ide.tests.runningItem': '{label} 正在執行',
  'workbench.attachment.chipTestFailure': '測試失敗：{name}',
  'workbench.attachment.chipStack': '堆疊：{name}',
  'workbench.attachment.missing-test': '沒有可附加的測試失敗。',
  'workbench.attachment.missing-stack': '沒有可附加的堆疊影格。',
  'workbench.ide.extensions.openSettings': '開啟擴充功能設定',
  'workbench.ide.extensions.empty': '尚未載入擴充功能。',
  'workbench.ide.status.noWorkspace': '沒有工作區',
  'workbench.ide.status.noBranch': '沒有分支',
  'workbench.ide.commandPalette': '命令面板',
  'workbench.ide.commandPaletteAria': '開啟命令面板',
  'workbench.ide.settings': '設定',
  'workbench.ide.settingsAria': '開啟設定',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 Varin 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'filesView.document.conflict.title': '磁碟上的檔案已變更',
  'filesView.document.conflict.description': '你尚未儲存的編輯與最新檔案內容不一致。',
  'filesView.document.conflict.keepEdits': '保留我的編輯',
  'filesView.document.conflict.reloadDisk': '從磁碟重新載入',
  'filesView.document.conflict.agentDescription': 'Agent 或其他行程在你有未儲存編輯時變更了此檔案。',
  'filesView.document.conflict.ancestor': '原始內容',
  'filesView.document.conflict.yours': '你的編輯',
  'filesView.document.conflict.disk': '磁碟上',
  'filesView.document.conflict.merge': '檢視三方合併',
  'filesView.document.conflict.acceptOurs': '保留我的',
  'filesView.document.conflict.acceptTheirs': '採用磁碟',
  'filesView.document.conflict.editHunk': '編輯合併文字',
  'filesView.document.conflict.applyEdited': '儲存已編輯的合併結果',
  'filesView.document.deleted.title': '此檔案已被刪除',
  'filesView.document.deleted.description': '尚未儲存的編輯仍在。儲存將重新建立該檔案。',
  'filesView.document.outsideWorkspace': '此路徑位於工作區之外，無法在此編輯。',
  ...
  'contextSidebar.section.contextPreparation': '內容準備',
  'contextSidebar.context.preparation.disabled': '背景準備已關閉',
  'contextSidebar.context.candidate.none': '閒置',
  'contextSidebar.context.candidate.preparing': '正在準備摘要',
  'contextSidebar.context.candidate.ready': '摘要就緒',
  'contextSidebar.context.status.preparationFailed': '背景準備最近失敗。',
  'contextSidebar.context.status.compactionFailed': '壓縮提交最近失敗。',
  ...
  'contextSidebar.tokens.cacheWrite1h': '1 小時快取寫入',
  'contextSidebar.tokens.cacheHit': '快取命中',
  'contextSidebar.tokens.total': '總計',
  ...
  'header.services.shutdownDev': '停止 Varin',
  ...
  'chat.goal.dialog.budgetLabel': 'token 預算',
  ...
  'chat.followup.status.waiting': '等待中',
  'chat.followup.status.triggered': '已觸發',
  'chat.followup.status.delivered': '已送達',
  'chat.followup.status.cancelled': '已取消',
  'chat.followup.status.superseded': '已取代',
  'chat.followup.status.unavailable': '不可用',
  'chat.followup.action.check': '檢查',
  'chat.followup.action.checkHint': '由程式檢查來源，不呼叫 Agent',
  'chat.followup.action.fire': '立即執行',
  'chat.followup.action.fireHint': '觸發後續並呼叫 Agent',
  'chat.followup.action.cancel': '取消',
  'chat.followup.action.cancelHint': '僅停止等待——被觀察的工作繼續執行',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Varin 需要存取此資料夾。',
  ...
  'pi.interaction.extensionFallback': 'Pi 擴充功能',
  'pi.interaction.trust.description': 'Pi 在此工作區發現了專案提供的擴充功能與資源。信任後將允許這些程式碼執行。',
  'pi.interaction.trust.remember': '記住對此工作區的選擇',
  'pi.interaction.trust.title': '信任專案擴充功能？',
  'pi.interaction.trust.workspace': '工作區',
  'aboutDialog.actions.openDiagnostics': '開啟診斷',
  'aboutDialog.diagnosticsDescription': '查看 Pi 執行環境、套件、外掛、會話與專案上下文。',
  'aboutDialog.footerNote': '為社群用心打造',
  'helpDialog.title': '鍵盤快速鍵',
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Varin',
  ...
  'header.actions.openAppMenu': 'Varin 選單',
  'header.actions.openAppMenuAria': '開啟 Varin 選單',
  ...
  'chat.emptyState.draftTitle': '我們要做什麼？',
  'chat.emptyState.draftTitleWithProject': '我們要在 {project} 中做什麼？',
  ...
  'chat.piComposer.sendResultUnknown': '訊息送出後連線中斷，結果尚不確定。請先檢查工作階段，再決定是否重送。',
  ...
  'commandPalette.item.splitEditor': '分割編輯器',
  'commandPalette.item.splitEditorOrthogonal': '正交分割編輯器',
  'commandPalette.item.closeEditor': '關閉編輯器',
  'commandPalette.item.saveActiveFile': '儲存檔案',
  'commandPalette.item.saveAllFiles': '儲存所有檔案',
  'commandPalette.item.findInFile': '在檔案中尋找',
  'commandPalette.item.replaceInFile': '在檔案中取代',
  'commandPalette.item.goToLine': '前往行',
  'commandPalette.item.goToSymbol': '前往符號',
  'commandPalette.item.formatDocument': '格式化文件',
  'commandPalette.item.renameSymbol': '重新命名符號',
  'commandPalette.item.quickFix': '快速修正',
  'commandPalette.item.goToDefinition': '前往定義',
  'commandPalette.item.findReferences': '尋找參考',
  'commandPalette.item.foldRegion': '摺疊區域',
  'commandPalette.item.unfoldRegion': '展開區域',
  'commandPalette.item.toggleEditorWrap': '切換自動換行',
  'commandPalette.item.toggleEditorMinimap': '切換縮圖',
  'commandPalette.item.addCursorAbove': '在上方新增游標',
  'commandPalette.item.addCursorBelow': '在下方新增游標',
  'commandPalette.item.focusPreviousEditorGroup': '聚焦上一個編輯器群組',
  'commandPalette.item.focusNextEditorGroup': '聚焦下一個編輯器群組',
  'commandPalette.session.untitled': '未命名會話',
  'varinDiagnosticsDialog.title': 'Varin 診斷',
  'varinDiagnosticsDialog.description': '查看目前 Pi 執行環境，以及不含憑證的套件、外掛、會話與專案狀態摘要。',
  'varinDiagnosticsDialog.actions.copy': '複製',
  'varinDiagnosticsDialog.actions.refresh': '重新整理',
  'varinDiagnosticsDialog.empty.noData': '目前沒有診斷資訊。',
  'varinDiagnosticsDialog.state.collecting': '正在收集診斷資訊...',
  'varinDiagnosticsDialog.state.failed': '收集診斷資訊失敗：{error}',
  'varinDiagnosticsDialog.toast.copiedTitle': '已複製',
  'varinDiagnosticsDialog.toast.copiedDescription': '診斷資訊已複製到剪貼簿',
  'varinDiagnosticsDialog.toast.copyFailed': '複製診斷資訊失敗',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 Varin，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Varin',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Varin 伺服器之間切換',
  ...
  'multiRun.window.description': 'Varin 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Varin',
  'onboarding.chooser.description': '使用 Varin 內建的 Pi、在設定中選擇其他本機安裝，或連線至遠端 Varin 伺服器。',
  'onboarding.chooser.tabs.localInstall': '本機工作區',
  'onboarding.chooser.tabs.connectRemote': '連線遠端',
  'onboarding.localSetup.title': '本機工作區執行環境',
  'onboarding.localSetup.description': 'Varin 已內建 Pi，不需要另外安裝。預設本機執行環境可以直接啟動；你也可以在設定中選擇其他本機安裝。',
  'onboarding.localSetup.status.ready': '本機工作區執行環境已就緒',
  'onboarding.localSetup.status.readyWithVersion': 'Pi {version} 已就緒',
  'onboarding.localSetup.status.readyDetail': '{source}，位於 {commandPath}',
  'onboarding.localSetup.status.missing': '本機工作區執行環境無法使用',
  'onboarding.localSetup.status.missingDetail': '所選執行環境無法使用。請重試或選擇其他安裝；若使用的是內建執行環境，可重新安裝 Varin 進行修復。',
  'onboarding.localSetup.status.upgradeRequired': '目前的 Pi 版本過舊',
  'onboarding.localSetup.status.upgradeRequiredDetail': '已安裝的 {currentVersion} 低於最低要求 {targetVersion}。請升級此安裝；Varin 不會降級較新的 Pi。',
  'onboarding.localSetup.status.failed': '本機工作區執行環境無法啟動',
  'onboarding.localSetup.status.hostEntryUnavailable': 'Varin 安裝需要修復',
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '啟動工作區執行環境所需的應用程式 Host 檔案遺失或無法存取。請重新下載並安裝 Varin；升級或改選 Pi 無法修復這些應用程式檔案。',
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': '技術詳情',
  'onboarding.localSetup.status.checking': '正在啟動工作區執行環境',
  'onboarding.localSetup.status.checkingDetail': '正在啟動 Varin 工作區執行環境…',
  'onboarding.localSetup.status.installing': '正在安裝 Pi',
  'onboarding.localSetup.status.upgrading': '正在升級 Pi',
  'onboarding.localSetup.status.discovering': '正在啟動工作區執行環境',
  'onboarding.localSetup.status.probing': '正在檢查工作區執行環境',
  'onboarding.localSetup.errors.timeout': '工作區執行環境交握逾時。請重試，或連線至遠端伺服器。',
  'onboarding.localSetup.errors.managerUnavailable': '目前介面無法管理本機工作區執行環境。',
  'onboarding.localSetup.runtime.piVersion': 'Pi',
  'onboarding.localSetup.runtime.hostVersion': 'Varin 主機',
  'onboarding.localSetup.runtime.nodeVersion': 'Node.js',
  'onboarding.localSetup.runtime.source': '來源',
  'onboarding.localSetup.runtime.source.system': '系統',
  'onboarding.localSetup.runtime.source.standalone': '獨立安裝',
  'onboarding.localSetup.runtime.source.custom': '自訂',
  'onboarding.localSetup.runtime.source.development': '開發',
  'onboarding.localSetup.runtime.source.bundled': 'Varin 內建',
  'onboarding.localSetup.runtime.commandPath': '命令',
  'onboarding.localSetup.actions.continue': '使用本機工作區',
  'onboarding.localSetup.actions.useThisPi': '使用此 Pi',
  'onboarding.localSetup.actions.installPi': '安裝 Pi',
  'onboarding.localSetup.actions.upgradePi': '升級 Pi',
  'onboarding.localSetup.actions.selectExisting': '選擇既有安裝',
  'onboarding.localSetup.actions.retryDetect': '重新偵測',
  'onboarding.localSetup.actions.downloadVarinAgain': '重新下載 Varin',
  'onboarding.localSetup.customPath.placeholder': 'Pi 套件根目錄路徑',
  'onboarding.localSetup.customPath.apply': '使用此路徑',
  'onboarding.localSetup.installPlan.summary': '將透過 {manager} 安裝 {version}。',
  'onboarding.localSetup.installPlan.location': '位置：{location}',
  'onboarding.localSetup.actions.continuing': '正在開啟…',
  'onboarding.localSetup.actions.checking': '檢查中…',
  'onboarding.localSetup.actions.retry': '重試',
  'onboarding.localSetup.remotePreference': '偏好使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連線至遠端伺服器 →',
  'onboarding.remoteConnection.title': '連接遠端伺服器',
  'onboarding.remoteConnection.titleRecovery': '連接到其他伺服器',
  'onboarding.remoteConnection.description': '輸入要連接的 Varin 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Varin 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Varin。請確認位址是否指向 Varin 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本機工作區執行環境無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': '本機工作區執行環境無法啟動。請重試執行環境，或改為連線至遠端伺服器。',
  'onboarding.desktopRecovery.localUnavailable.retry': '重試本機執行環境',
  'onboarding.desktopRecovery.localUnavailable.useLocal': '使用本機執行環境',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Varin。請確認位址是否指向 Varin 伺服器。',
  ...
  'startup.initRecovery.description': 'Varin 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  'startup.initRecovery.retry': '重試',
  'startup.initRecovery.retrying': '重試中…',
  'workbench.recovery.title': '工作台無法使用',
  'workbench.recovery.description': '所選工作台 Shell 無法執行。請重新啟用其擴充、選擇其他設定檔，或開啟擴充設定。',
  'workbench.recovery.reenable': '重新啟用 Shell',
  'workbench.recovery.chooseProfile': '選擇其他設定檔',
  'workbench.recovery.openExtensions': '開啟擴充',
  ...
  'updateDialog.header.updating': '正在更新 Varin...',
  'updateDialog.header.restarting': '正在重新啟動 Varin…',
  ...
  'updateDialog.status.desktopRestarting': '正在重新啟動以安裝更新…',
  'updateDialog.status.desktopRestartingHint': 'Varin 正在關閉背景服務並交由安裝程式處理，請稍候。',
  ...
  'updateDialog.actions.restarting': '正在重新啟動…',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：varin update',
  'mobileUpdate.toast.available.title': 'Varin 更新可用',
  ...
  'varinLogo.aria.logo': 'Varin 標誌',
  'splash.aria.loading': '正在載入 Varin',
  'splash.aria.switching': '正在切換工作台 Profile',
  'splash.switching': '正在切換工作台',
  'splash.switchingTo': '正在切換到 {profile}',
  'splash.status.startingDesktop': '正在啟動桌面外殼',
  'splash.status.connectingRuntime': '正在啟動工作區',
  'splash.status.preparingWorkspace': '正在準備工作區',
  'splash.status.desktopFailed': '桌面啟動失敗，請重新啟動應用程式。',
  'splash.status.desktopSlow': '啟動時間比預期長',
  ...
  'header.services.tokenUsage.cache': '快取',
  'header.services.tokenUsage.cacheBreakdown': '快取讀取 {read} · 寫入 {write}',
  'header.services.tokenUsage.description': '最近一次助理回覆的 token 計數。',
  'header.services.tokenUsage.input': '輸入',
  'header.services.tokenUsage.output': '輸出',
  'header.services.tokenUsage.reasoning': '推理',
  'header.services.tokenUsage.title': 'token 用量',
  'header.services.tokenUsage.total': '總計',
  ...
  'contextPanel.recovery.actions.redo': '重做',
  'contextPanel.recovery.actions.checkpoint': '建立檢查點',
  'contextPanel.recovery.checkpoint.placeholder': '檢查點名稱',
  ...
  'contextPanel.recovery.actions.repair': '修復提示詞',
  'contextPanel.recovery.actions.repairTypo': '修復拼字錯誤',
  'contextPanel.recovery.actions.repairDestructive': '破壞性修復',
  'contextPanel.recovery.toast.failed': '復原失敗：{message}',
  'contextPanel.recovery.toast.applied': '已由 {provider} 完成復原',
  'contextPanel.recovery.toast.cancelled': '{provider} 已取消復原',
  'contextPanel.recovery.toast.delegated': '復原已交由 {provider}；外掛會回報最終結果',
  'contextPanel.recovery.destructive.description': '破壞性修復會重寫 Pi 工作階段歷史，無法復原，也不會還原檔案或外部副作用。',
  ...
  'walkthrough.blocked.chooseModel': '選擇其他模型',
  ...
  'walkthrough.blocked.serverUnsupported.description': '目前連線的 Varin 伺服器未回應導讀 API。請更新 Varin 後重新整理。',
