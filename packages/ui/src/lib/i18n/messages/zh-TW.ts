...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.recoveryDialog.noFileChanges': '此檢查點與目前工作區之間沒有檔案變更。',
  'chat.recoveryDialog.confirmSelection': '以所選方式繼續復原',
  'chat.recoveryDialog.modeConflict': '此次復原已使用其他選項啟動。請關閉此對話框後重新選擇。',
