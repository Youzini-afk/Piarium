...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.workspacePicker.chooseAria': '워크스페이스 선택',
  'sessions.sidebar.workspacePicker.generalChat': '일반 채팅',
  'sessions.sidebar.workspacePicker.addWorkspace': '워크스페이스 추가',
  'sessions.sidebar.workspacePicker.recent': '최근',
