...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.recoveryDialog.noFileChanges': '이 체크포인트에는 현재 작업 공간과 비교해 변경된 파일이 없습니다.',
  'chat.recoveryDialog.confirmSelection': '선택한 복구로 계속',
  'chat.recoveryDialog.modeConflict': '이 복구는 이미 다른 옵션으로 시작되었습니다. 이 대화 상자를 닫고 다시 선택하세요.',
