...
export const dict: Record<I18nKey, string> = {
  ...
  'workbench.patch.written': '현재 파일 리비전으로 패치를 썼습니다.',
  ...
  'chat.workStatus.title': '작업 상태',
  'chat.workStatus.section.session': '세션',
  'chat.workStatus.section.activity': '활동',
  'chat.workStatus.section.pinned': '고정된 컨텍스트',
  'chat.workStatus.toolCalls': '도구 호출',
  'chat.workStatus.tokens': '토큰',
  'chat.workStatus.queue': '대기열',
  'chat.workStatus.state.working': '작업 중',
  'chat.workStatus.state.compacting': '압축 중',
  'chat.workStatus.state.retrying': '재시도 중',
  'chat.workStatus.state.idle': '대기 중',
