...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.openChamberVersionLabel': 'Piarium 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Piarium 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Piarium를 열어 두세요.',
