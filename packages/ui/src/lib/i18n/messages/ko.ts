...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Piarium를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Piarium가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'Piarium에 연결',
  ...
  'mobile.connect.password.placeholder': 'Piarium 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Piarium 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'Piarium Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 Piarium 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutPiarium': 'Piarium 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Piarium에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'Piarium 종료',
  ...
  'workbench.ide.run.emptyTasks': '정의된 작업이 없습니다. node 스크립트가 있는 piarium.tasks.json 파일을 추가하세요.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 Piarium에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Piarium에서 이 폴더에 접근해야 합니다.',
  ...
  'helpDialog.description': '이 단축키로 Piarium를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Piarium 메뉴',
  'header.actions.openAppMenuAria': 'Piarium 메뉴 열기',
  ...
  'piariumDiagnosticsDialog.title': 'Piarium 진단',
  'piariumDiagnosticsDialog.description': '활성 Pi 런타임과 자격 증명이 제외된 패키지, 플러그인, 세션 및 프로젝트 요약을 확인합니다.',
  'piariumDiagnosticsDialog.actions.copy': '복사',
  'piariumDiagnosticsDialog.actions.refresh': '새로 고침',
  'piariumDiagnosticsDialog.empty.noData': '진단 정보가 없습니다.',
  'piariumDiagnosticsDialog.state.collecting': '진단 정보 수집 중...',
  'piariumDiagnosticsDialog.state.failed': '진단 정보 수집 실패: {error}',
  'piariumDiagnosticsDialog.toast.copiedTitle': '복사됨',
  'piariumDiagnosticsDialog.toast.copiedDescription': '진단 정보를 클립보드에 복사했습니다',
  'piariumDiagnosticsDialog.toast.copyFailed': '진단 정보 복사에 실패했습니다',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 Piarium를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'Piarium 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Piarium 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Piarium 멀티런 창.',
  ...
  'onboarding.chooser.description': 'Piarium에 포함된 Pi를 사용하거나, 설정에서 다른 로컬 설치를 선택하거나, 원격 Piarium 서버에 연결하세요.',
  ...
  'onboarding.localSetup.description': 'Piarium에는 Pi가 포함되어 있으므로 별도 설치가 필요하지 않습니다. 기본 로컬 런타임은 바로 시작할 수 있으며, 설정에서 다른 로컬 설치를 선택할 수도 있습니다.',
  ...
  'onboarding.localSetup.status.missingDetail': '선택한 런타임을 사용할 수 없습니다. 다시 시도하거나 다른 설치를 선택하세요. 내장 런타임을 사용했다면 Piarium을 다시 설치해 복구할 수 있습니다.',
  'onboarding.localSetup.status.upgradeRequired': "이 Pi는 너무 오래되었습니다",
  'onboarding.localSetup.status.upgradeRequiredDetail': "설치된 {currentVersion}이 최소 요구 버전 {targetVersion}보다 낮습니다. 이 설치를 업그레이드하세요. Piarium은 더 새로운 Pi를 다운그레이드하지 않습니다.",
  'onboarding.localSetup.status.failed': '로컬 워크스페이스 런타임을 시작할 수 없습니다',
  'onboarding.localSetup.status.hostEntryUnavailable': "Piarium 설치를 복구해야 합니다",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '워크스페이스 런타임을 시작하는 데 필요한 애플리케이션 Host 파일이 없거나 접근할 수 없습니다. Piarium을 다시 다운로드해 설치하세요. Pi를 변경하거나 업그레이드해도 이 파일은 복구되지 않습니다.',
  ...
  'onboarding.localSetup.status.checkingDetail': 'Piarium 워크스페이스 런타임을 시작하는 중…',
  ...
  'onboarding.localSetup.runtime.hostVersion': "Piarium 호스트",
  ...
  'onboarding.localSetup.runtime.source.bundled': 'Piarium 내장',
  ...
  'onboarding.localSetup.actions.downloadPiariumAgain': "Piarium 다시 다운로드",
  ...
  'onboarding.remoteConnection.description': '연결할 Piarium 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Piarium 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Piarium 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Piarium가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Piarium를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Piarium가 실행 중이 아닙니다. 주소가 Piarium 서버를 가리키는지 확인하세요.',
  ...
  'startup.initRecovery.description': 'Piarium 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Piarium 업데이트 중…',
  'updateDialog.header.restarting': 'Piarium 재시작 중…',
  ...
  'updateDialog.status.desktopRestartingHint': 'Piarium이 백그라운드 서비스를 종료하고 설치 프로그램으로 전환하고 있습니다. 잠시 기다려 주세요.',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `piarium update`를 실행하세요.',
  'mobileUpdate.toast.available.title': 'Piarium 업데이트 사용 가능',
  ...
  'piariumLogo.aria.logo': 'Piarium 로고',
  'splash.aria.loading': 'Piarium 로드 중',
  ...
  'walkthrough.blocked.serverUnsupported.description': '연결된 Piarium 서버가 워크스루 API에 응답하지 않았습니다. Piarium을 업데이트한 뒤 새로 고치세요.',
