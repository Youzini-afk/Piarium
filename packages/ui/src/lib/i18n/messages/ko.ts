...
export const dict: Record<I18nKey, string> = {
  ...
  'contextSidebar.section.memory': '메모리',
  'contextSidebar.memory.effective': '적용 모드: {mode}',
  'contextSidebar.memory.inherited': '전역 설정 사용',
  'contextSidebar.memory.override': '세션 재정의',
  'contextSidebar.memory.mode.inherit': '전역 설정 상속',
  'contextSidebar.memory.mode.off': '끔',
  'contextSidebar.memory.mode.assist': '유지 및 주입 (assist)',
  'contextSidebar.memory.mode.takeover': '유지하고 준비되면 압축 인수 (takeover)',
  'contextSidebar.memory.status.updating': '메모리 모드 업데이트 중…',
  'contextSidebar.memory.status.updateFailed': '메모리 모드를 업데이트하지 못했습니다.',
  'contextSidebar.memory.status.keeperFailed': '메모리 키퍼가 최근 실패했습니다.',
  'contextSidebar.memory.status.compactionFailed': '메모리 압축이 최근 실패했습니다.',
