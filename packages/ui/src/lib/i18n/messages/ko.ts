...
export const dict: Record<I18nKey, string> = {
  ...
  'tasksHub.paused': "일시 중지",
  'tasksHub.completed': "완료",
  'tasksHub.scheduledDescription': "에이전트가 정해진 일정에 따라 작업을 실행합니다.",
  'followupEditor.create': "이어가기 작업 만들기",
  'followupEditor.edit': "이어가기 작업 편집",
  'followupEditor.description': "선택한 대화를 이어갑니다. 조건이 이미 충족되었다면 즉시 재개될 수 있습니다.",
  'followupEditor.session': "이어갈 대화",
  'followupEditor.chooseSession': "대화 선택",
  'followupEditor.noSessions': "프로젝트에 연결된 기존 대화를 선택하세요.",
  'followupEditor.instruction': "다음에 할 일",
  'followupEditor.condition': "이어갈 조건",
  'followupEditor.at': "날짜와 시간",
  'followupEditor.path': "작업 공간 기준 상대 파일 경로",
  'followupEditor.branch': "브랜치 (비워 두면 현재 브랜치)",
  'followupEditor.invalidTime': "올바른 날짜와 시간을 선택하세요.",
  'followupEditor.keepSource': "기존 조건 유지",
  'followupEditor.chooseExperiment': "실험 선택",
  'followupEditor.kind.time': "지정 시간",
  'followupEditor.kind.file': "파일 상태",
  'followupEditor.kind.experiment': "실험 종료",
  'followupEditor.kind.external': "Pull Request 상태",
  'followupEditor.kind.manual': "수동 재개",
  'followupEditor.file.exists': "파일 생성",
  'followupEditor.file.changed': "파일이 변경될 때마다",
  'followupEditor.file.ready': "파일 준비 완료",
  'followupEditor.pr.exists': "PR 존재",
  'followupEditor.pr.open': "PR 열림",
  'followupEditor.pr.merged': "PR 병합",
  'followupEditor.pr.closed': "PR 닫힘",
  'tasksHub.title': "예약 및 이어가기",
  'tasksHub.scheduled': "예약 작업",
  'tasksHub.followUps': "이어가기 작업",
  'tasksHub.followUpsDescription': "이 인스턴스의 대화별 대기 작업입니다. 지정한 시간이나 조건이 충족되면 원래 대화를 이어갑니다.",
  'tasksHub.active': "대기 중",
  'tasksHub.history': "기록",
  'tasksHub.search': "조건, 지시 또는 대화 검색",
  'tasksHub.refresh': "새로 고침",
  'tasksHub.empty': "대기 중인 작업이 없습니다. 대화에서 에이전트에게 특정 시간이나 조건에 따라 작업을 이어가도록 요청하세요.",
  'tasksHub.emptyHistory': "이어가기 기록이 없습니다.",
  ...
  'research-workbench.branchesAndMaterials': "연구 분기 및 자료",
  'research-workbench.retry': "다시 시도",
  'research-facts.summary': "실험 시도 {attempts}개 · 머신 {machines}개 · 소스 {sources}개",
  'research-facts.attempts': "실험",
  'research-facts.machines': "머신",
  'research-facts.sources': "소스",
  'research-facts.emptyAttempts': "기록된 실험 시도가 없습니다.",
  'research-facts.emptyMachines': "등록된 실행 대상이 없습니다.",
  'research-facts.cancel': "취소",
  'research-facts.collect': "수집",
  'research-facts.capacity': "용량",
  'research-facts.capacityUnknown': "용량 알 수 없음",
  'research-facts.usage': "사용량",
  'research-facts.usageUnread': "사용량을 읽지 못함",
  'research-facts.stale': "오래됨",
  'research-facts.commitments': "커밋먼트 {count}개",
  'research-facts.queued': "대기 중",
  'research-facts.sourceRetired': "폐기됨",
  'research-facts.attempt.submitted': "제출됨",
  'research-facts.attempt.queued': "대기 중",
  'research-facts.attempt.running': "실행 중",
  'research-facts.attempt.stopping': "중지 중",
  'research-facts.attempt.completed': "완료됨",
  'research-facts.attempt.failed': "실패",
  'research-facts.attempt.cancelled': "취소됨",
  'research-facts.attempt.lost': "유실됨",
  'research-facts.attempt.unknown': "알 수 없는 상태",
  'research-facts.machine.available': "사용 가능",
  'research-facts.machine.degraded': "성능 저하",
  'research-facts.machine.offline': "오프라인",
  'research-facts.machine.retired': "폐기됨",
  'research-facts.connection.connected': "연결됨",
  'research-facts.connection.degraded': "연결 성능 저하",
  'research-facts.connection.offline': "연결 끊김",
  'research-facts.connection.unknown': "연결 알 수 없음",
  'research-facts.collection.pending': "수집 중",
  'research-facts.collection.done': "수집됨",
  'research-facts.collection.failed': "수집 실패",
  'research-facts.source': "소스",
  'research-facts.observedAt': "관측 {time}",
  'research-facts.checkedAt': "확인 {time}",
  'research-facts.viewDetails': "세부 정보 보기",
  'research-facts.hideDetails': "세부 정보 숨기기",
  'research-facts.loadingDetails': "시도 세부 정보 로드 중…",
  'research-facts.detailsUnavailable': "시도 세부 정보를 사용할 수 없습니다.",
  'research-facts.logs': "로그",
  'research-facts.log.stdout': "표준 출력",
  'research-facts.log.stderr': "표준 오류",
  'research-facts.loadLog': "로드",
  'research-facts.loadMore': "더 로드",
  'research-facts.noLog': "로그 출력이 없습니다.",
  'research-facts.artifacts': "아티팩트",
  'research-facts.noArtifacts': "수집된 아티팩트가 없습니다.",
  'research-facts.download': "다운로드",
  'research-facts.artifactUnavailable': "사용할 수 없음",
  'research-facts.refreshFailed': "새로 고침에 실패하여 이전 사실을 표시합니다.",
  'research-facts.target': "대상",
  'research-facts.targetSource.desktop-host': "데스크톱 Host",
  'research-facts.targetSource.ssh-instance': "SSH 인스턴스",
  'research-facts.targetSource.configured-host': "구성된 Host",
  'research-facts.capabilities': "기능",
  'research-facts.coordinator': "코디네이터 Host",
  'research-facts.coordinatorUnavailable': "코디네이터 Host를 사용할 수 없습니다. 대기 중인 작업에는 온라인 상태가 필요합니다.",
  'research-facts.backend': "백엔드",
  'research-facts.sourceThread': "소스 Thread",
  'research-facts.sourceRun': "소스 Run",
  'research-facts.awaitingCoordinator': "코디네이터 대기 중",
  'research-facts.remoteAccepted': "원격 대상이 수락했습니다. 이 데스크톱을 닫아도 계속 실행될 수 있습니다.",
  'research-facts.remoteArtifact': "원격",
  'research-facts.remoteUnreachable': "원격 아티팩트를 사용할 수 없음",
  'research-facts.remoteExpired': "원격 아티팩트 만료",
  'research-facts.targetDetails': "대상 세부 정보",
  'research-facts.resourceDetails': "리소스 세부 정보",
  'research-facts.remoteJobsSurviveDisconnect': "수락된 작업은 클라이언트 연결이 끊겨도 계속됩니다",
  'research-facts.remoteJobsMayStopWithClient': "수락된 작업은 클라이언트와 함께 중지될 수 있습니다",
  'research-facts.unassignedNeedsCoordinator': "할당되지 않은 작업에는 코디네이터가 온라인이어야 합니다",
  'research-facts.unassignedCoordinatorOptional': "할당되지 않은 작업에는 이 코디네이터가 필요하지 않습니다",
  'research-facts.gpuProbe': "GPU 검사",
  'research-facts.selectAttempt': "시도 {attempt} 선택",
  'research-facts.executionCwd': "작업 디렉터리",
  'research-facts.executionRoot': "실행 루트",
  'research-facts.technicalDetails': "기술 세부 정보",
  'research-facts.jobState': "작업 상태",
  'research-facts.retryOf': "재시도 원본",
  'research-facts.rerun': "다시 실행",
  'research-facts.selectedCount': "{count}개 선택됨",
  'research-facts.cancelSelected': "선택 항목 취소",
  'research-facts.rerunSelected': "선택 항목 다시 실행",
  'research-facts.actionFailed': "작업 실패",
  'research-facts.unknownTarget': "알 수 없는 대상",
  'workFocus.label': "작업 중점",
  'workFocus.code': "일반",
  'workFocus.research': "연구",
  'workFocus.codeDescription': "코딩과 일상 작업에 필요한 도구를 사용합니다.",
  'workFocus.researchDescription': "문제를 조사하고 설명을 비교하며 실험을 설계하고 진행합니다.",
  'workFocus.pending': "다음 실행부터 적용",
  'workFocus.nextTurn': "다음 실행 시작 시 적용됩니다. 현재 실행과 대기 중인 후속 질문은 기존 작업 방향을 유지합니다.",
  'workFocus.fromProject': "대화 생성 시 프로젝트 기본값을 사용했습니다.",
  'workFocus.failed': "적용하지 못했습니다. 현재 {focus}을(를) 사용 중입니다. 다시 보내 재시도하세요.",
  'workFocus.useProjectDefault': "프로젝트 기본값 사용: {focus}",
  'workFocus.projectDefault': "기본 작업 중점",
  'workFocus.projectDefaultDescription': "새 대화에 사용합니다. 기존 대화는 각자의 중점을 유지합니다.",
  ...
  'harness.overview.description': '계획, 변경 사항, 하위 작업, 출처 및 지속되는 세션 컨텍스트를 한곳에서 봅니다.',
  'harness.overview.review': '확인 필요',
  'harness.overview.reviewCount': '{count}개 대기 중',
  'harness.overview.plan': '계획',
  'harness.overview.planProgress': '{done}/{total}',
  'harness.overview.outputs': '결과 및 변경 사항',
  'harness.overview.workspaceChanges': '현재 작업 공간',
  'harness.overview.outputFiles': '{count}개 파일',
  'harness.overview.outputDiff': '{files}개 파일 · +{insertions} −{deletions}',
  'harness.overview.moreItems': '{count}개 더 있음',
  'harness.overview.viewChanges': '변경 사항 보기',
  'harness.overview.pendingThreadChanges': '하위 작업 변경 사항',
  'harness.overview.pendingThreadChangesDescription': '격리된 하위 작업에서 생성되었으며 아직 상위 작업 공간에 통합되지 않은 변경 사항입니다.',
  'harness.overview.threads': '하위 작업',
  'harness.overview.threadsSummary': '{active}개 진행 중 · {completed}개 완료',
  'harness.overview.sources': '출처',
  'harness.overview.memory': '기억 및 결정',
  'harness.overview.memoryProgress': '현재 진행 상황',
  'harness.overview.memoryDecisions': '주요 결정',
  'harness.overview.runDetails': '실행 세부 정보',
  'harness.overview.summary.attention': '{count}개 하위 작업에 주의가 필요함',
  'harness.overview.summary.blocked': '계획 항목 {count}개가 차단됨',
  'harness.overview.summary.running': '{count}개 하위 작업 실행 중',
  'harness.overview.summary.plan': '진행 중 · {done}/{total}개 작업',
  'harness.overview.summary.review': '{count}개 항목 확인 대기 중',
  'harness.overview.summary.done': '계획 완료 · {done}/{total}',
  'harness.overview.summary.changed': '{count}개 파일 변경됨',
  'harness.overview.summary.context': '현재 작업 컨텍스트',
  'harness.blocks.title': '메모리 및 계획',
  'harness.blocks.edit': '블록 편집',
  'harness.blocks.cancel': '취소',
  'harness.blocks.save': '저장',
  'harness.blocks.conflict': '이 블록이 백그라운드에서 변경되었습니다. 최신 버전을 다시 불러왔으니 확인 후 저장하세요.',
  'harness.knowledge.title': '지식 검토',
  'harness.knowledge.scope.workspace': '워크스페이스',
  'harness.knowledge.scope.user': '사용자',
  'harness.knowledge.content': '지식 내용',
  'harness.knowledge.trigger': '호출 조건',
  'harness.knowledge.triggerPlaceholder': '언제 이 내용을 떠올려야 하나요?',
  'harness.knowledge.supersedes': '승인된 지식 대체',
  'harness.knowledge.dismiss': '거부',
  'harness.knowledge.save': '저장',
  'harness.knowledge.accept': '승인',
  'harness.knowledge.rememberWorkspace': '프로젝트',
  'harness.knowledge.rememberUser': '사용자',
  'harness.knowledge.created': '지식 검토에 추가됨',
  ...
  'harness.threads.discussion': '토론 스레드',
  'harness.threads.userThread': '사용자 스레드',
  'harness.threads.kind.discussion': '토론',
  'harness.threads.kind.implementation': '구현',
  'harness.threads.convert': '구현 스레드로 전환',
  'harness.threads.converting': '전환 중…',
  'harness.threads.convertFailed': '토론 스레드를 전환하지 못했습니다',
  'harness.threads.ask': '질문',
  'harness.threads.askPlaceholder': '이 스레드에 질문하거나 지시…',
  'harness.threads.fresh': '새로',
  'harness.threads.note': '메모',
  'harness.threads.sendFailed': '메시지를 전달할 수 없습니다',
  'harness.threads.peer.user': '사용자',
  'harness.threads.peer.session': '상위 세션',
  'harness.threads.msg.inform': '메모',
  'harness.threads.msg.request': '요청',
  'harness.threads.msg.held': '다음 실행까지 보류',
  'harness.threads.merge': '결과 병합',
  'harness.threads.merging': '병합 중…',
  'harness.threads.mergeFailed': '스레드 결과를 병합하지 못했습니다',
  'harness.threads.undoMerge': '편집기 병합 실행 취소',
  'harness.threads.undoUnavailable': '편집기 병합을 더 이상 실행 취소할 수 없습니다',
  'harness.threads.chooseParent': '부모 유지',
  'harness.threads.chooseChild': '자식 사용',
  'harness.threads.chooseBase': '기준선 사용',
  'harness.threads.unavailable': '사용할 수 없는 대상',
  'harness.threads.surfacePending': '편집기 초안',
  'harness.threads.previewStale': '이 미리보기는 더 이상 최신이 아닙니다',
  'harness.threads.previewApplicability': '병합 미리보기는 적용 가능 여부만 설명하며 테스트 통과를 의미하지 않습니다.',
  'harness.threads.verification.child': '결과 검사 (r{revision})',
  'harness.threads.verification.childEmpty': '이 결과에 기록된 명령이 없습니다',
  'harness.threads.verification.childUncertain': '바인딩이 불확실함: {reason}',
  'harness.threads.verification.command': '종료 {code} · {command}',
  'harness.threads.verification.merge': '병합 적용 가능 여부',
  'harness.threads.verification.parent': '병합 후 부모 상태 검사',
  'harness.threads.verification.parentUnsaved': '초안 병합은 저장되지 않았습니다. 디스크 명령은 저장되지 않은 버퍼를 검증할 수 없습니다',
  'harness.threads.verification.parentNone': '이 병합에 대한 부모 세션 검사가 없습니다',
  'harness.threads.verification.review': '검토 (r{revision})',
  'harness.threads.verification.reviewRunning': '검토 진행 중',
  'harness.threads.verification.reviewNone': '검토되지 않음',
  'harness.threads.state.dirty': '미게시 결과 있음',
  'chat.messageBody.actions.openThreadAria': '이 메시지에서 토론 스레드 열기',
  'chat.messageBody.actions.openThread': '여기서 스레드 열기',
  'chat.messageBody.actions.openThreadWithoutBlocks': '메모리 블록 없이 열기',
  'chat.messageBody.actions.openThreadFailed': '이 메시지에서 토론 스레드를 열지 못했습니다',
  ...
  'harness.threads.state.completed': '완료',
  'harness.threads.state.failed': '실패',
  'harness.threads.state.cancelled': '취소됨',
  'harness.threads.state.interrupted': '중단됨',
  'harness.threads.state.merge-ready': '병합 준비',
  'harness.threads.state.conflict': '충돌',
  'harness.threads.state.merged': '병합됨',
  'harness.threads.state.archived': '보관됨',
  'harness.threads.archive': '보관',
  'harness.threads.archiving': '보관 중…',
  'harness.threads.archiveFailed': '스레드를 보관하지 못했습니다',
  'harness.threads.restore': '복원',
  'harness.threads.restoring': '복원 중…',
  'harness.threads.restoreFailed': '스레드를 복원하지 못했습니다',
  'harness.threads.reclaim': '디렉터리 회수',
  'harness.threads.reclaiming': '회수 중…',
  'harness.threads.reclaimFailed': '스레드 디렉터리를 회수하지 못했습니다',
  'harness.threads.keepWorktree': '디렉터리 유지',
  'harness.threads.keepWorktreeOn': '디렉터리 유지 중',
  'harness.threads.keepFailed': '디렉터리 유지를 업데이트하지 못했습니다',
  'harness.threads.delete': '삭제',
  'harness.threads.deleteConfirm': '스레드를 삭제할까요? 모든 하위 스레드, Pi 대화, 결과 기록, 관리 디렉터리가 제거됩니다.',
  'harness.threads.deleting': '삭제 중…',
  'harness.threads.deleteFailed': '스레드를 삭제하지 못했습니다',
  'harness.threads.showArchived': '보관 항목 표시',
  'harness.threads.hideArchived': '보관 항목 숨기기',
  'harness.threads.space.title': '사용량',
  'harness.threads.space.bytes': '{bytes} B',
  'harness.threads.space.unknownSize': '알 수 없음',
  'harness.threads.space.logical': '디렉터리 {bytes}',
  'harness.threads.space.overBudget': '구성된 워크트리 예산을 초과했습니다',
  'harness.threads.space.lowFree': '남은 공간이 구성된 최소 비율보다 낮습니다',
  'harness.threads.space.enospc': '볼륨에 공간이 없습니다',
  'harness.threads.space.kept': '유지 이유: {reason}',
  'harness.threads.empty': '이 보기에 스레드가 없습니다',
  'harness.threads.history.open': '히스토리 결과',
  'harness.threads.history.title': '스레드 결과 히스토리',
  'harness.threads.history.loading': '히스토리 결과 로드 중…',
  'harness.threads.history.loadFailed': '스레드 결과 히스토리를 로드하지 못했습니다',
  'harness.threads.history.retry': '다시 시도',
  'harness.threads.history.empty': '이 스레드에는 네이티브 결과가 없습니다.',
  'harness.threads.history.revision': '결과 r{revision}',
  'harness.threads.history.select': '해제할 결과 r{revision} 선택',
  'harness.threads.history.bytes': '{bytes} B',
  'harness.threads.history.retainedBytesNote': '이 버전이 참조하는 콘텐츠 크기이며, 전체가 회수된다고 보장할 수 없습니다.',
  'harness.threads.history.protected': '보호됨: {reasons}',
  'harness.threads.history.protected.branchHead': '브랜치 헤드',
  'harness.threads.history.protected.currentResult': '현재 결과',
  'harness.threads.history.protected.runInput': '활성 Run 입력',
  'harness.threads.history.protected.review': '검토 진행 중',
  'harness.threads.history.protected.integration': '통합 대기 중',
  'harness.threads.history.release': '선택한 {count}개 해제',
  'harness.threads.history.releasing': '해제 중…',
  'harness.threads.history.releaseFailed': '선택한 결과를 해제하지 못했습니다',
  'harness.threads.history.confirmTitle': '선택한 결과를 해제할까요?',
  'harness.threads.history.confirmDescription': '이 스레드에서 선택한 결과 {count}개를 해제할까요?',
  'harness.threads.history.confirmWarning': '해제된 버전은 더 이상 읽거나 병합할 수 없습니다. 보고서, 세션 기록, 다른 소유자가 참조하는 콘텐츠는 유지됩니다.',
  'harness.threads.history.cancel': '취소',
  'harness.threads.history.confirm': '결과 해제',
  'harness.threads.history.released': '결과 {count}개를 해제했습니다.',
  'harness.threads.history.missing': '선택한 결과 중 {count}개는 이미 없습니다.',
  'harness.threads.history.cleanupComplete': '정리에서 객체 {objects}개를 삭제하고 {bytes} B를 회수했습니다.',
  'harness.threads.history.cleanupFailed': '기록 버전은 제거되었지만 정리는 아직 완료되지 않았습니다: {message}',
  'harness.threads.history.retryCleanup': '정리 다시 시도',
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Varin를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Varin가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'Varin에 연결',
  ...
  'mobile.connect.password.placeholder': 'Varin 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Varin 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'Varin Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 Varin 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.grouping.generalChat': '일반 채팅',
  'sessions.sidebar.grouping.recent': '최근',
  ...
  'sessions.scheduledTasks.dialog.confirm.deleteLoopFile': '"{taskName}"의 루프 파일을 삭제할까요?',
  'sessions.scheduledTasks.dialog.loopFile.project': '프로젝트 루프',
  'sessions.scheduledTasks.dialog.loopFile.user': '사용자 루프',
  'sessions.scheduledTasks.loopEditor.title': '루프 편집',
  'sessions.scheduledTasks.loopEditor.description': '기준이 되는 Markdown 루프 파일을 편집합니다.',
  'sessions.scheduledTasks.loopEditor.confirmDiscard': '저장하지 않은 루프 변경 사항을 버릴까요?',
  ...
  'sessions.sidebar.footer.actions.aboutVarin': 'Varin 정보',
  ...
  'sessions.sidebar.project.actions.pin': '맨 위에 고정',
  'sessions.sidebar.project.actions.archiveChats': '채팅 보관',
  'sessions.sidebar.project.actions.remove': '프로젝트 제거',
  'sessions.sidebar.project.reveal.error': '프로젝트 폴더를 열지 못했습니다',
  'sessions.sidebar.dialogs.removeProject.title': '프로젝트를 제거할까요?',
  'sessions.sidebar.dialogs.removeProject.description': '“{projectTitle}”이(가) 사이드바에서 제거됩니다. 채팅과 파일은 유지됩니다.',
  'sessions.sidebar.project.actions.newDraftSession': '새 드래프트 세션',
  'sessions.sidebar.session.menu.rename': '이름 변경',
  'sessions.sidebar.session.menu.restore': '세션 복원',
  ...
  'sessions.sidebar.session.unarchive.success': '세션을 복원했습니다',
  'sessions.sidebar.session.unarchive.error': '세션을 복원하지 못했습니다',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Varin에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'Varin 종료',
  ...
  'filesView.editor.splitEditor': '편집기 분할',
  'filesView.editor.pinTab': '탭 고정',
  'filesView.editor.unpinTab': '탭 고정 해제',
  'filesView.editor.moveTab': '다른 그룹으로 이동',
  ...
  'filesView.editor.languageStarting': '언어 기능을 시작하는 중…',
  'filesView.editor.languageDegraded': '일부 언어 기능을 사용할 수 없습니다: {message}',
  'filesView.editor.languageFailed': '언어 기능을 시작하지 못했습니다: {message}',
  'filesView.workspaceEdit.renameTitle': '이름 바꾸기 미리 보기',
  'filesView.workspaceEdit.actionTitle': '변경 사항 미리 보기',
  'filesView.workspaceEdit.descriptionSingle': '{count}개 파일이 변경됩니다. 적용하기 전에 검토하세요.',
  'filesView.workspaceEdit.descriptionMany': '{count}개 파일이 변경됩니다. 적용하기 전에 모두 검토하세요.',
  'filesView.workspaceEdit.files': '변경할 파일',
  'filesView.workspaceEdit.editCountSingle': '{count}개 편집',
  'filesView.workspaceEdit.editCountMany': '{count}개 편집',
  'filesView.workspaceEdit.showFocused': '변경 영역 보기',
  'filesView.workspaceEdit.showFull': '전체 파일 보기',
  'filesView.workspaceEdit.before': '변경 전',
  'filesView.workspaceEdit.after': '변경 후',
  'filesView.workspaceEdit.noChanges': '텍스트 변경 없음',
  'filesView.workspaceEdit.apply': '변경 적용',
  'filesView.workspaceEdit.renameDescription': '이름을 {name}(으)로 바꿉니다. 적용하기 전에 영향을 받는 모든 파일을 검토하세요.',
  'filesView.workspaceEdit.unavailable': '이 위치에서 사용할 수 있는 이름 바꾸기 또는 코드 작업이 없습니다.',
  'filesView.workspaceEdit.stale': '문서 또는 언어 서비스가 변경되었습니다. 다시 시도하세요.',
  'filesView.workspaceEdit.cancelled': '변경 사항을 적용하지 않았습니다.',
  'filesView.workspaceEdit.failed': '언어 서비스 변경 사항을 적용할 수 없습니다',
  'filesView.workspaceEdit.appliedSingle': '파일 {count}개를 변경했습니다',
  'filesView.workspaceEdit.appliedMany': '파일 {count}개를 변경했습니다',
  'filesView.workspaceEdit.undo': '실행 취소',
  'filesView.workspaceEdit.undone': '변경 사항을 되돌렸습니다',
  'filesView.workspaceEdit.undoUnavailable': '이 변경 사항은 더 이상 하나의 작업으로 되돌릴 수 없습니다.',
  ...
  'workbench.panel.problems': '문제',
  'workbench.panel.output': '출력',
  'workbench.panel.problemsEmpty': '이 작업 영역에 문제가 없습니다.',
  'workbench.panel.outputEmpty': '출력 채널이 없습니다.',
  'workbench.panel.problemsFailed': '문제를 불러올 수 없습니다: {message}',
  'workbench.panel.problemsItem': '{resourceId}: {message}',
  'workbench.panel.problemsItemAtLine': '{resourceId}:{line}: {message}',
  'workbench.panel.problemsOpenAria': '{resourceId} 열기',
  'workbench.panel.outputFailed': '출력을 불러올 수 없습니다: {message}',
  'workbench.panel.changes': '변경 사항',
  'workbench.panel.changesEmpty': '이 작업 공간에는 Agent 변경이나 저장되지 않은 파일이 없습니다.',
  'workbench.panel.changesOpenAria': '{resourceId} 열기',
  'workbench.panel.changesConflict': '충돌',
  'workbench.panel.changesDirty': '저장되지 않음',
  'workbench.panel.changesAgent': 'Agent',
  'workbench.panel.changesOpen': '열림',
  'workbench.panel.changesItem': '{resourceId} · {state} · {revision}',
  'workbench.attachment.chipUnsaved': '저장되지 않은 스냅샷: {name}',
  'workbench.attachment.chipSaved': '저장된 파일: {name}',
  'workbench.attachment.chipSelection': '선택 영역: {name}',
  'workbench.attachment.chipDiagnostic': '문제: {name}',
  'workbench.attachment.chipDiff': '차이: {name}',
  'workbench.attachment.attachDiff': 'diff를 에이전트에 첨부',
  'workbench.attachment.removeAria': 'Agent 컨텍스트에서 {name} 제거',
  'workbench.attachment.unsavedBadge': '저장되지 않은 스냅샷',
  'workbench.attachment.missing-editor': '첨부할 활성 편집기가 없습니다.',
  'workbench.attachment.missing-selection': '먼저 편집기에서 텍스트를 선택하세요.',
  'workbench.attachment.missing-document': '해당 문서가 워크벤치에서 열려 있지 않습니다.',
  'workbench.attachment.wrong-runtime': '이 첨부는 다른 Agent 런타임에 속합니다.',
  'workbench.attachment.no-session': '편집기 컨텍스트를 첨부하기 전에 Agent 세션을 여세요.',
  'workbench.patch.acceptHunk': '이 hunk 유지',
  'workbench.patch.rejectHunk': '이 hunk 되돌리기',
  'workbench.patch.applyAccepted': '유지한 hunk 적용',
  'workbench.patch.revertRejected': '거부한 hunk 되돌리기',
  'workbench.patch.written': '패치를 편집기 버퍼에 적용했습니다. 확인한 뒤 저장하세요.',
  'workbench.patch.conflict': '파일에 저장되지 않은 편집이나 더 새로운 리비전이 있습니다. 먼저 편집기 충돌을 해결하세요.',
  'workbench.patch.failed': '패치를 적용할 수 없습니다: {message}',
  'workbench.ide.title': 'IDE 워크벤치',
  'workbench.ide.activity.explorer': '탐색기',
  'workbench.ide.activity.search': '검색',
  'workbench.ide.activity.git': 'Git',
  'workbench.ide.activity.run': '실행 및 테스트',
  'workbench.ide.activity.extensions': '확장',
  'workbench.ide.activity.explorerAria': '탐색기 표시',
  'workbench.ide.activity.searchAria': '검색 표시',
  'workbench.ide.activity.gitAria': 'Git 표시',
  'workbench.ide.activity.runAria': '실행 및 테스트 표시',
  'workbench.ide.activity.extensionsAria': '확장 표시',
  'workbench.ide.sidebar.hideSecondary': '에이전트 사이드바 숨기기',
  'workbench.ide.sidebar.showSecondary': '에이전트 사이드바 표시',
  'workbench.ide.sessions': '세션',
  'workbench.ide.sessionsAria': '세션 목록 열기',
  'workbench.ide.search.placeholder': '파일 이름으로 검색',
  'workbench.ide.search.empty': '일치하는 파일이 없습니다.',
  'workbench.ide.search.failed': '검색에 실패했습니다: {message}',
  'workbench.ide.search.noWorkspace': '파일을 검색하려면 워크스페이스를 여세요.',
  'workbench.ide.search.searching': '검색 중...',
  'workbench.ide.search.filesTab': '파일',
  'workbench.ide.search.contentTab': '텍스트',
  'workbench.ide.search.contentPlaceholder': '작업 영역에서 텍스트 검색',
  'workbench.ide.search.contentEmpty': '일치하는 텍스트가 없습니다.',
  'workbench.ide.search.contentFailed': '텍스트 검색에 실패했습니다: {message}',
  'workbench.ide.search.contentNoWorkspace': '텍스트를 검색하려면 워크스페이스를 여세요.',
  'workbench.ide.search.filesAria': '파일 이름으로 검색',
  'workbench.ide.search.contentAria': '파일에서 텍스트 검색',
  'workbench.ide.run.unavailableTitle': '실행 및 테스트는 아직 사용할 수 없습니다',
  'workbench.ide.run.unavailableDescription': '디버그 어댑터와 테스트 제공자는 이후 워크벤치 업데이트에서 제공됩니다. 편집, 검색, Git, 터미널, 에이전트는 그대로 사용할 수 있습니다.',
  'workbench.ide.run.noWorkspace': '작업 공간을 열어 실행, 디버그, 테스트를 하세요.',
  'workbench.ide.run.tasks': '작업',
  'workbench.ide.run.runTask': '{label} 실행',
  'workbench.ide.run.emptyTasks': '정의된 작업이 없습니다. node 스크립트가 있는 varin.tasks.json 파일을 추가하세요.',
  'workbench.ide.run.tasksFailed': '작업을 불러올 수 없습니다: {message}',
  'workbench.ide.run.unsupported': '이 런타임에서는 실행, 디버그, 테스트를 사용할 수 없습니다.',
  'workbench.ide.debug.title': '디버그',
  'workbench.ide.debug.start': '시작',
  'workbench.ide.debug.stop': '중지',
  'workbench.ide.debug.continue': '계속',
  'workbench.ide.debug.stepOver': '프로시저 단위 실행',
  'workbench.ide.debug.stepInto': '한 단계씩 실행',
  'workbench.ide.debug.stepOut': '프로시저 나가기',
  'workbench.ide.debug.programAria': '디버그할 프로그램',
  'workbench.ide.debug.paused': '일시 중지됨',
  'workbench.ide.debug.running': '실행 중',
  'workbench.ide.debug.failed': '디버그에 실패했습니다: {message}',
  'workbench.ide.debug.absent': '디버그 세션이 없습니다',
  'workbench.ide.debug.breakpoints': '중단점',
  'workbench.ide.debug.breakpointsEmpty': '중단점이 없습니다. 편집기에서 전환하세요.',
  'workbench.ide.debug.callStack': '호출 스택',
  'workbench.ide.debug.variables': '변수',
  'workbench.ide.debug.watch': '조사식',
  'workbench.ide.debug.watchAdd': '추가',
  'workbench.ide.debug.watchRemove': '제거',
  'workbench.ide.debug.console': '디버그 콘솔',
  'workbench.ide.debug.consolePlaceholder': '식 평가',
  'workbench.ide.debug.evaluate': '평가',
  'workbench.ide.tests.title': '테스트',
  'workbench.ide.tests.run': '테스트 실행',
  'workbench.ide.tests.discover': '검색',
  'workbench.ide.tests.empty': '테스트를 찾지 못했습니다.',
  'workbench.ide.tests.failedLoad': '테스트를 불러올 수 없습니다: {message}',
  'workbench.ide.tests.failedItem': '{label} 실패',
  'workbench.ide.tests.passedItem': '{label} 통과',
  'workbench.ide.tests.runningItem': '{label} 실행 중',
  'workbench.attachment.chipTestFailure': '테스트 실패: {name}',
  'workbench.attachment.chipStack': '스택: {name}',
  'workbench.attachment.missing-test': '첨부할 테스트 실패가 없습니다.',
  'workbench.attachment.missing-stack': '첨부할 스택 프레임이 없습니다.',
  'workbench.ide.extensions.openSettings': '확장 설정 열기',
  'workbench.ide.extensions.empty': '로드된 확장이 없습니다.',
  'workbench.ide.status.noWorkspace': '워크스페이스 없음',
  'workbench.ide.status.noBranch': '브랜치 없음',
  'workbench.ide.commandPalette': '명령 팔레트',
  'workbench.ide.commandPaletteAria': '명령 팔레트 열기',
  'workbench.ide.settings': '설정',
  'workbench.ide.settingsAria': '설정 열기',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 Varin에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'filesView.document.conflict.title': '디스크의 파일이 변경되었습니다',
  'filesView.document.conflict.description': '저장하지 않은 편집 내용이 최신 파일 내용과 다릅니다.',
  'filesView.document.conflict.keepEdits': '내 편집 유지',
  'filesView.document.conflict.reloadDisk': '디스크에서 다시 불러오기',
  'filesView.document.conflict.agentDescription': '저장되지 않은 편집이 있는 동안 Agent 또는 다른 프로세스가 이 파일을 변경했습니다.',
  'filesView.document.conflict.ancestor': '원본',
  'filesView.document.conflict.yours': '내 편집',
  'filesView.document.conflict.disk': '디스크',
  'filesView.document.conflict.merge': '3방향 병합 검토',
  'filesView.document.conflict.acceptOurs': '내 내용 유지',
  'filesView.document.conflict.acceptTheirs': '디스크 사용',
  'filesView.document.conflict.editHunk': '병합된 텍스트 편집',
  'filesView.document.conflict.applyEdited': '편집한 병합 저장',
  'filesView.document.deleted.title': '이 파일이 삭제되었습니다',
  'filesView.document.deleted.description': '저장하지 않은 편집 내용은 그대로 있습니다. 저장하면 파일이 다시 만들어집니다.',
  'filesView.document.outsideWorkspace': '이 경로는 작업 영역 밖에 있어 여기에서 편집할 수 없습니다.',
  ...
  'contextSidebar.section.contextPreparation': '컨텍스트 준비',
  'contextSidebar.context.preparation.disabled': '백그라운드 준비 끔',
  'contextSidebar.context.candidate.none': '유휴',
  'contextSidebar.context.candidate.preparing': '요약 준비 중',
  'contextSidebar.context.candidate.ready': '요약 준비 완료',
  'contextSidebar.context.status.preparationFailed': '최근 백그라운드 준비에 실패했습니다.',
  'contextSidebar.context.status.compactionFailed': '최근 압축 제출에 실패했습니다.',
  ...
  'contextSidebar.tokens.cacheWrite1h': '1시간 캐시 쓰기',
  'contextSidebar.tokens.cacheHit': '캐시 적중',
  'contextSidebar.tokens.total': '합계',
  ...
  'chat.followup.status.waiting': '대기 중',
  'chat.followup.status.triggered': '트리거됨',
  'chat.followup.status.delivered': '전달됨',
  'chat.followup.status.cancelled': '취소됨',
  'chat.followup.status.superseded': '대체됨',
  'chat.followup.status.unavailable': '사용할 수 없음',
  'chat.followup.action.check': '확인',
  'chat.followup.action.checkHint': '에이전트를 호출하지 않고 지금 소스를 확인합니다',
  'chat.followup.action.fire': '지금 실행',
  'chat.followup.action.fireHint': '후속 작업을 실행하고 에이전트를 호출합니다',
  'chat.followup.action.cancel': '취소',
  'chat.followup.action.cancelHint': '대기만 중단합니다 — 감시 중인 작업은 계속 실행됩니다',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Varin에서 이 폴더에 접근해야 합니다.',
  ...
  'pi.interaction.extensionFallback': 'Pi 확장',
  'pi.interaction.trust.description': 'Pi가 이 작업 공간에서 프로젝트가 제공한 확장과 리소스를 찾았습니다. 신뢰하면 해당 코드를 실행할 수 있습니다.',
  'pi.interaction.trust.remember': '이 작업 공간에 대한 결정을 기억',
  'pi.interaction.trust.title': '프로젝트 확장을 신뢰하시겠습니까?',
  'pi.interaction.trust.workspace': '작업 공간',
  'aboutDialog.actions.openDiagnostics': '진단 열기',
  'aboutDialog.diagnosticsDescription': 'Pi 런타임, 패키지, 플러그인, 세션 및 프로젝트 컨텍스트를 확인합니다.',
  'aboutDialog.footerNote': '커뮤니티를 위해 정성껏 만들었습니다',
  'helpDialog.title': '키보드 단축키',
  'helpDialog.description': '이 단축키로 Varin를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Varin 메뉴',
  'header.actions.openAppMenuAria': 'Varin 메뉴 열기',
  ...
  'chat.piComposer.attachedContext': '첨부된 컨텍스트: {count}',
  'chat.piComposer.queueFollowUp': '후속 메시지를 대기열에 추가',
  'chat.piComposer.steerCurrentRun': '현재 실행에 지시',
  'chat.piComposer.sendResultUnknown': '전송 후 연결이 끊겼습니다. 결과를 알 수 없습니다. 다시 보내기 전에 세션을 확인하세요.',
  ...
  'commandPalette.item.splitEditor': '편집기 분할',
  'commandPalette.item.splitEditorOrthogonal': '편집기 직교 분할',
  'commandPalette.item.closeEditor': '편집기 닫기',
  'commandPalette.item.saveActiveFile': '파일 저장',
  'commandPalette.item.saveAllFiles': '모든 파일 저장',
  'commandPalette.item.findInFile': '파일에서 찾기',
  'commandPalette.item.replaceInFile': '파일에서 바꾸기',
  'commandPalette.item.goToLine': '줄로 이동',
  'commandPalette.item.goToSymbol': '기호로 이동',
  'commandPalette.item.formatDocument': '문서 서식 지정',
  'commandPalette.item.renameSymbol': '기호 이름 바꾸기',
  'commandPalette.item.quickFix': '빠른 수정',
  'commandPalette.item.goToDefinition': '정의로 이동',
  'commandPalette.item.findReferences': '참조 찾기',
  'commandPalette.item.foldRegion': '영역 접기',
  'commandPalette.item.unfoldRegion': '영역 펼치기',
  'commandPalette.item.toggleEditorWrap': '줄 바꿈 전환',
  'commandPalette.item.toggleEditorMinimap': '미니맵 전환',
  'commandPalette.item.addCursorAbove': '위에 커서 추가',
  'commandPalette.item.addCursorBelow': '아래에 커서 추가',
  'commandPalette.item.focusPreviousEditorGroup': '이전 편집기 그룹에 포커스',
  'commandPalette.item.focusNextEditorGroup': '다음 편집기 그룹에 포커스',
  'commandPalette.session.untitled': '제목 없는 세션',
  'varinDiagnosticsDialog.title': 'Varin 진단',
  'varinDiagnosticsDialog.description': '활성 Pi 런타임과 자격 증명이 제외된 패키지, 플러그인, 세션 및 프로젝트 요약을 확인합니다.',
  'varinDiagnosticsDialog.actions.copy': '복사',
  'varinDiagnosticsDialog.actions.refresh': '새로 고침',
  'varinDiagnosticsDialog.empty.noData': '진단 정보가 없습니다.',
  'varinDiagnosticsDialog.state.collecting': '진단 정보 수집 중...',
  'varinDiagnosticsDialog.state.failed': '진단 정보 수집 실패: {error}',
  'varinDiagnosticsDialog.toast.copiedTitle': '복사됨',
  'varinDiagnosticsDialog.toast.copiedDescription': '진단 정보를 클립보드에 복사했습니다',
  'varinDiagnosticsDialog.toast.copyFailed': '진단 정보 복사에 실패했습니다',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 Varin를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'Varin 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Varin 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Varin 멀티런 창.',
  ...
  'onboarding.chooser.description': 'Varin에 포함된 Pi를 사용하거나, 설정에서 다른 로컬 설치를 선택하거나, 원격 Varin 서버에 연결하세요.',
  'onboarding.chooser.tabs.localInstall': '로컬 워크스페이스',
  'onboarding.chooser.tabs.connectRemote': "Connect Remote",
  'onboarding.localSetup.title': '로컬 워크스페이스 런타임',
  'onboarding.localSetup.description': 'Varin에는 Pi가 포함되어 있으므로 별도 설치가 필요하지 않습니다. 기본 로컬 런타임은 바로 시작할 수 있으며, 설정에서 다른 로컬 설치를 선택할 수도 있습니다.',
  'onboarding.localSetup.status.ready': '로컬 워크스페이스 런타임이 준비되었습니다',
  'onboarding.localSetup.status.readyWithVersion': "Pi {version} 준비됨",
  'onboarding.localSetup.status.readyDetail': "{source} · {commandPath}",
  'onboarding.localSetup.status.missing': '로컬 워크스페이스 런타임을 사용할 수 없습니다',
  'onboarding.localSetup.status.missingDetail': '선택한 런타임을 사용할 수 없습니다. 다시 시도하거나 다른 설치를 선택하세요. 내장 런타임을 사용했다면 Varin을 다시 설치해 복구할 수 있습니다.',
  'onboarding.localSetup.status.upgradeRequired': "이 Pi는 너무 오래되었습니다",
  'onboarding.localSetup.status.upgradeRequiredDetail': "설치된 {currentVersion}이 최소 요구 버전 {targetVersion}보다 낮습니다. 이 설치를 업그레이드하세요. Varin은 더 새로운 Pi를 다운그레이드하지 않습니다.",
  'onboarding.localSetup.status.failed': '로컬 워크스페이스 런타임을 시작할 수 없습니다',
  'onboarding.localSetup.status.hostEntryUnavailable': "Varin 설치를 복구해야 합니다",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '워크스페이스 런타임을 시작하는 데 필요한 애플리케이션 Host 파일이 없거나 접근할 수 없습니다. Varin을 다시 다운로드해 설치하세요. Pi를 변경하거나 업그레이드해도 이 파일은 복구되지 않습니다.',
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "기술 세부 정보",
  'onboarding.localSetup.status.checking': '워크스페이스 런타임을 시작하는 중',
  'onboarding.localSetup.status.checkingDetail': 'Varin 워크스페이스 런타임을 시작하는 중…',
  'onboarding.localSetup.status.installing': "Pi 설치 중",
  'onboarding.localSetup.status.upgrading': "Pi 업그레이드 중",
  'onboarding.localSetup.status.discovering': '워크스페이스 런타임을 시작하는 중',
  'onboarding.localSetup.status.probing': '워크스페이스 런타임을 확인하는 중',
  'onboarding.localSetup.errors.timeout': '워크스페이스 런타임 핸드셰이크가 시간 초과되었습니다. 다시 시도하거나 원격 서버에 연결하세요.',
  'onboarding.localSetup.errors.managerUnavailable': '이 화면에서는 로컬 워크스페이스 런타임을 관리할 수 없습니다.',
  'onboarding.localSetup.runtime.piVersion': "Pi",
  'onboarding.localSetup.runtime.hostVersion': "Varin 호스트",
  'onboarding.localSetup.runtime.nodeVersion': "Node.js",
  'onboarding.localSetup.runtime.source': "소스",
  'onboarding.localSetup.runtime.source.system': "시스템",
  'onboarding.localSetup.runtime.source.standalone': "독립 설치",
  'onboarding.localSetup.runtime.source.custom': "사용자 지정",
  'onboarding.localSetup.runtime.source.development': "개발",
  'onboarding.localSetup.runtime.source.bundled': 'Varin 내장',
  'onboarding.localSetup.runtime.commandPath': "명령",
  'onboarding.localSetup.actions.continue': '로컬 워크스페이스 사용',
  'onboarding.localSetup.actions.useThisPi': "이 Pi 사용",
  'onboarding.localSetup.actions.installPi': "Pi 설치",
  'onboarding.localSetup.actions.upgradePi': "Pi 업그레이드",
  'onboarding.localSetup.actions.selectExisting': "기존 설치 선택",
  'onboarding.localSetup.actions.retryDetect': "다시 검색",
  'onboarding.localSetup.actions.downloadVarinAgain': "Varin 다시 다운로드",
  'onboarding.localSetup.customPath.placeholder': "Pi 패키지 루트 경로",
  'onboarding.localSetup.customPath.apply': "이 경로 사용",
  'onboarding.localSetup.installPlan.summary': "{manager}로 {version} 설치",
  'onboarding.localSetup.installPlan.location': "위치: {location}",
  ...
  'onboarding.remoteConnection.description': '연결할 Varin 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Varin 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Varin 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Varin가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Varin를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Varin가 실행 중이 아닙니다. 주소가 Varin 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 워크스페이스 런타임을 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': '로컬 워크스페이스 런타임을 시작할 수 없습니다. 런타임을 다시 시도하거나 원격 서버에 연결하세요.',
  'onboarding.desktopRecovery.localUnavailable.retry': '로컬 런타임 다시 시도',
  'onboarding.desktopRecovery.localUnavailable.useLocal': '로컬 런타임 사용',
  ...
  'startup.initRecovery.description': 'Varin 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  'startup.initRecovery.retry': '다시 시도',
  'startup.initRecovery.retrying': '다시 시도 중…',
  'workbench.recovery.title': '워크벤치를 사용할 수 없음',
  'workbench.recovery.description': '선택한 워크벤치 셸을 실행할 수 없습니다. 확장을 다시 사용하거나 다른 프로필을 선택하거나 확장 설정을 여세요.',
  'workbench.recovery.reenable': '셸 다시 사용',
  'workbench.recovery.chooseProfile': '다른 프로필 선택',
  'workbench.recovery.openExtensions': '확장 열기',
  ...
  'updateDialog.header.updating': 'Varin 업데이트 중…',
  'updateDialog.header.restarting': 'Varin 재시작 중…',
  ...
  'updateDialog.status.desktopRestarting': '업데이트 설치를 위해 재시작 중…',
  'updateDialog.status.desktopRestartingHint': 'Varin이 백그라운드 서비스를 종료하고 설치 프로그램으로 전환하고 있습니다. 잠시 기다려 주세요.',
  ...
  'updateDialog.actions.restarting': '재시작 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `varin update`를 실행하세요.',
  'mobileUpdate.toast.available.title': 'Varin 업데이트 사용 가능',
  ...
  'varinLogo.aria.logo': 'Varin 로고',
  'splash.aria.loading': 'Varin 로드 중',
  'splash.aria.switching': '워크벤치 프로필 전환 중',
  'splash.switching': '워크벤치 전환 중',
  'splash.switchingTo': '{profile}(으)로 전환 중',
  'splash.status.startingDesktop': '데스크톱 셸 시작 중',
  'splash.status.connectingRuntime': '워크스페이스를 시작하는 중',
  'splash.status.preparingWorkspace': '작업 공간 준비 중',
  'splash.status.desktopFailed': '데스크톱 시작에 실패했습니다. 앱을 다시 시작하세요.',
  'splash.status.desktopSlow': '시작이 예상보다 오래 걸립니다',
  ...
  'contextPanel.recovery.actions.redo': '다시 실행',
  'contextPanel.recovery.actions.checkpoint': '체크포인트 만들기',
  'contextPanel.recovery.checkpoint.placeholder': '체크포인트 이름',
  ...
  'contextPanel.recovery.actions.repair': '프롬프트 복구',
  'contextPanel.recovery.actions.repairTypo': '오타 복구',
  'contextPanel.recovery.actions.repairDestructive': '파괴적 복구',
  'contextPanel.recovery.toast.failed': '복구 실패: {message}',
  'contextPanel.recovery.toast.applied': '{provider}에서 복구를 적용했습니다',
  'contextPanel.recovery.toast.cancelled': '{provider}에서 복구를 취소했습니다',
  'contextPanel.recovery.toast.delegated': '복구를 {provider}에 위임했습니다. 최종 결과는 플러그인이 알립니다',
  'contextPanel.recovery.destructive.description': '파괴적 복구는 Pi 세션 기록을 다시 씁니다. 되돌릴 수 없으며 파일이나 외부 부작용도 되돌리지 않습니다.',
  ...
  'walkthrough.blocked.chooseModel': '다른 모델 선택',
  ...
  'walkthrough.blocked.serverUnsupported.description': '연결된 Varin 서버가 워크스루 API에 응답하지 않았습니다. Varin을 업데이트한 뒤 새로 고치세요.',
