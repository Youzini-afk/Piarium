...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.localSetup.description': "Piarium은 이 컴퓨터에 설치된 Pi 런타임을 사용합니다. 설치하거나 기존 설치를 선택한 뒤 계속하세요.",
  'onboarding.localSetup.status.ready': "Pi 런타임이 준비되었습니다",
  'onboarding.localSetup.status.readyWithVersion': "Pi {version} 준비됨",
  'onboarding.localSetup.status.readyDetail': "{source} · {commandPath}",
  'onboarding.localSetup.status.missing': "Pi 런타임을 찾을 수 없습니다",
  'onboarding.localSetup.status.missingDetail': "이 사용자용으로 Pi를 설치하거나 기존 설치를 선택하세요.",
  ...
  'onboarding.localSetup.status.failed': "Pi 런타임을 시작할 수 없습니다",
  'onboarding.localSetup.status.hostEntryUnavailable': "Piarium 설치를 복구해야 합니다",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "Pi를 시작하는 데 필요한 애플리케이션 Host 파일이 없거나 접근할 수 없습니다. Piarium을 다시 다운로드해 설치하세요. Pi를 변경하거나 업그레이드해도 이 파일은 복구되지 않습니다.",
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "기술 세부 정보",
  'onboarding.localSetup.status.checking': "Pi 런타임에 연결하는 중",
  'onboarding.localSetup.status.checkingDetail': "Piarium 런타임 프로토콜을 협상하는 중…",
  'onboarding.localSetup.status.installing': "Pi 설치 중",
  'onboarding.localSetup.status.upgrading': "Pi 업그레이드 중",
  'onboarding.localSetup.status.discovering': "Pi 런타임을 찾는 중",
  'onboarding.localSetup.status.probing': "Pi 런타임을 확인하는 중",
  'onboarding.localSetup.errors.timeout': 'Pi 런타임 핸드셰이크가 시간 초과되었습니다. 다시 시도하거나 원격 서버에 연결하세요.',
  'onboarding.localSetup.errors.managerUnavailable': "이 화면에서는 로컬 Pi 런타임을 관리할 수 없습니다.",
  ...
  'onboarding.localSetup.runtime.source.bundled': "번들",
  'onboarding.localSetup.runtime.commandPath': "명령",
  'onboarding.localSetup.actions.continue': "로컬 Pi 사용",
  ...
  'splash.status.connectingRuntime': 'Pi 런타임에 연결 중',
