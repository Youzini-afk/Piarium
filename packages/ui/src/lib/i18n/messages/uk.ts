...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть Piarium для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "Piarium встановлено",
  ...
  "mobile.connect.welcome.title": "Підключись до Piarium",
  ...
  "mobile.connect.password.placeholder": "Пароль Piarium",
  ...
  "mobile.connect.scan.invalid": "Це не QR-код підключення Piarium.",
  ...
  "mobile.connect.relay.badge": "через Piarium Relay",
  ...
  "mobile.connect.error.unreachable": "Не вдалося достукатись до цього Piarium сервера.",
  ...
  "sessions.sidebar.footer.actions.aboutPiarium": "Про Piarium",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до Piarium — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "workbench.ide.run.emptyTasks": "Завдання не визначено. Додайте файл piarium.tasks.json зі скриптом node.",
  ...
  "filesView.editor.binaryFileDescription": "Цей файл є бінарним і його не можна редагувати в Piarium. Завантажте його, щоб відкрити в іншій програмі.",
  ...
  "header.services.shutdownDev": "Зупинити Piarium",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Piarium потрібен доступ до цієї папки.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації Piarium",
  ...
  "header.actions.openAppMenu": "Меню Piarium",
  "header.actions.openAppMenuAria": "Відкрити меню Piarium",
  ...
  "piariumDiagnosticsDialog.title": "Діагностика Piarium",
  "piariumDiagnosticsDialog.description": "Перегляд активного середовища Pi та безпечного зведення пакетів, плагінів, сеансів і проєкту.",
  "piariumDiagnosticsDialog.actions.copy": "Копіювати",
  "piariumDiagnosticsDialog.actions.refresh": "Оновити",
  "piariumDiagnosticsDialog.empty.noData": "Діагностика недоступна.",
  "piariumDiagnosticsDialog.state.collecting": "Збір діагностики...",
  "piariumDiagnosticsDialog.state.failed": "Не вдалося зібрати діагностику: {error}",
  "piariumDiagnosticsDialog.toast.copiedTitle": "Скопійовано",
  "piariumDiagnosticsDialog.toast.copiedDescription": "Діагностику скопійовано в буфер обміну",
  "piariumDiagnosticsDialog.toast.copyFailed": "Не вдалося скопіювати діагностику",
  ...
  "sessionAuth.error.networkDescription": "Нам не вдалося перевірити сесію інтерфейсу. Якщо ви відкриваєте Piarium з іншого пристрою у локальній мережі, увімкніть Desktop Network Access у настільному застосунку та використайте LAN-адресу, показану в налаштуваннях.",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати Piarium",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими Piarium серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску Piarium.",
  ...
  'onboarding.chooser.description': 'Використовуйте Pi, вбудований у Piarium, виберіть інше локальне встановлення в налаштуваннях або підключіться до віддаленого сервера Piarium.',
  ...
  'onboarding.localSetup.description': 'Piarium містить Pi, тому окреме встановлення не потрібне. Середовище за замовчуванням можна запустити одразу; у налаштуваннях також можна вибрати інше локальне встановлення.',
  ...
  'onboarding.localSetup.status.missingDetail': 'Вибране середовище недоступне. Повторіть спробу або виберіть інше встановлення; якщо використовувалося вбудоване середовище, перевстановіть Piarium для відновлення.',
  'onboarding.localSetup.status.upgradeRequired': "Ця версія Pi застаріла",
  'onboarding.localSetup.status.upgradeRequiredDetail': "Встановлена версія {currentVersion} нижча за мінімальну {targetVersion}. Оновіть це встановлення; Piarium не понижуватиме новішу версію Pi.",
  'onboarding.localSetup.status.failed': 'Не вдалося запустити локальне середовище робочої області',
  'onboarding.localSetup.status.hostEntryUnavailable': "Інсталяцію Piarium потрібно відновити",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': 'Файли Host, потрібні для запуску середовища робочої області, відсутні або недоступні. Завантажте й перевстановіть Piarium; зміна чи оновлення Pi їх не відновить.',
  ...
  'onboarding.localSetup.status.checkingDetail': 'Запуск середовища робочої області Piarium…',
  ...
  'onboarding.localSetup.runtime.hostVersion': "Хост Piarium",
  ...
  'onboarding.localSetup.runtime.source.bundled': 'Вбудоване в Piarium',
  ...
  'onboarding.localSetup.actions.downloadPiariumAgain': "Завантажити Piarium знову",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера Piarium для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер Piarium або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Цей інстанс працює з іншою версією Piarium. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "Сервер працює з Piarium, але несумісний із цією версією застосунку. Оновіть Piarium на сервері та повторіть спробу.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює Piarium. Перевірте, чи адреса вказує на сервер Piarium.",
  ...
  "startup.initRecovery.description": "Piarium не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення Piarium...",
  "updateDialog.header.restarting": "Перезапуск Piarium…",
  ...
  "updateDialog.status.desktopRestartingHint": "Piarium завершує фонові служби та передає керування інсталятору. Це може тривати деякий час.",
  ...
  "piariumLogo.aria.logo": "Логотип Piarium",
  "splash.aria.loading": "Завантаження Piarium",
  ...
  "walkthrough.blocked.serverUnsupported.description": "Підключений сервер Piarium не відповів на API розбору. Оновіть Piarium і повторіть спробу.",
