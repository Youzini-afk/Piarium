...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.title': 'Стан роботи',
  'chat.workStatus.section.session': 'Сеанс',
  'chat.workStatus.section.activity': 'Активність',
  'chat.workStatus.section.pinned': 'Закріплений контекст',
  'chat.workStatus.toolCalls': 'Виклики інструментів',
  'chat.workStatus.tokens': 'Токени',
  'chat.workStatus.queue': 'Черга',
  'chat.workStatus.state.working': 'Виконується',
  'chat.workStatus.state.compacting': 'Стискання',
  'chat.workStatus.state.retrying': 'Повторна спроба',
  'chat.workStatus.state.idle': 'Очікування',
