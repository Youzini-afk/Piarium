...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.localSetup.description': "Piarium використовує середовище виконання Pi, встановлене на цьому комп’ютері. Встановіть його або виберіть наявне, щоб продовжити.",
  'onboarding.localSetup.status.ready': "Середовище виконання Pi готове",
  ...
  'onboarding.localSetup.status.missing': "Середовище виконання Pi не знайдено",
  'onboarding.localSetup.status.missingDetail': "Встановіть Pi для цього користувача або виберіть наявне встановлення.",
  ...
  'onboarding.localSetup.status.failed': "Не вдалося запустити середовище виконання Pi",
  'onboarding.localSetup.status.hostEntryUnavailable': "Інсталяцію Piarium потрібно відновити",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "Файли Host, потрібні для запуску Pi, відсутні або недоступні. Завантажте й перевстановіть Piarium; зміна чи оновлення Pi їх не відновить.",
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "Технічні подробиці",
  'onboarding.localSetup.status.checking': "Підключення до середовища виконання Pi",
  'onboarding.localSetup.status.checkingDetail': "Узгодження протоколу середовища виконання Piarium…",
  'onboarding.localSetup.status.installing': "Встановлення Pi",
  'onboarding.localSetup.status.upgrading': "Оновлення Pi",
  'onboarding.localSetup.status.discovering': "Пошук середовища виконання Pi",
  'onboarding.localSetup.status.probing': "Перевірка середовища виконання Pi",
  'onboarding.localSetup.errors.timeout': 'Час очікування рукостискання середовища виконання Pi минув. Повторіть спробу або підключіться до віддаленого сервера.',
  'onboarding.localSetup.errors.managerUnavailable': "Ця поверхня не може керувати локальним середовищем виконання Pi.",
  ...
  'onboarding.localSetup.runtime.source.bundled': "Вбудоване",
  'onboarding.localSetup.runtime.commandPath': "Команда",
  'onboarding.localSetup.actions.continue': "Використати локальний Pi",
  ...
  "splash.status.connectingRuntime": "Підключення до середовища виконання Pi",
