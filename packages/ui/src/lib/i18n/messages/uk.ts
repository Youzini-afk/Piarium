...
export const dict: Record<I18nKey, string> = {
  ...
  "contextSidebar.section.memory": "Пам’ять",
  "contextSidebar.memory.effective": "Чинний режим: {mode}",
  "contextSidebar.memory.inherited": "Використовується глобальне налаштування",
  "contextSidebar.memory.override": "Перевизначення для сесії",
  "contextSidebar.memory.mode.inherit": "Успадкувати глобальне налаштування",
  "contextSidebar.memory.mode.off": "Вимкнено",
  "contextSidebar.memory.mode.assist": "Підтримувати й інжектувати (асистент)",
  "contextSidebar.memory.mode.takeover": "Підтримувати й перебирати стиснення, коли готово (перехоплення)",
  "contextSidebar.memory.status.updating": "Оновлення режиму пам’яті…",
  "contextSidebar.memory.status.updateFailed": "Не вдалося оновити режим пам’яті.",
  "contextSidebar.memory.status.keeperFailed": "Зберігач пам’яті нещодавно завершився з помилкою.",
  "contextSidebar.memory.status.compactionFailed": "Стиснення пам’яті нещодавно завершилося з помилкою.",
