export const settingsDict = {
 ...
 'settings.piarium.fleet.commandFailed': 'Fleet command failed',
  ...
  'settings.piarium.mcp.structured.advancedFields': 'Environment variables, headers, bearer tokens, OAuth details, lifecycle, direct tools, tool filters, debugging, tracing, and future server fields remain in Raw Advanced JSONC.',
