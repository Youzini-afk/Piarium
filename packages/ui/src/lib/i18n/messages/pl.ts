...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.recoveryDialog.noFileChanges': 'Ten punkt kontrolny nie zawiera zmian plików względem bieżącego obszaru roboczego.',
  'chat.recoveryDialog.confirmSelection': 'Kontynuuj wybrane odzyskiwanie',
  'chat.recoveryDialog.modeConflict': 'To odzyskiwanie zostało już rozpoczęte z inną opcją. Zamknij to okno i wybierz ponownie.',
