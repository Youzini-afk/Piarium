...
export const dict: Record<I18nKey, string> = {
  ...
  'contextSidebar.section.memory': 'Pamięć',
  'contextSidebar.memory.effective': 'Obowiązujący tryb: {mode}',
  'contextSidebar.memory.inherited': 'Używa ustawienia globalnego',
  'contextSidebar.memory.override': 'Zastąpienie dla sesji',
  'contextSidebar.memory.mode.inherit': 'Dziedzicz ustawienie globalne',
  'contextSidebar.memory.mode.off': 'Wyłączone',
  'contextSidebar.memory.mode.assist': 'Utrzymuj i wstrzykuj (asysta)',
  'contextSidebar.memory.mode.takeover': 'Utrzymuj i przejmuj kompaktowanie, gdy gotowe (przejęcie)',
  'contextSidebar.memory.status.updating': 'Aktualizowanie trybu pamięci…',
  'contextSidebar.memory.status.updateFailed': 'Nie udało się zaktualizować trybu pamięci.',
  'contextSidebar.memory.status.keeperFailed': 'Opiekun pamięci ostatnio zakończył się błędem.',
  'contextSidebar.memory.status.compactionFailed': 'Kompaktowanie pamięci ostatnio zakończyło się błędem.',
