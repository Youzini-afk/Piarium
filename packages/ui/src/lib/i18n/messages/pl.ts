...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.title': 'Stan pracy',
  'chat.workStatus.section.session': 'Sesja',
  'chat.workStatus.section.activity': 'Aktywność',
  'chat.workStatus.section.pinned': 'Przypięty kontekst',
  'chat.workStatus.toolCalls': 'Wywołania narzędzi',
  'chat.workStatus.tokens': 'Tokeny',
  'chat.workStatus.queue': 'Kolejka',
  'chat.workStatus.state.working': 'Praca',
  'chat.workStatus.state.compacting': 'Kompaktowanie',
  'chat.workStatus.state.retrying': 'Ponawianie',
  'chat.workStatus.state.idle': 'Bezczynny',
