...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.localSetup.description': "Piarium korzysta z runtime’u Pi zainstalowanego na tym komputerze. Zainstaluj go lub wybierz istniejący, aby kontynuować.",
  'onboarding.localSetup.status.ready': "Runtime Pi jest gotowy",
  ...
  'onboarding.localSetup.status.missing': "Nie znaleziono runtime’u Pi",
  'onboarding.localSetup.status.missingDetail': "Zainstaluj Pi dla tego użytkownika albo wybierz istniejącą instalację.",
  ...
  'onboarding.localSetup.status.failed': "Nie udało się uruchomić runtime’u Pi",
  'onboarding.localSetup.status.hostEntryUnavailable': "Instalacja Piarium wymaga naprawy",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "Brakuje plików Host wymaganych do uruchomienia Pi lub są one niedostępne. Pobierz i zainstaluj Piarium ponownie; zmiana lub aktualizacja Pi ich nie naprawi.",
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "Szczegóły techniczne",
  'onboarding.localSetup.status.checking': "Łączenie z runtime’em Pi",
  'onboarding.localSetup.status.checkingDetail': "Negocjowanie protokołu runtime Piarium…",
  'onboarding.localSetup.status.installing': "Instalowanie Pi",
  'onboarding.localSetup.status.upgrading': "Aktualizowanie Pi",
  'onboarding.localSetup.status.discovering': "Wyszukiwanie runtime’u Pi",
  'onboarding.localSetup.status.probing': "Sprawdzanie runtime’u Pi",
  'onboarding.localSetup.errors.timeout': 'Handshake runtime’u Pi przekroczył limit czasu. Spróbuj ponownie lub połącz się z serwerem zdalnym.',
  'onboarding.localSetup.errors.managerUnavailable': "Ten interfejs nie może zarządzać lokalnym runtime’em Pi.",
  ...
  'onboarding.localSetup.runtime.source.bundled': "Dołączony",
  'onboarding.localSetup.runtime.commandPath': "Polecenie",
  'onboarding.localSetup.actions.continue': "Użyj lokalnego Pi",
  ...
  'splash.status.connectingRuntime': 'Łączenie ze środowiskiem uruchomieniowym Pi',
