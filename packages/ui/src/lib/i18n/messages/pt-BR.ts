...
export const dict: Record<I18nKey, string> = {
  ...
  "contextSidebar.section.memory": "Memória",
  "contextSidebar.memory.effective": "Modo efetivo: {mode}",
  "contextSidebar.memory.inherited": "Usando a configuração global",
  "contextSidebar.memory.override": "Substituição da sessão",
  "contextSidebar.memory.mode.inherit": "Herdar configuração global",
  "contextSidebar.memory.mode.off": "Desativado",
  "contextSidebar.memory.mode.assist": "Manter e injetar (assistência)",
  "contextSidebar.memory.mode.takeover": "Manter e assumir a compactação quando pronto (assumir controle)",
  "contextSidebar.memory.status.updating": "Atualizando o modo de memória…",
  "contextSidebar.memory.status.updateFailed": "Não foi possível atualizar o modo de memória.",
  "contextSidebar.memory.status.keeperFailed": "O guardião de memória falhou recentemente.",
  "contextSidebar.memory.status.compactionFailed": "A compactação de memória falhou recentemente.",
