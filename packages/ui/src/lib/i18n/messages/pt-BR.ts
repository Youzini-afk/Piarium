...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.recoveryDialog.noFileChanges': 'Este checkpoint não possui alterações de arquivo em relação ao workspace atual.',
  'chat.recoveryDialog.confirmSelection': 'Continuar com a recuperação selecionada',
  'chat.recoveryDialog.modeConflict': 'Esta recuperação já começou com outra opção. Feche este diálogo e escolha novamente.',
  ...
  'chat.recoveryDialog.preparing': 'Verificando o ponto de recuperação e o workspace atual…',
  'chat.recoveryDialog.filesAffected': 'Caminhos afetados',
  'chat.recoveryDialog.dataSize': 'Dados do snapshot',
  'chat.recoveryDialog.reviewRequired': 'Revisão necessária',
  'chat.recoveryDialog.noCheckpoint': 'Esta mensagem antiga não possui um snapshot nativo do workspace. Ainda é possível retornar somente a conversa do Pi.',
  ...
  'chat.recoveryDialog.inPlace': 'Voltar a conversa e este workspace',
  'chat.recoveryDialog.inPlaceDescription': 'Restaura os arquivos aqui e move a conversa do Pi de forma atômica, preservando antes um ponto de segurança.',
  'chat.recoveryDialog.newWorkspace': 'Restaurar em um novo workspace',
  'chat.recoveryDialog.newWorkspaceDescription': 'Mantém este workspace e a conversa inalterados e materializa o snapshot no caminho abaixo.',
  'chat.recoveryDialog.destination': 'Destino do workspace recuperado',
  'chat.recoveryDialog.applying': 'Aplicando recuperação…',
  'chat.recoveryDialog.operationState': 'Estado da recuperação: {state}',
  'chat.recoveryDialog.compensatedDescription': 'A conversa mudou antes da navegação. O Piarium restaurou o ponto de segurança original do workspace.',
  'chat.recoveryDialog.retry': 'Tentar novamente',
  'chat.recoveryDialog.completed': 'Conversa e workspace restaurados',
  'chat.recoveryDialog.newWorkspaceReady': 'Workspace recuperado criado em {path}; a conversa atual não foi alterada',
  ...
  'contextPanel.recovery.native.description': 'Pontos do workspace, operações combinadas e desfazer seguro após falhas.',
  'contextPanel.recovery.native.checkpointDescription': 'Fixe e nomeie a revisão atual usando o mesmo mecanismo imutável da recuperação de mensagens.',
  ...
  'contextPanel.recovery.native.noSnapshots': 'Ainda não há snapshots do workspace.',
  ...
  'contextPanel.recovery.native.undoNeedsWorkspace': 'Esta recuperação só pode ser desfeita em um novo workspace.',
