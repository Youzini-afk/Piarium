...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o Piarium para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Piarium instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao Piarium",
  ...
  "mobile.connect.password.placeholder": "Senha do Piarium",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Piarium.",
  ...
  "mobile.connect.relay.badge": "via Piarium Relay",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Piarium.",
  ...
  "sessions.sidebar.footer.actions.aboutPiarium": "Sobre o Piarium",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Piarium — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "workbench.ide.run.emptyTasks": "Nenhuma tarefa está definida. Adicione um arquivo piarium.tasks.json com um script node.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no Piarium. Baixe-o para abrir em outro aplicativo.",
  ...
  "header.services.shutdownDev": "Parar Piarium",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Piarium precisa acessar esta pasta.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Piarium com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Piarium",
  "header.actions.openAppMenuAria": "Abrir menu do Piarium",
  ...
  'chat.recoveryDialog.description': 'O Piarium verificará o ponto de recuperação antes de alterar a conversa ou o workspace.',
  'chat.recoveryDialog.filesAffected': 'Caminhos afetados',
  'chat.recoveryDialog.reviewRequired': 'Revisão necessária',
  'chat.recoveryDialog.incompleteCheckpoint': 'O snapshot desta mensagem está incompleto; o Piarium não o tratará como uma restauração segura dos arquivos.',
  ...
  "piariumDiagnosticsDialog.title": "Diagnósticos do Piarium",
  "piariumDiagnosticsDialog.description": "Inspecione o runtime Pi ativo e um resumo sem credenciais de pacotes, plugins, sessões e projeto.",
  "piariumDiagnosticsDialog.actions.copy": "Copiar",
  "piariumDiagnosticsDialog.actions.refresh": "Atualizar",
  "piariumDiagnosticsDialog.empty.noData": "Nenhum diagnóstico disponível.",
  "piariumDiagnosticsDialog.state.collecting": "Coletando diagnósticos...",
  "piariumDiagnosticsDialog.state.failed": "Falha ao coletar diagnósticos: {error}",
  "piariumDiagnosticsDialog.toast.copiedTitle": "Copiado",
  "piariumDiagnosticsDialog.toast.copiedDescription": "Diagnósticos copiados para a área de transferência",
  "piariumDiagnosticsDialog.toast.copyFailed": "Não foi possível copiar os diagnósticos",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o Piarium de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Piarium",
  ...
  "multiRun.window.description": "Janela do Piarium Multi-Run.",
  ...
  'onboarding.chooser.description': 'Use o Pi incluído no Piarium, escolha outra instalação local em Configurações ou conecte-se a um servidor Piarium remoto.',
  ...
  'onboarding.localSetup.description': 'O Piarium inclui o Pi, portanto não é necessária uma instalação separada. O runtime local padrão pode ser iniciado diretamente; você também pode escolher outra instalação local em Configurações.',
  ...
  'onboarding.localSetup.status.missingDetail': 'O runtime selecionado não está disponível. Tente novamente ou escolha outra instalação; se você usava o runtime incluído, reinstale o Piarium para corrigi-lo.',
  'onboarding.localSetup.status.upgradeRequired': "Este Pi é antigo demais",
  'onboarding.localSetup.status.upgradeRequiredDetail': "A versão instalada {currentVersion} está abaixo do mínimo {targetVersion}. Atualize esta instalação; o Piarium não fará downgrade de um Pi mais novo.",
  'onboarding.localSetup.status.failed': 'O runtime do workspace local não pôde ser iniciado',
  'onboarding.localSetup.status.hostEntryUnavailable': "A instalação do Piarium precisa de reparo",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': 'Os arquivos Host necessários para iniciar o runtime do workspace estão ausentes ou inacessíveis. Baixe e reinstale o Piarium; trocar ou atualizar o Pi não corrigirá esses arquivos.',
  ...
  'onboarding.localSetup.status.checkingDetail': 'Iniciando o runtime do workspace do Piarium…',
  ...
  'onboarding.localSetup.runtime.hostVersion': "Host do Piarium",
  ...
  'onboarding.localSetup.runtime.source.bundled': 'Incluído no Piarium',
  ...
  'onboarding.localSetup.actions.downloadPiariumAgain': "Baixar o Piarium novamente",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Piarium para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Piarium ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Piarium. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Piarium, mas não é compatível com esta versão do app. Atualize o Piarium no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Piarium. Verifique se o endereço aponta para um servidor Piarium.",
  ...
  "startup.initRecovery.description": "O Piarium não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Piarium...",
  "updateDialog.header.restarting": "Reiniciando o Piarium…",
  ...
  "updateDialog.status.desktopRestartingHint": "O Piarium está encerrando os serviços em segundo plano e transferindo o controle ao instalador. Isso pode levar um momento.",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: piarium update",
  "mobileUpdate.toast.available.title": "Atualização do Piarium disponível",
  ...
  "piariumLogo.aria.logo": "Logo do Piarium",
  "splash.aria.loading": "Carregando o Piarium",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor Piarium conectado não respondeu à API de percurso. Atualize o Piarium e tente novamente.",
