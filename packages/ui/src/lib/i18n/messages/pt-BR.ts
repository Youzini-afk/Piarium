...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.localSetup.description': "O Piarium usa o runtime do Pi instalado neste computador. Instale ou escolha um para continuar.",
  'onboarding.localSetup.status.ready': "O runtime do Pi está pronto",
  ...
  'onboarding.localSetup.status.missing': "Nenhum runtime do Pi encontrado",
  'onboarding.localSetup.status.missingDetail': "Instale o Pi para este usuário ou escolha uma instalação existente.",
  ...
  'onboarding.localSetup.status.failed': "O runtime do Pi não pôde ser iniciado",
  'onboarding.localSetup.status.hostEntryUnavailable': "A instalação do Piarium precisa de reparo",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "Os arquivos Host necessários para iniciar o Pi estão ausentes ou inacessíveis. Baixe e reinstale o Piarium; trocar ou atualizar o Pi não corrigirá esses arquivos.",
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "Detalhes técnicos",
  'onboarding.localSetup.status.checking': "Conectando ao runtime do Pi",
  'onboarding.localSetup.status.checkingDetail': "Negociando o protocolo de runtime do Piarium…",
  'onboarding.localSetup.status.installing': "Instalando o Pi",
  'onboarding.localSetup.status.upgrading': "Atualizando o Pi",
  'onboarding.localSetup.status.discovering': "Procurando um runtime do Pi",
  'onboarding.localSetup.status.probing': "Verificando o runtime do Pi",
  'onboarding.localSetup.errors.timeout': 'O handshake do runtime do Pi expirou. Tente novamente ou conecte-se a um servidor remoto.',
  'onboarding.localSetup.errors.managerUnavailable': "Esta superfície não pode gerenciar o runtime local do Pi.",
  ...
  'onboarding.localSetup.runtime.source.bundled': "Empacotado",
  ...
  "splash.status.connectingRuntime": "Conectando ao runtime do Pi",
