...
export const dict: Record<I18nKey, string> = {
  ...
  'contextSidebar.section.memory': '记忆',
  'contextSidebar.memory.effective': '当前生效模式：{mode}',
  'contextSidebar.memory.inherited': '使用全局设置',
  'contextSidebar.memory.override': '会话覆盖',
  'contextSidebar.memory.mode.inherit': '继承全局设置',
  'contextSidebar.memory.mode.off': '关闭',
  'contextSidebar.memory.mode.assist': '维护并注入（assist）',
  'contextSidebar.memory.mode.takeover': '维护并在就绪时接管压缩（takeover）',
  'contextSidebar.memory.status.updating': '正在更新记忆模式…',
  'contextSidebar.memory.status.updateFailed': '无法更新记忆模式。',
  'contextSidebar.memory.status.keeperFailed': '记忆维护器最近失败。',
  'contextSidebar.memory.status.compactionFailed': '记忆压缩最近失败。',
