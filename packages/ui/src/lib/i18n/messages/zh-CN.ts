...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.chooser.description': '使用本地 Pi 运行时，或连接远程 Piarium 服务器。',
  'onboarding.chooser.tabs.localInstall': '本地 Pi',
  'onboarding.chooser.tabs.connectRemote': '连接远程',
  'onboarding.localSetup.title': '本地 Pi 运行时',
  'onboarding.localSetup.description': 'Piarium 使用本机已安装的 Pi 运行时。请安装或选择一个后继续。',
  'onboarding.localSetup.status.ready': 'Pi 运行时已就绪',
  ...
  'onboarding.localSetup.status.missing': '未找到 Pi 运行时',
  'onboarding.localSetup.status.missingDetail': '可为当前用户安装 Pi，或选择已有安装。',
  ...
  'onboarding.localSetup.status.failed': 'Pi 运行时启动失败',
  'onboarding.localSetup.status.hostEntryUnavailable': 'Piarium 安装需要修复',
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '启动 Pi 所需的应用 Host 文件缺失或无法访问。请重新下载并安装 Piarium；升级或改选 Pi 无法修复这些应用文件。',
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': '技术详情',
  'onboarding.localSetup.status.checking': '正在连接 Pi 运行时',
  'onboarding.localSetup.status.checkingDetail': '正在协商 Piarium 运行时协议…',
  'onboarding.localSetup.status.installing': '正在安装 Pi',
  'onboarding.localSetup.status.upgrading': '正在升级 Pi',
  'onboarding.localSetup.status.discovering': '正在查找 Pi 运行时',
  'onboarding.localSetup.status.probing': '正在检查 Pi 运行时',
  'onboarding.localSetup.errors.timeout': 'Pi 运行时握手超时。请重试，或连接远程服务器。',
  'onboarding.localSetup.errors.managerUnavailable': '当前界面无法管理本机 Pi 运行时。',
  ...
  'onboarding.localSetup.runtime.source.bundled': '内置',
  'onboarding.localSetup.runtime.commandPath': '命令',
  'onboarding.localSetup.actions.continue': '使用本地 Pi',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Pi 运行时不可用',
  'onboarding.desktopRecovery.localUnavailable.description': '本地 Pi 运行时无法启动。请重试运行时，或改为连接远程服务器。',
  'onboarding.desktopRecovery.localUnavailable.retry': '重试本地',
  'onboarding.desktopRecovery.localUnavailable.useLocal': '检查本地 Pi',
  ...
  'splash.status.connectingRuntime': '正在连接 Pi 运行时',
