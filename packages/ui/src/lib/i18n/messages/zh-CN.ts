...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.sidebar.actions.chooseWorkspace': '选择工作区',
  'workspace.sidebar.actions.terminal': '终端',
  'workspace.sidebar.actions.newFolder': '新建文件夹',
  'workspace.sidebar.actions.upload': '上传',
  'workspace.sidebar.actions.sort': '排序',
  'workspace.sidebar.actions.refresh': '刷新',
  'workspace.sidebar.sort.nameAsc': '名称 A → Z',
  'workspace.sidebar.sort.nameDesc': '名称 Z → A',
  'workspace.sidebar.sort.modifiedDesc': '最近修改优先',
  'workspace.sidebar.sort.modifiedAsc': '最早修改优先',
  ...
  'workspace.sidebar.menu.newFile': '新建文件',
  'workspace.sidebar.menu.upload': '上传',
  'workspace.sidebar.menu.refreshGitStatus': '刷新 Git 状态',
  'workspace.sidebar.menu.addToSession': '添加到会话',
  'workspace.sidebar.menu.copyPath': '复制路径',
  'workspace.sidebar.menu.download': '下载',
  'workspace.sidebar.menu.rename': '重命名',
  'workspace.sidebar.menu.moveToTrash': '移到回收站',
  'workspace.sidebar.menu.permanentDelete': '永久删除',
  'workspace.sidebar.trash.title': '回收站',
  'workspace.sidebar.trash.empty': '回收站为空',
  'workspace.sidebar.state.empty': '空',
  'workspace.sidebar.state.loading': '加载中...',
  'workspace.sidebar.prompt.newFolderName': '新文件夹名称',
  'workspace.sidebar.prompt.newFileName': '新文件名称',
  'workspace.sidebar.prompt.renameTo': '重命名为',
  'workspace.sidebar.dialog.create.cancel': '取消',
  'workspace.sidebar.dialog.create.confirm': '创建',
  'workspace.sidebar.dialog.create.failed': '创建失败',
  'workspace.sidebar.dialog.create.fileDescription': '在 {path} 中创建新文件。',
  'workspace.sidebar.dialog.create.fileTitle': '新建文件',
  'workspace.sidebar.dialog.create.folderDescription': '在 {path} 中创建新文件夹。',
  'workspace.sidebar.dialog.create.folderTitle': '新建文件夹',
  'workspace.sidebar.dialog.create.invalidName': '名称不能为空，也不能包含 / 或 \\。',
  'workspace.sidebar.dialog.create.namePlaceholder': '名称',
  'workspace.sidebar.dialog.rename.title': '重命名',
  'workspace.sidebar.dialog.rename.description': '请输入“{name}”的新名称。',
  'workspace.sidebar.dialog.rename.placeholder': '新名称',
  'workspace.sidebar.dialog.rename.invalidName': '名称不能为空，也不能包含 / 或 \\。',
  'workspace.sidebar.dialog.rename.sameName': '请输入不同的名称。',
  'workspace.sidebar.dialog.rename.cancel': '取消',
  'workspace.sidebar.dialog.rename.submit': '重命名',
  'workspace.sidebar.confirm.moveToTrash': '将“{name}”移到回收站？',
  'workspace.sidebar.confirm.permanentDelete': '永久删除“{name}”？此操作无法撤销。',
  'workspace.sidebar.toast.folderCreated': '文件夹已创建',
  'workspace.sidebar.toast.fileCreated': '文件已创建',
  'workspace.sidebar.toast.renamed': '已重命名',
  'workspace.sidebar.toast.movedToTrash': '已移到回收站',
  'workspace.sidebar.toast.permanentlyDeleted': '已永久删除',
  'workspace.sidebar.toast.uploaded': '已上传 {count} 个文件',
  'workspace.sidebar.toast.uploadFailed': '上传失败',
  'workspace.sidebar.toast.addedToSession': '已添加“{name}”到会话',
  'workspace.sidebar.toast.pathCopied': '路径已复制',
  'workspace.sidebar.toast.copyFailed': '复制失败',
  'workspace.sidebar.toast.downloadFailed': '下载失败',
  'workspace.sidebar.toast.workspaceSelected': '已切换工作区',
  'workspace.sidebar.toast.workspaceSelectFailed': '切换工作区失败',
  ...
  'workbench.patch.written': '已按当前文件版本写入补丁。',
  ...
  'chat.piComposer.sendResultUnknown': '消息发送后连接中断，结果尚不确定。草稿已保留，请先检查会话再决定是否重发。',
  ...
  'contextRail.surface.recovery.description': '会话恢复、检查点与提示词修复',
  ...
  'chat.workStatus.title': '工作状态',
  'chat.workStatus.section.session': '会话',
  'chat.workStatus.section.activity': '当前活动',
  'chat.workStatus.section.pinned': '固定上下文',
  'chat.workStatus.toolCalls': '工具调用',
  'chat.workStatus.tokens': '令牌',
  'chat.workStatus.queue': '队列',
  'chat.workStatus.state.working': '工作中',
  'chat.workStatus.state.compacting': '压缩中',
  'chat.workStatus.state.retrying': '重试中',
  'chat.workStatus.state.idle': '空闲',
