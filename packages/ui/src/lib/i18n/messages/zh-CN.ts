...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 Piarium 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Piarium 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 Piarium',
  ...
  'mobile.connect.password.placeholder': 'Piarium 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 Piarium 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutPiarium': '关于 Piarium',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Piarium 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'workbench.ide.run.emptyTasks': '尚未定义任务。添加包含 node 脚本的 piarium.tasks.json 文件。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 Piarium 中编辑。请下载后使用其他应用打开。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Piarium 需要访问此文件夹。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Piarium',
  ...
  'header.actions.openAppMenu': 'Piarium 菜单',
  'header.actions.openAppMenuAria': '打开 Piarium 菜单',
  ...
  'piariumDiagnosticsDialog.title': 'Piarium 诊断',
  'piariumDiagnosticsDialog.description': '查看当前 Pi 运行时，以及不含凭据的包、插件、会话与项目状态摘要。',
  'piariumDiagnosticsDialog.actions.copy': '复制',
  'piariumDiagnosticsDialog.actions.refresh': '刷新',
  'piariumDiagnosticsDialog.empty.noData': '暂无诊断信息。',
  'piariumDiagnosticsDialog.state.collecting': '正在收集诊断信息...',
  'piariumDiagnosticsDialog.state.failed': '收集诊断信息失败：{error}',
  'piariumDiagnosticsDialog.toast.copiedTitle': '已复制',
  'piariumDiagnosticsDialog.toast.copiedDescription': '诊断信息已复制到剪贴板',
  'piariumDiagnosticsDialog.toast.copyFailed': '复制诊断信息失败',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 Piarium，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Piarium',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Piarium 服务器之间切换',
  ...
  'multiRun.window.description': 'Piarium 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Piarium',
  'onboarding.chooser.description': '使用 Piarium 内置的 Pi、在设置中选择其他本地安装，或连接远程 Piarium 服务器。',
  'onboarding.chooser.tabs.localInstall': '本地工作区',
  'onboarding.chooser.tabs.connectRemote': '连接远程',
  'onboarding.localSetup.title': '本地工作区运行时',
  'onboarding.localSetup.description': 'Piarium 已内置 Pi，无需单独安装。默认本地运行时可直接启动；你也可以在设置中选择其他本地安装。',
  ...
  'onboarding.localSetup.status.missingDetail': '所选运行时不可用。请重试或选择其他安装；如果使用的是内置运行时，可重新安装 Piarium 进行修复。',
  'onboarding.localSetup.status.upgradeRequired': '当前 Pi 版本过低',
  'onboarding.localSetup.status.upgradeRequiredDetail': '已安装的 {currentVersion} 低于最低要求 {targetVersion}。请升级此安装；Piarium 不会降级更新的 Pi。',
  'onboarding.localSetup.status.failed': '本地工作区运行时启动失败',
  'onboarding.localSetup.status.hostEntryUnavailable': 'Piarium 安装需要修复',
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '启动工作区运行时所需的应用 Host 文件缺失或无法访问。请重新下载并安装 Piarium；升级或改选 Pi 无法修复这些应用文件。',
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': '技术详情',
  'onboarding.localSetup.status.checking': '正在启动工作区运行时',
  'onboarding.localSetup.status.checkingDetail': '正在启动 Piarium 工作区运行时…',
  ...
  'onboarding.localSetup.runtime.hostVersion': 'Piarium 主机',
  ...
  'onboarding.localSetup.runtime.source.bundled': 'Piarium 内置',
  ...
  'onboarding.localSetup.actions.downloadPiariumAgain': '重新下载 Piarium',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Piarium 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Piarium 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Piarium。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Piarium，但与此应用版本不兼容。请更新服务器上的 Piarium 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Piarium。请确认地址是否指向 Piarium 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Piarium。请确认地址是否指向 Piarium 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Piarium 服务器与此应用版本不兼容。请更新服务器上的 Piarium 后重试。',
  ...
  'startup.initRecovery.description': 'Piarium 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.restarting': '正在重启 Piarium…',
  ...
  'updateDialog.status.desktopRestartingHint': 'Piarium 正在关闭后台服务并交给安装程序处理，请稍候。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：piarium update',
  ...
  'piariumLogo.aria.logo': 'Piarium 标志',
  'splash.aria.loading': '正在加载 Piarium',
  ...
  'walkthrough.blocked.serverUnsupported.description': '当前连接的 Piarium 服务器未响应导读 API。请更新 Piarium 后刷新。',
