...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.recoveryDialog.description': 'Piarium 会先核验消息检查点和当前工作区，再改动对话或文件。',
  'chat.recoveryDialog.preparing': '正在检查检查点和当前工作区…',
  'chat.recoveryDialog.filesAffected': '受影响路径',
  'chat.recoveryDialog.dataSize': '快照数据',
  'chat.recoveryDialog.reviewRequired': '需要确认',
  'chat.recoveryDialog.noCheckpoint': '这条旧消息没有原生工作区检查点；仍然可以只回退 Pi 对话。',
  'chat.recoveryDialog.incompleteCheckpoint': '这条消息的工作区检查点不完整，Piarium 不会把它当成可安全恢复的文件状态。',
  'chat.recoveryDialog.inPlace': '同时回退对话和当前工作区',
  'chat.recoveryDialog.inPlaceDescription': '先保留安全检查点，再在这里恢复文件并原子切换 Pi 对话。',
  'chat.recoveryDialog.newWorkspace': '恢复到新工作区',
  'chat.recoveryDialog.newWorkspaceDescription': '当前工作区和对话保持不变，把检查点恢复到下面的路径。',
  'chat.recoveryDialog.destination': '新工作区路径',
  'chat.recoveryDialog.applying': '正在执行恢复…',
  'chat.recoveryDialog.operationState': '恢复状态：{state}',
  'chat.recoveryDialog.compensatedDescription': '提交导航前对话已变化，Piarium 已把工作区恢复到原来的安全检查点。',
  'chat.recoveryDialog.retry': '重试',
  'chat.recoveryDialog.completed': '对话和工作区已恢复',
  'chat.recoveryDialog.newWorkspaceReady': '已在 {path} 创建恢复工作区；当前对话没有变化',
  'chat.recoveryDialog.noFileChanges': '这个检查点与当前工作区之间没有文件变化。',
  'chat.recoveryDialog.confirmSelection': '按所选方式继续恢复',
  'chat.recoveryDialog.modeConflict': '这次恢复已按另一种方式启动。请关闭面板后重新选择。',
  ...
  'contextPanel.recovery.native.description': '查看工作区检查点、联合恢复操作和可续跑的安全撤销。',
  'contextPanel.recovery.native.checkpointDescription': '给当前工作区版本命名并固定；它与消息回退使用同一套不可变快照引擎。',
  ...
  'contextPanel.recovery.native.noSnapshots': '还没有工作区快照。',
  'contextPanel.recovery.native.combinedOperation': '对话与工作区恢复',
  'contextPanel.recovery.native.undoOperation': '恢复撤销',
  'contextPanel.recovery.native.undoConfirm': '撤销这次已完成的恢复，让对话和工作区一起回到它的安全检查点吗？',
  'contextPanel.recovery.native.undoNeedsWorkspace': '这次恢复只能撤销到新工作区，请通过消息恢复选择器确认目标路径。',
