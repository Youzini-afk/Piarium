...
export const dict: Record<I18nKey, string> = {
  ...
  'tasksHub.scheduledDescription': "让智能体按计划执行任务。",
  'followupEditor.create': "新建接续任务",
  'followupEditor.edit': "编辑接续任务",
  'followupEditor.description': "届时在所选对话中继续。若条件已经满足，可能立即接续。",
  'followupEditor.session': "接续哪个对话",
  'followupEditor.chooseSession': "选择对话",
  'followupEditor.noSessions': "请选择一条关联项目的已有对话。",
  'followupEditor.instruction': "届时要做什么",
  'followupEditor.condition': "何时接续",
  'followupEditor.at': "日期与时间",
  'followupEditor.path': "工作区相对文件路径",
  'followupEditor.branch': "分支（留空使用当前分支）",
  'followupEditor.invalidTime': "请选择有效的日期与时间。",
  'followupEditor.keepSource': "保留原触发条件",
  'followupEditor.chooseExperiment': "选择实验",
  'followupEditor.kind.time': "指定时间",
  'followupEditor.kind.file': "文件状态",
  'followupEditor.kind.experiment': "实验结束",
  'followupEditor.kind.external': "Pull Request 状态",
  'followupEditor.kind.manual': "手动唤醒",
  'followupEditor.file.exists': "文件出现",
  'followupEditor.file.changed': "每次文件变化",
  'followupEditor.file.ready': "文件就绪",
  'followupEditor.pr.exists': "PR 已存在",
  'followupEditor.pr.open': "PR 已打开",
  'followupEditor.pr.merged': "PR 已合并",
  'followupEditor.pr.closed': "PR 已关闭",
  'tasksHub.title': "定时与接续",
  'tasksHub.scheduled': "定时任务",
  'tasksHub.followUps': "接续任务",
  'tasksHub.followUpsDescription': "集中查看本实例各对话的等待任务；时间到达或条件满足后，接着原对话继续。",
  'tasksHub.active': "等待中",
  'tasksHub.history': "历史记录",
  'tasksHub.search': "搜索条件、指令或对话",
  'tasksHub.refresh': "刷新",
  'tasksHub.empty': "暂无待接续任务。可在对话中让智能体在指定时间或条件满足时继续工作。",
  'tasksHub.emptyHistory': "暂无接续记录。",
  ...
  'research-workbench.mainline': "科研主线",
  'research-workbench.latestFinding': "最近结果",
  'research-workbench.branchesAndMaterials': "研究分支与材料",
  'research-workbench.retry': "重试",
  'research-facts.summary': "{attempts} 个实验尝试 · {machines} 台机器 · {sources} 个来源",
  'research-facts.attempts': "实验",
  'research-facts.machines': "机器",
  'research-facts.sources': "来源",
  'research-facts.emptyAttempts': "没有记录实验尝试。",
  'research-facts.emptyMachines': "没有注册执行目标。",
  'research-facts.cancel': "取消",
  'research-facts.collect': "收集",
  'research-facts.capacity': "容量",
  'research-facts.capacityUnknown': "容量未知",
  'research-facts.usage': "使用情况",
  'research-facts.usageUnread': "使用情况未读取",
  'research-facts.stale': "已过期",
  'research-facts.commitments': "{count} 个占用",
  'research-facts.queued': "排队中",
  'research-facts.sourceRetired': "已停用",
  'research-facts.attempt.submitted': "已提交",
  'research-facts.attempt.queued': "排队中",
  'research-facts.attempt.running': "运行中",
  'research-facts.attempt.stopping': "停止中",
  'research-facts.attempt.completed': "已完成",
  'research-facts.attempt.failed': "失败",
  'research-facts.attempt.cancelled': "已取消",
  'research-facts.attempt.lost': "已丢失",
  'research-facts.attempt.unknown': "未知状态",
  'research-facts.machine.available': "可用",
  'research-facts.machine.degraded': "降级",
  'research-facts.machine.offline': "离线",
  'research-facts.machine.retired': "已停用",
  'research-facts.connection.connected': "已连接",
  'research-facts.connection.degraded': "连接降级",
  'research-facts.connection.offline': "连接离线",
  'research-facts.connection.unknown': "连接未知",
  'research-facts.collection.pending': "收集中",
  'research-facts.collection.done': "已收集",
  'research-facts.collection.failed': "收集失败",
  'research-facts.source': "来源",
  'research-facts.observedAt': "观测于 {time}",
  'research-facts.checkedAt': "检查于 {time}",
  'research-facts.viewDetails': "查看详情",
  'research-facts.hideDetails': "隐藏详情",
  'research-facts.loadingDetails': "正在加载尝试详情…",
  'research-facts.detailsUnavailable': "尝试详情不可用。",
  'research-facts.logs': "日志",
  'research-facts.log.stdout': "标准输出",
  'research-facts.log.stderr': "标准错误",
  'research-facts.loadLog': "加载",
  'research-facts.loadMore': "加载更多",
  'research-facts.noLog': "没有日志输出。",
  'research-facts.artifacts': "产物",
  'research-facts.noArtifacts': "没有已收集的产物。",
  'research-facts.download': "下载",
  'research-facts.artifactUnavailable': "不可用",
  'research-facts.refreshFailed': "刷新失败；正在显示之前的事实。",
  'research-facts.target': "目标",
  'research-facts.targetSource.desktop-host': "桌面 Host",
  'research-facts.targetSource.ssh-instance': "SSH 实例",
  'research-facts.targetSource.configured-host': "已配置 Host",
  'research-facts.capabilities': "能力",
  'research-facts.coordinator': "协调 Host",
  'research-facts.coordinatorUnavailable': "协调 Host 不可用；排队任务需要它在线。",
  'research-facts.backend': "后端",
  'research-facts.sourceThread': "来源 Thread",
  'research-facts.sourceRun': "来源 Run",
  'research-facts.awaitingCoordinator': "等待协调者",
  'research-facts.remoteAccepted': "远端已接收；关闭此桌面后仍可继续运行。",
  'research-facts.remoteArtifact': "远端",
  'research-facts.remoteUnreachable': "远端产物不可访问",
  'research-facts.remoteExpired': "远端产物已过期",
  'research-facts.targetDetails': "目标详情",
  'research-facts.resourceDetails': "资源详情",
  'research-facts.remoteJobsSurviveDisconnect': "已接收任务可在客户端断开后继续",
  'research-facts.remoteJobsMayStopWithClient': "已接收任务可能随客户端停止",
  'research-facts.unassignedNeedsCoordinator': "未派发任务需要协调者在线",
  'research-facts.unassignedCoordinatorOptional': "未派发任务不需要此协调者",
  'research-facts.gpuProbe': "GPU 探测",
  'research-facts.selectAttempt': "选择尝试 {attempt}",
  'research-facts.executionCwd': "工作目录",
  'research-facts.executionRoot': "执行根目录",
  'research-facts.technicalDetails': "技术详情",
  'research-facts.jobState': "作业状态",
  'research-facts.retryOf': "补跑自",
  'research-facts.rerun': "补跑",
  'research-facts.selectedCount': "已选择 {count} 项",
  'research-facts.cancelSelected': "取消已选",
  'research-facts.rerunSelected': "补跑已选",
  'research-facts.actionFailed': "操作失败",
  'research-facts.unknownTarget': "未知目标",
  'workFocus.label': "工作侧重",
  'workFocus.code': "通用",
  'workFocus.research': "科研",
  'workFocus.codeDescription': "处理编程与日常任务，按需要调用工具。",
  'workFocus.researchDescription': "调查问题、比较解释，设计并推进实验。",
  'workFocus.pending': "待下次启动生效",
  'workFocus.nextTurn': "修改在下次启动执行时生效；当前运行及其追问队列保留原侧重。",
  'workFocus.fromProject': "创建对话时采用的项目默认值。",
  'workFocus.failed': "应用失败，仍使用{focus}。再次发送可重试。",
  'workFocus.useProjectDefault': "使用项目默认：{focus}",
  'workFocus.projectDefault': "默认工作侧重",
  'workFocus.projectDefaultDescription': "用于新对话；已有对话保留各自的工作侧重。",
  'chat.statusRow.todo.clear': '清除',
  'chat.statusRow.todo.clearAria': '清除此会话的任务',
  ...
  'harness.overview.description': '集中查看计划、变更、子任务、来源和当前会话上下文。',
  'harness.overview.review': '待确认',
  'harness.overview.reviewCount': '{count} 项待确认',
  'harness.overview.plan': '计划',
  'harness.overview.planProgress': '{done}/{total}',
  'harness.overview.outputs': '产出与变更',
  'harness.overview.workspaceChanges': '当前工作区',
  'harness.overview.outputFiles': '{count} 个文件',
  'harness.overview.outputDiff': '{files} 个文件 · +{insertions} −{deletions}',
  'harness.overview.moreItems': '另有 {count} 项',
  'harness.overview.viewChanges': '查看变更',
  'harness.overview.pendingThreadChanges': '子任务产出',
  'harness.overview.pendingThreadChangesDescription': '来自隔离子任务、尚未合并到当前工作区的变更。',
  'harness.overview.threads': '子任务',
  'harness.overview.threadsSummary': '{active} 进行中 · {completed} 已完成',
  'harness.overview.sources': '来源',
  'harness.overview.memory': '记忆与决定',
  'harness.overview.memoryProgress': '当前进展',
  'harness.overview.memoryDecisions': '关键决定',
  'harness.overview.runDetails': '运行详情',
  'harness.overview.summary.attention': '{count} 个子任务需要处理',
  'harness.overview.summary.blocked': '计划有 {count} 项受阻',
  'harness.overview.summary.running': '{count} 个子任务正在执行',
  'harness.overview.summary.plan': '进行中 · {done}/{total} 项',
  'harness.overview.summary.review': '{count} 项等待确认',
  'harness.overview.summary.done': '计划已完成 · {done}/{total}',
  'harness.overview.summary.changed': '{count} 个文件有变更',
  'harness.overview.summary.context': '当前工作上下文',
  'harness.blocks.title': '记忆与计划',
  'harness.blocks.edit': '编辑状态块',
  'harness.blocks.cancel': '取消',
  'harness.blocks.save': '保存',
  'harness.blocks.conflict': '这个状态块已在后台更新，现已载入最新版本；请检查后再保存。',
  'harness.knowledge.title': '知识审阅',
  'harness.knowledge.scope.workspace': '工作区',
  'harness.knowledge.scope.user': '用户',
  'harness.knowledge.content': '知识内容',
  'harness.knowledge.trigger': '召回条件',
  'harness.knowledge.triggerPlaceholder': '什么时候应该想起它？',
  'harness.knowledge.supersedes': '取代已接受知识',
  'harness.knowledge.dismiss': '驳回',
  'harness.knowledge.save': '保存',
  'harness.knowledge.accept': '接受',
  'harness.knowledge.rememberWorkspace': '记到项目',
  'harness.knowledge.rememberUser': '记到用户',
  'harness.knowledge.created': '已加入知识审阅',
  ...
  'harness.sources.remove': '移除来源',
  'harness.pdf.openReader': '阅读 PDF',
  'harness.pdf.readerTitle': 'PDF 阅读器',
  'harness.pdf.readerDescription': '查看页面、搜索文字，并把选区加入当前对话草稿。',
  'harness.pdf.views': 'PDF 视图',
  'harness.pdf.pageView': '原页',
  'harness.pdf.textView': '当前页文字',
  'harness.pdf.structureView': '结构',
  'harness.pdf.cellsView': '单元格',
  'harness.pdf.openOriginal': '打开原文件',
  'harness.pdf.loading': '正在读取文档…',
  'harness.pdf.loadingPage': '正在渲染页面…',
  'harness.pdf.analyzing': '正在解析文档…',
  'harness.pdf.analyzeStructure': '解析结构',
  'harness.pdf.search': '搜索文字',
  'harness.pdf.searchPlaceholder': '查找文档内容',
  'harness.pdf.searchResults': '搜索结果（{count}）',
  'harness.pdf.noSearchResults': '没有找到匹配文字。',
  'harness.pdf.textUnavailable': '此文档没有可提取的文字。',
  'harness.pdf.noStructure': '尚无可用的结构数据。',
  'harness.pdf.headings': '标题',
  'harness.pdf.pages': '页面',
  'harness.pdf.tables': '表格',
  'harness.pdf.tablesFound': '检测到 {count} 个表格。',
  'harness.pdf.pageLayouts': '页面布局',
  'harness.pdf.layoutsFound': '检测到 {count} 个页面布局。',
  'harness.pdf.figures': '图示',
  'harness.pdf.figureNumber': '图 {index}',
  'harness.pdf.formulas': '公式候选',
  'harness.pdf.pageAlt': '{title}，第 {page} 页',
  'harness.pdf.pageNumber': '第 {page} 页',
  'harness.pdf.previousPage': '上一页',
  'harness.pdf.goToPage': '跳转到页面',
  'harness.pdf.nextPage': '下一页',
  'harness.pdf.zoomOut': '缩小',
  'harness.pdf.zoomIn': '放大',
  'harness.pdf.selectedRegion': '已选页面区域',
  'harness.pdf.regionSelected': '已选择区域',
  'harness.pdf.askAboutSelection': '围绕此处提问',
  'harness.pdf.addingToDraft': '正在加入草稿…',
  'harness.pdf.addedToDraft': '已加入当前对话草稿。',
  'harness.pdf.hitHasNoRegion': '此文字匹配没有页面坐标。',
  'harness.pdf.sessionMissing': '请打开一个对话后再阅读或引用此 PDF。',
  'harness.pdf.sessionChanged': '请切回拥有此 PDF 的会话后再阅读或引用。',
  'harness.pdf.sessionWorkspaceRequired': '请在此工作区打开对话后搜索或引用 PDF。下方仍可查看原文件。',
  'harness.pdf.sourceUnavailable': '此会话中无法读取该 PDF。',
  'harness.pdf.sourceHashUnavailable': '缺少原文件哈希，无法引用此区域。',
  'harness.pdf.pageImageUnavailable': '无法读取此页面图像。',
  'harness.pdf.analysisUnavailable': '结构解析不可用：{reason}',
  'harness.pdf.ocrUnavailable': '此文档无法进行 OCR 识别。',
  'harness.pdf.readCurrentPageWithOcr': '识别当前页文字（OCR）',
  'harness.pdf.ocrUsed': '已识别当前页文字。',
  'harness.pdf.ocrNotNeeded': '此页已有可提取文字，无需 OCR。',
  'harness.pdf.sourceHashMismatch': '此引用对应的 PDF 原件不同。请重新载入材料后再引用。',
  'harness.pdf.runtimeChanged': '连接的 Host 已切换。请在当前会话中重新打开 PDF。',
  'harness.pdf.analysisRange': '结构解析范围',
  'harness.pdf.currentPage': '当前页',
  'harness.pdf.wholeDocument': '整个文档',
  'harness.pdf.readingOrder': '阅读顺序（{count}）',
  'harness.pdf.elements': '检测到的元素',
  'harness.pdf.tableCells': '{count} 个单元格',
  'harness.pdf.element.section': '章节',
  'harness.pdf.element.table': '表格',
  'harness.pdf.element.figure': '图示',
  'harness.pdf.element.formula': '公式',
  'harness.sources.originalSource': '原始来源',
  'harness.threads.discussion': '讨论线',
  'harness.threads.userThread': '用户线程',
  'harness.threads.kind.discussion': '讨论',
  'harness.threads.kind.implementation': '实现',
  'harness.threads.convert': '转为实现线程',
  'harness.threads.converting': '正在转换…',
  'harness.threads.convertFailed': '无法转换讨论线',
  'harness.threads.ask': '提问',
  'harness.threads.askPlaceholder': '向该线程提问或下达指令…',
  'harness.threads.fresh': '全新',
  'harness.threads.note': '留言',
  'harness.threads.sendFailed': '无法送达消息',
  'harness.threads.peer.user': '用户',
  'harness.threads.peer.session': '父会话',
  'harness.threads.msg.inform': '留言',
  'harness.threads.msg.request': '请求',
  'harness.threads.msg.held': '已挂起待下次运行',
  'harness.threads.merge': '合并结果',
  'harness.threads.merging': '正在合并…',
  'harness.threads.mergeFailed': '无法合并线程结果',
  'harness.threads.undoMerge': '撤销编辑器合并',
  'harness.threads.undoUnavailable': '编辑器合并已无法撤销',
  'harness.threads.chooseParent': '保留父内容',
  'harness.threads.chooseChild': '使用子结果',
  'harness.threads.chooseBase': '使用基线',
  'harness.threads.unavailable': '目标不可用',
  'harness.threads.surfacePending': '编辑器草稿',
  'harness.threads.previewStale': '此预览已失效',
  'harness.threads.previewApplicability': '合并预览只说明能否应用，不代表测试通过。',
  'harness.threads.verification.child': '结果检查（r{revision}）',
  'harness.threads.verification.childEmpty': '该结果尚未记录命令',
  'harness.threads.verification.childUncertain': '绑定不确定：{reason}',
  'harness.threads.verification.command': '退出 {code} · {command}',
  'harness.threads.verification.merge': '合并可应用性',
  'harness.threads.verification.parent': '合并后的父状态检查',
  'harness.threads.verification.parentUnsaved': '草稿合并未保存；磁盘命令不能验证未保存缓冲',
  'harness.threads.verification.parentNone': '此次合并尚未记录父会话检查',
  'harness.threads.verification.review': '审阅（r{revision}）',
  'harness.threads.verification.reviewRunning': '正在审阅',
  'harness.threads.verification.reviewNone': '尚未审阅',
  'harness.threads.state.dirty': '有未发布结果',
  'chat.messageBody.actions.openThreadAria': '从这条消息开一条讨论线',
  'chat.messageBody.actions.openThread': '从这里开一条线',
  'chat.messageBody.actions.openThreadWithoutBlocks': '开一条不带记忆块的讨论线',
  'chat.messageBody.actions.openThreadFailed': '无法从这条消息创建讨论线',
  ...
  'harness.threads.state.failed': '失败',
  'harness.threads.state.cancelled': '已取消',
  'harness.threads.state.interrupted': '已中断',
  'harness.threads.state.merge-ready': '待合并',
  'harness.threads.state.conflict': '有冲突',
  'harness.threads.state.merged': '已合并',
  'harness.threads.state.archived': '已归档',
  'harness.threads.archive': '归档',
  'harness.threads.archiving': '正在归档…',
  'harness.threads.archiveFailed': '无法归档该线程',
  'harness.threads.restore': '恢复',
  'harness.threads.restoring': '正在恢复…',
  'harness.threads.restoreFailed': '无法恢复该线程',
  'harness.threads.reclaim': '回收目录',
  'harness.threads.reclaiming': '正在回收…',
  'harness.threads.reclaimFailed': '无法回收线程目录',
  'harness.threads.keepWorktree': '保留目录',
  ...
  'harness.threads.hideArchived': '隐藏已归档',
  'harness.threads.space.title': '占用',
  'harness.threads.space.bytes': '{bytes} B',
  'harness.threads.space.unknownSize': '未知',
  'harness.threads.space.logical': '目录 {bytes}',
  'harness.threads.space.overBudget': '已超过配置的工作树预算',
  'harness.threads.space.lowFree': '剩余空间低于配置的最低比例',
  'harness.threads.space.enospc': '卷已没有可用空间',
  'harness.threads.space.kept': '保留原因：{reason}',
  'harness.threads.empty': '此视图没有线程',
  'harness.threads.history.open': '历史结果',
  'harness.threads.history.title': '线程结果历史',
  'harness.threads.history.loading': '正在加载历史结果…',
  'harness.threads.history.loadFailed': '无法加载线程结果历史',
  'harness.threads.history.retry': '重试',
  'harness.threads.history.empty': '此线程没有原生结果。',
  'harness.threads.history.revision': '结果 r{revision}',
  'harness.threads.history.select': '选择要释放的结果 r{revision}',
  'harness.threads.history.bytes': '{bytes} B',
  'harness.threads.history.retainedBytesNote': '显示此版本引用的内容大小；共享内容在所有引用释放后才会回收。',
  'harness.threads.history.protected': '受保护：{reasons}',
  'harness.threads.history.protected.branchHead': '分支头',
  'harness.threads.history.protected.currentResult': '当前结果',
  'harness.threads.history.protected.runInput': '活动 Run 输入',
  'harness.threads.history.protected.review': '正在审阅',
  'harness.threads.history.protected.integration': '待处理 Integration',
  'harness.threads.history.release': '释放已选 {count} 项',
  'harness.threads.history.releasing': '正在释放…',
  'harness.threads.history.releaseFailed': '无法释放所选结果',
  'harness.threads.history.confirmTitle': '释放所选结果？',
  'harness.threads.history.confirmDescription': '要释放此线程中的 {count} 个所选结果吗？',
  'harness.threads.history.confirmWarning': '释放后将无法再读取或合并这些版本。报告、会话转录及其他所有者引用的内容会保留。',
  'harness.threads.history.cancel': '取消',
  'harness.threads.history.confirm': '释放结果',
  'harness.threads.history.released': '已释放 {count} 个结果。',
  'harness.threads.history.missing': '所选结果中有 {count} 个已经不存在。',
  'harness.threads.history.cleanupComplete': '清理已删除 {objects} 个对象，回收 {bytes} B。',
  'harness.threads.history.cleanupFailed': '历史版本已移除，清理尚未完成：{message}',
  'harness.threads.history.retryCleanup': '重试清理',
  ...
  'markdownRenderer.fileReference.openFileTitle': '打开文件',
  'pwa.installPrompt.description': '安装 Varin 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Varin 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 Varin',
  ...
  'mobile.connect.password.placeholder': 'Varin 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 Varin 服务器。',
  ...
  'sessions.sidebar.grouping.generalChat': '普通对话',
  ...
  'sessions.scheduledTasks.dialog.confirm.deleteLoopFile': '删除“{taskName}”对应的循环文件？',
  'sessions.scheduledTasks.dialog.loopFile.project': '项目循环',
  'sessions.scheduledTasks.dialog.loopFile.user': '用户循环',
  'sessions.scheduledTasks.loopEditor.title': '编辑循环',
  'sessions.scheduledTasks.loopEditor.description': '编辑作为权威来源的 Markdown 循环文件。',
  'sessions.scheduledTasks.loopEditor.confirmDiscard': '放弃尚未保存的循环修改？',
  ...
  'sessions.scheduledTasks.editor.goal.budgetLabel': 'token 预算',
  'sessions.scheduledTasks.editor.goal.budgetAria': '用 token 预算限制该目标',
  ...
  'sessions.sidebar.footer.actions.aboutVarin': '关于 Varin',
  ...
  'sessions.sidebar.project.actions.pin': '置顶',
  'sessions.sidebar.project.actions.archiveChats': '归档聊天',
  'sessions.sidebar.project.actions.remove': '移除项目',
  'sessions.sidebar.project.reveal.error': '无法打开项目目录',
  'sessions.sidebar.dialogs.removeProject.title': '移除项目？',
  'sessions.sidebar.dialogs.removeProject.description': '“{projectTitle}”将从侧边栏移除。会话和文件都会保留。',
  'sessions.sidebar.project.actions.newDraftSession': '新建草稿会话',
  'sessions.sidebar.session.menu.rename': '重命名',
  'sessions.sidebar.session.menu.restore': '恢复会话',
  ...
  'sessions.sidebar.session.unarchive.success': '会话已恢复',
  'sessions.sidebar.session.unarchive.error': '恢复会话失败',
  ...
  'gitView.directorySelector.label': 'Git 文件夹',
  'gitView.directorySelector.noDirectory': '未选择文件夹',
  'gitView.directorySelector.choose': '选择文件夹',
  'gitView.directorySelector.followSession': '跟随会话',
  'gitView.directorySelector.dialogTitle': '选择 Git 文件夹',
  'gitView.directorySelector.dialogDescription': '请先选择文件夹，随后 Git 面板会加载该文件夹的仓库状态。',
  'gitView.directorySelector.dialogConfirm': '使用文件夹',
  ...
  'contextRail.surface.context.description': '会话上下文与 token 用量',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Varin 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'workspace.archive.menu.preview': '预览压缩包',
  'workspace.archive.menu.extractNewFolder': '解压到新文件夹',
  'workspace.archive.menu.extractHere': '解压到此处',
  'workspace.archive.actions.extract': '解压',
  'workspace.archive.actions.extracting': '解压中...',
  'workspace.archive.actions.cancel': '取消',
  'workspace.archive.dialog.title': '压缩包',
  'workspace.archive.dialog.description': '预览并解压压缩包内容。',
  'workspace.archive.dialog.format': '格式',
  'workspace.archive.dialog.entries': '内容',
  'workspace.archive.dialog.entryCount': '{files} 个文件，{folders} 个文件夹',
  'workspace.archive.dialog.totalSize': '总大小',
  'workspace.archive.dialog.mode': '解压方式',
  'workspace.archive.dialog.conflict': '冲突处理',
  'workspace.archive.dialog.destination': '目标目录',
  'workspace.archive.dialog.destinationPlaceholder': '工作区相对目标目录',
  'workspace.archive.dialog.deleteArchive': '解压成功后删除压缩包',
  'workspace.archive.dialog.loading': '正在读取压缩包...',
  'workspace.archive.dialog.folder': '文件夹',
  'workspace.archive.dialog.truncated': '预览已截断。',
  'workspace.archive.dialog.empty': '没有内容',
  'workspace.archive.mode.newFolder': '新文件夹',
  'workspace.archive.mode.merge': '解压到此处',
  'workspace.archive.conflict.rename': '自动重命名',
  'workspace.archive.conflict.skip': '跳过已有项',
  'workspace.archive.conflict.error': '遇到冲突停止',
  'workspace.archive.toast.previewFailed': '预览压缩包失败',
  'workspace.archive.toast.extracted': '已解压 {files} 个文件和 {folders} 个文件夹',
  'workspace.terminal.actions.restart': '重启',
  'workspace.terminal.actions.stop': '停止',
  'workspace.terminal.actions.restore': '还原',
  'workspace.terminal.actions.maximize': '最大化',
  'workspace.terminal.actions.hide': '隐藏',
  'workspace.terminal.status.connecting': '正在连接...',
  'workspace.terminal.status.processExited': '进程已退出',
  'workspace.terminal.error.createFailed': '创建终端失败',
  'workspace.terminal.error.connectionFailed': '终端连接失败',
  'workspace.terminal.error.sendFailed': '发送输入失败',
  'workspace.git.title': 'Git - {path}',
  'workspace.git.workspace': '工作区',
  'workspace.git.description': '工作区仓库',
  'workspace.git.state.loading': '加载中...',
  'workspace.git.state.notRepository': '不是 Git 仓库',
  'workspace.git.state.notRepositoryHint': '可以在这个文件夹里克隆仓库，也可以打开终端执行 git init 等命令。',
  'workspace.git.state.clean': '干净',
  'workspace.git.state.none': '无',
  'workspace.git.actions.terminal': '终端',
  'workspace.git.actions.refresh': '刷新',
  'workspace.git.actions.fetch': '获取',
  'workspace.git.actions.clone': '克隆',
  'workspace.git.actions.pull': '拉取',
  'workspace.git.actions.push': '推送',
  'workspace.git.actions.checkout': '检出',
  'workspace.git.actions.stageAll': '暂存全部更改',
  'workspace.git.actions.selectFile': '选择 {path}',
  'workspace.git.actions.commit': '提交',
  'workspace.git.actions.close': '关闭',
  'workspace.git.summary.branch': '分支',
  'workspace.git.summary.remote': '远端',
  'workspace.git.summary.ahead': '领先',
  'workspace.git.summary.behind': '落后',
  'workspace.git.section.clone': 'Clone 仓库',
  'workspace.git.section.repository': '当前仓库',
  'workspace.git.section.checkout': '检出',
  'workspace.git.section.changes': '变更',
  'workspace.git.section.remotes': '远端',
  'workspace.git.section.recentLog': '最近提交',
  'workspace.git.clone.description': '将在 {path} 中执行 clone，支持 HTTPS 或 SSH 仓库地址。',
  'workspace.git.placeholder.repositoryUrl': '仓库地址',
  'workspace.git.placeholder.cloneBranch': '分支，可留空',
  'workspace.git.placeholder.cloneDirectory': '文件夹，可留空',
  'workspace.git.placeholder.branch': '分支',
  'workspace.git.placeholder.commitMessage': '提交信息',
  'workspace.git.toast.cloned': '仓库已克隆',
  'workspace.git.toast.fetched': '已获取',
  'workspace.git.toast.pulled': '已拉取',
  'workspace.git.toast.pushed': '已推送',
  'workspace.git.toast.checkedOut': '已检出',
  'workspace.git.toast.selectFiles': '请选择文件或暂存全部更改',
  'workspace.git.toast.committed': '已提交',
  ...
  'filesView.editor.splitEditor': '拆分编辑器',
  'filesView.editor.pinTab': '固定标签页',
  'filesView.editor.unpinTab': '取消固定标签页',
  'filesView.editor.moveTab': '移动到其他分组',
  ...
  'filesView.editor.languageStarting': '正在启动语言功能…',
  'filesView.editor.languageDegraded': '部分语言功能暂不可用：{message}',
  'filesView.editor.languageFailed': '语言功能启动失败：{message}',
  'filesView.workspaceEdit.renameTitle': '预览重命名',
  'filesView.workspaceEdit.actionTitle': '预览更改',
  'filesView.workspaceEdit.descriptionSingle': '将更改 {count} 个文件，请在应用前检查。',
  'filesView.workspaceEdit.descriptionMany': '将更改 {count} 个文件，请在应用前逐一检查。',
  'filesView.workspaceEdit.files': '待更改文件',
  'filesView.workspaceEdit.editCountSingle': '{count} 处编辑',
  'filesView.workspaceEdit.editCountMany': '{count} 处编辑',
  'filesView.workspaceEdit.showFocused': '仅显示更改区域',
  'filesView.workspaceEdit.showFull': '显示完整文件',
  'filesView.workspaceEdit.before': '更改前',
  'filesView.workspaceEdit.after': '更改后',
  'filesView.workspaceEdit.noChanges': '没有文本更改',
  'filesView.workspaceEdit.apply': '应用更改',
  'filesView.workspaceEdit.renameDescription': '重命名为 {name}。应用前请检查所有受影响的文件。',
  'filesView.workspaceEdit.unavailable': '此位置没有可用的重命名或代码操作。',
  'filesView.workspaceEdit.stale': '文档或语言服务已发生变化，请重试。',
  'filesView.workspaceEdit.cancelled': '未应用更改。',
  'filesView.workspaceEdit.failed': '无法应用语言服务更改',
  'filesView.workspaceEdit.appliedSingle': '已更改 {count} 个文件',
  'filesView.workspaceEdit.appliedMany': '已更改 {count} 个文件',
  'filesView.workspaceEdit.undo': '撤销',
  'filesView.workspaceEdit.undone': '已撤销更改',
  'filesView.workspaceEdit.undoUnavailable': '这些更改已无法作为一个整体撤销。',
  'filesView.editor.useProvider': '使用 {provider}',
  'filesView.editor.diffAgainstDisk': '工作副本与上次保存内容的对比',
  'workbench.panel.terminal': '终端',
  'workbench.panel.problems': '问题',
  'workbench.panel.output': '输出',
  'workbench.panel.problemsEmpty': '此工作区没有问题。',
  'workbench.panel.outputEmpty': '没有输出通道。',
  'workbench.panel.problemsFailed': '无法加载问题：{message}',
  'workbench.panel.problemsItem': '{resourceId}: {message}',
  'workbench.panel.problemsItemAtLine': '{resourceId}:{line}: {message}',
  'workbench.panel.problemsOpenAria': '打开 {resourceId}',
  'workbench.panel.outputFailed': '无法加载输出：{message}',
  'workbench.panel.changes': '更改',
  'workbench.panel.changesEmpty': '此工作区没有 Agent 或未保存的文件更改。',
  'workbench.panel.changesOpenAria': '打开 {resourceId}',
  'workbench.panel.changesConflict': '冲突',
  'workbench.panel.changesDirty': '未保存',
  'workbench.panel.changesAgent': 'Agent',
  'workbench.panel.changesOpen': '已打开',
  'workbench.panel.changesItem': '{resourceId} · {state} · {revision}',
  'workbench.attachment.chipUnsaved': '未保存快照：{name}',
  'workbench.attachment.chipSaved': '已保存文件：{name}',
  'workbench.attachment.chipSelection': '选区：{name}',
  'workbench.attachment.chipDiagnostic': '问题：{name}',
  'workbench.attachment.chipDiff': '差异：{name}',
  'workbench.attachment.attachDiff': '将差异附加到智能体',
  'workbench.attachment.removeAria': '从 Agent 上下文中移除 {name}',
  'workbench.attachment.unsavedBadge': '未保存快照',
  'workbench.attachment.missing-editor': '没有可附加的活动编辑器。',
  'workbench.attachment.missing-selection': '请先在编辑器中选择文本。',
  'workbench.attachment.missing-document': '该文档未在工作台中打开。',
  'workbench.attachment.wrong-runtime': '此附件属于另一个 Agent 运行时。',
  'workbench.attachment.no-session': '请先打开 Agent 会话再附加编辑器上下文。',
  'workbench.patch.acceptHunk': '保留此块',
  'workbench.patch.rejectHunk': '还原此块',
  'workbench.patch.applyAccepted': '应用保留的块',
  'workbench.patch.revertRejected': '还原已拒绝的块',
  'workbench.patch.written': '补丁已应用到编辑器缓冲区，请在确认后保存。',
  'workbench.patch.conflict': '文件有未保存的编辑或更新的版本。请先解决编辑器冲突。',
  'workbench.patch.failed': '无法应用补丁：{message}',
  'workbench.ide.title': 'IDE 工作台',
  'workbench.ide.activity.explorer': '资源管理器',
  'workbench.ide.activity.search': '搜索',
  'workbench.ide.activity.git': 'Git',
  'workbench.ide.activity.run': '运行和测试',
  'workbench.ide.activity.extensions': '扩展',
  'workbench.ide.activity.explorerAria': '显示资源管理器',
  'workbench.ide.activity.searchAria': '显示搜索',
  'workbench.ide.activity.gitAria': '显示 Git',
  'workbench.ide.activity.runAria': '显示运行和测试',
  'workbench.ide.activity.extensionsAria': '显示扩展',
  'workbench.ide.sidebar.hideSecondary': '隐藏智能体侧栏',
  'workbench.ide.sidebar.showSecondary': '显示智能体侧栏',
  'workbench.ide.sessions': '会话',
  'workbench.ide.sessionsAria': '打开会话列表',
  'workbench.ide.search.placeholder': '按文件名搜索',
  'workbench.ide.search.empty': '没有匹配的文件。',
  'workbench.ide.search.failed': '搜索失败：{message}',
  'workbench.ide.search.noWorkspace': '打开工作区后再搜索文件。',
  'workbench.ide.search.searching': '正在搜索...',
  'workbench.ide.search.filesTab': '文件',
  'workbench.ide.search.contentTab': '文本',
  'workbench.ide.search.contentPlaceholder': '在工作区中搜索文本',
  'workbench.ide.search.contentEmpty': '没有匹配的文本。',
  'workbench.ide.search.contentFailed': '文本搜索失败：{message}',
  'workbench.ide.search.contentNoWorkspace': '打开工作区后再搜索文本。',
  'workbench.ide.search.filesAria': '按文件名搜索',
  'workbench.ide.search.contentAria': '在文件中搜索文本',
  'workbench.ide.run.unavailableTitle': '运行和测试尚不可用',
  'workbench.ide.run.unavailableDescription': '调试适配器和测试提供方会在后续工作台更新中提供。编辑、搜索、Git、终端和智能体仍可使用。',
  'workbench.ide.run.noWorkspace': '打开工作区以运行、调试和测试。',
  'workbench.ide.run.tasks': '任务',
  'workbench.ide.run.runTask': '运行 {label}',
  'workbench.ide.run.emptyTasks': '尚未定义任务。添加包含 node 脚本的 varin.tasks.json 文件。',
  'workbench.ide.run.tasksFailed': '无法加载任务：{message}',
  'workbench.ide.run.unsupported': '此运行时不支持运行、调试和测试。',
  'workbench.ide.debug.title': '调试',
  'workbench.ide.debug.start': '开始',
  'workbench.ide.debug.stop': '停止',
  'workbench.ide.debug.continue': '继续',
  'workbench.ide.debug.stepOver': '单步跳过',
  'workbench.ide.debug.stepInto': '单步进入',
  'workbench.ide.debug.stepOut': '单步跳出',
  'workbench.ide.debug.programAria': '要调试的程序',
  'workbench.ide.debug.paused': '已暂停',
  'workbench.ide.debug.running': '正在运行',
  'workbench.ide.debug.failed': '调试失败：{message}',
  'workbench.ide.debug.absent': '没有调试会话',
  'workbench.ide.debug.breakpoints': '断点',
  'workbench.ide.debug.breakpointsEmpty': '没有断点。可在编辑器中切换断点。',
  'workbench.ide.debug.callStack': '调用堆栈',
  'workbench.ide.debug.variables': '变量',
  'workbench.ide.debug.watch': '监视',
  'workbench.ide.debug.watchAdd': '添加',
  'workbench.ide.debug.watchRemove': '移除',
  'workbench.ide.debug.console': '调试控制台',
  'workbench.ide.debug.consolePlaceholder': '求值表达式',
  'workbench.ide.debug.evaluate': '求值',
  'workbench.ide.tests.title': '测试',
  'workbench.ide.tests.run': '运行测试',
  'workbench.ide.tests.discover': '发现',
  'workbench.ide.tests.empty': '未找到测试。',
  'workbench.ide.tests.failedLoad': '无法加载测试：{message}',
  'workbench.ide.tests.failedItem': '{label} 失败',
  'workbench.ide.tests.passedItem': '{label} 通过',
  'workbench.ide.tests.runningItem': '{label} 正在运行',
  'workbench.attachment.chipTestFailure': '测试失败：{name}',
  'workbench.attachment.chipStack': '堆栈：{name}',
  'workbench.attachment.missing-test': '没有可附加的测试失败。',
  'workbench.attachment.missing-stack': '没有可附加的堆栈帧。',
  'workbench.ide.extensions.openSettings': '打开扩展设置',
  'workbench.ide.extensions.empty': '尚未加载扩展。',
  'workbench.ide.status.noWorkspace': '没有工作区',
  'workbench.ide.status.noBranch': '没有分支',
  'workbench.ide.commandPalette': '命令面板',
  'workbench.ide.commandPaletteAria': '打开命令面板',
  'workbench.ide.settings': '设置',
  'workbench.ide.settingsAria': '打开设置',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 Varin 中编辑。请下载后使用其他应用打开。',
  ...
  'filesView.document.conflict.title': '磁盘上的文件已更改',
  'filesView.document.conflict.description': '你的未保存编辑与最新文件内容不一致。',
  'filesView.document.conflict.keepEdits': '保留我的编辑',
  'filesView.document.conflict.reloadDisk': '从磁盘重新加载',
  'filesView.document.conflict.agentDescription': 'Agent 或其他进程在你有未保存编辑时更改了此文件。',
  'filesView.document.conflict.ancestor': '原始内容',
  'filesView.document.conflict.yours': '你的编辑',
  'filesView.document.conflict.disk': '磁盘上',
  'filesView.document.conflict.merge': '查看三方合并',
  'filesView.document.conflict.acceptOurs': '保留我的',
  'filesView.document.conflict.acceptTheirs': '采用磁盘',
  'filesView.document.conflict.editHunk': '编辑合并文本',
  'filesView.document.conflict.applyEdited': '保存已编辑的合并结果',
  'filesView.document.deleted.title': '此文件已被删除',
  'filesView.document.deleted.description': '未保存的编辑仍在。保存将重新创建该文件。',
  'filesView.document.outsideWorkspace': '此路径位于工作区之外，无法在此编辑。',
  ...
  'contextSidebar.section.contextPreparation': '上下文准备',
  'contextSidebar.context.preparation.disabled': '后台准备已关闭',
  'contextSidebar.context.candidate.none': '空闲',
  'contextSidebar.context.candidate.preparing': '正在准备摘要',
  'contextSidebar.context.candidate.ready': '摘要就绪',
  'contextSidebar.context.status.preparationFailed': '后台准备最近失败。',
  'contextSidebar.context.status.compactionFailed': '压缩提交最近失败。',
  'contextSidebar.section.harness': '智能体 Harness',
  ...
  'contextSidebar.tokens.cacheWrite1h': '1 小时缓存写入',
  'contextSidebar.tokens.cacheHit': '缓存命中',
  'contextSidebar.tokens.total': '总计',
  ...
  'header.services.tokenUsage.description': '最近一次助手回复的 token 计数。',
  'header.services.tokenUsage.total': '总计',
  'header.services.tokenUsage.input': '输入',
  'header.services.tokenUsage.cache': '缓存',
  'header.services.tokenUsage.output': '输出',
  'header.services.tokenUsage.reasoning': '推理',
  'header.services.tokenUsage.cacheBreakdown': '缓存读取 {read} · 写入 {write}',
  ...
  'chat.goal.dialog.budgetLabel': 'token 预算',
  ...
  'chat.followup.status.triggered': '已触发',
  'chat.followup.status.delivered': '已送达',
  'chat.followup.status.cancelled': '已取消',
  'chat.followup.status.superseded': '已替换',
  'chat.followup.status.unavailable': '不可用',
  'chat.followup.action.check': '检查',
  'chat.followup.action.checkHint': '由程序检查来源，不调用 Agent',
  'chat.followup.action.fire': '立即执行',
  'chat.followup.action.fireHint': '触发后续并调用 Agent',
  'chat.followup.action.cancel': '取消',
  'chat.followup.action.cancelHint': '仅停止等待——被观察的工作继续运行',
  ...
  'directoryExplorerDialog.actions.selectFolder': '选择文件夹',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Varin 需要访问此文件夹。',
  ...
  'directoryExplorerDialog.footer.confirm': '确认',
  ...
  'aboutDialog.actions.openDiagnostics': '打开诊断',
  'aboutDialog.diagnosticsDescription': '查看 Pi 运行时、包、插件、会话与项目上下文。',
  'aboutDialog.footerNote': '为社区用心打造',
  'helpDialog.title': '键盘快捷键',
  'helpDialog.description': '使用这些快捷键可更高效地导航 Varin',
  ...
  'helpDialog.item.addSelectionToChat': '将选中文本添加到聊天',
  ...
  'header.actions.openAppMenu': 'Varin 菜单',
  'header.actions.openAppMenuAria': '打开 Varin 菜单',
  ...
  'chat.pendingChanges.summary.modified': '修改 {count}',
  'chat.pendingChanges.summary.created': '创建 {count}',
  'chat.pendingChanges.summary.deleted': '删除 {count}',
  'chat.changedFiles.title': '已更改文件',
  'chat.changedFiles.actions.openFile': '打开文件',
  'chat.changedFiles.actions.openFileTitle': '打开 {path}',
  'chat.changedFiles.actions.viewDiff': '查看差异',
  ...
  'chat.piComposer.queueFollowUp': '将后续消息加入队列',
  'chat.piComposer.steerCurrentRun': '调整当前运行',
  'chat.piComposer.sendResultUnknown': '消息发送后连接中断，结果尚不确定。请先检查会话，再决定是否重发。',
  ...
  'chat.piComposer.pdfAttachment.unsupported': '此会话工作区不支持上传 PDF。',
  ...
  'chat.timeline.loadFailed': '无法加载会话树',
  'chat.timeline.retry': '重试',
  'chat.timeline.refresh': '刷新会话树',
  'chat.timeline.attachmentsUnsupported': '打开 /tree 前请先移除附件',
  ...
  'chat.checkpoint.label.beforeMessage': '消息发送前',
  'chat.recoveryDialog.title': '回到这条消息',
  'chat.recoveryDialog.description': '回到这条消息前，请选择如何处理本次涉及的文件。',
  'chat.recoveryDialog.filesAffected': '受影响路径',
  'chat.recoveryDialog.reviewRequired': '需要确认',
  'chat.recoveryDialog.incompleteCheckpoint': '这一轮包含未能提前记录的 shell 或外部文件修改，因此只能可靠地回退对话。',
  'chat.recoveryDialog.partialCoverage': '部分变更路径未能提前记录，无法恢复。列出的文件将保持原样；其余受影响文件将被恢复。',
  'chat.recoveryDialog.noCoverage': '这一轮的变更路径均未能提前记录，无法恢复任何文件；仍可仅回退对话。',
  'chat.recoveryDialog.sourceShell': 'shell',
  'chat.recoveryDialog.sourceExternal': '外部',
  'chat.recoveryDialog.applying': '正在执行恢复…',
  'chat.recoveryDialog.retry': '重试',
  'chat.recoveryDialog.completed': '对话和工作区已恢复',
  'chat.checkpoint.confirm.viewDiff': '检测到这条消息前的文件存档。回退前先打开第一个变更文件的差异吗？（{count} 个变更）',
  'chat.checkpoint.confirm.restore': '是否把工作区文件恢复到这条消息的存档点？这可能覆盖或删除当前工作区更改。恢复前会自动创建一个安全存档点。（{count} 个文件受影响或被跟踪）',
  'chat.checkpoint.alert.restoreFailed': '恢复存档点失败：{message}',
  ...
  'chat.mobileStatus.subSessionTitle': '子会话：{title}',
  'chat.mobileStatus.untitledSession': '未命名',
  'chat.retryOverlay.defaultMessage': '已达到配额限制，正在自动重试。',
  ...
  'chat.toolPart.input': '输入',
  'chat.toolPart.output': '输出',
  'chat.toolPart.metadata': '元数据',
  'chat.toolPart.details': '工具详情',
  ...
  'chat.toolPart.subagent.waiting': '正在等待子代理活动...',
  'chat.toolPart.subagent.missingSessionId': '任务元数据中没有子代理会话 ID。',
  'chat.toolPart.subagent.moreHidden': '+{count} 条更多…',
  'chat.diffViewToggle.switchToUnified': '切换到统一视图',
  'chat.diffViewToggle.switchToSideBySide': '切换到并排视图',
  'chat.todo.total': '总计',
  ...
  'commandPalette.item.splitEditor': '拆分编辑器',
  'commandPalette.item.splitEditorOrthogonal': '正交拆分编辑器',
  'commandPalette.item.closeEditor': '关闭编辑器',
  'commandPalette.item.saveActiveFile': '保存文件',
  'commandPalette.item.saveAllFiles': '保存所有文件',
  'commandPalette.item.findInFile': '在文件中查找',
  'commandPalette.item.replaceInFile': '在文件中替换',
  'commandPalette.item.goToLine': '转到行',
  'commandPalette.item.goToSymbol': '转到符号',
  'commandPalette.item.formatDocument': '格式化文档',
  'commandPalette.item.renameSymbol': '重命名符号',
  'commandPalette.item.quickFix': '快速修复',
  'commandPalette.item.goToDefinition': '转到定义',
  'commandPalette.item.findReferences': '查找引用',
  'commandPalette.item.foldRegion': '折叠区域',
  'commandPalette.item.unfoldRegion': '展开区域',
  'commandPalette.item.toggleEditorWrap': '切换自动换行',
  'commandPalette.item.toggleEditorMinimap': '切换缩略图',
  'commandPalette.item.addCursorAbove': '在上方添加光标',
  'commandPalette.item.addCursorBelow': '在下方添加光标',
  'commandPalette.item.focusPreviousEditorGroup': '聚焦上一个编辑器组',
  'commandPalette.item.focusNextEditorGroup': '聚焦下一个编辑器组',
  'commandPalette.session.untitled': '未命名会话',
  'varinDiagnosticsDialog.title': 'Varin 诊断',
  'varinDiagnosticsDialog.description': '查看当前 Pi 运行时，以及不含凭据的包、插件、会话与项目状态摘要。',
  'varinDiagnosticsDialog.actions.copy': '复制',
  'varinDiagnosticsDialog.actions.refresh': '刷新',
  'varinDiagnosticsDialog.empty.noData': '暂无诊断信息。',
  'varinDiagnosticsDialog.state.collecting': '正在收集诊断信息...',
  'varinDiagnosticsDialog.state.failed': '收集诊断信息失败：{error}',
  'varinDiagnosticsDialog.toast.copiedTitle': '已复制',
  'varinDiagnosticsDialog.toast.copiedDescription': '诊断信息已复制到剪贴板',
  'varinDiagnosticsDialog.toast.copyFailed': '复制诊断信息失败',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 Varin，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Varin',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Varin 服务器之间切换',
  ...
  'multiRun.window.description': 'Varin 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Varin',
  'onboarding.chooser.description': '使用 Varin 内置的 Pi、在设置中选择其他本地安装，或连接远程 Varin 服务器。',
  'onboarding.chooser.tabs.localInstall': '本地工作区',
  'onboarding.chooser.tabs.connectRemote': '连接远程',
  'onboarding.localSetup.title': '本地工作区运行时',
  'onboarding.localSetup.description': 'Varin 已内置 Pi，无需单独安装。默认本地运行时可直接启动；你也可以在设置中选择其他本地安装。',
  'onboarding.localSetup.status.ready': '本地工作区运行时已就绪',
  'onboarding.localSetup.status.readyWithVersion': 'Pi {version} 已就绪',
  'onboarding.localSetup.status.readyDetail': '{source}，位于 {commandPath}',
  'onboarding.localSetup.status.missing': '本地工作区运行时不可用',
  'onboarding.localSetup.status.missingDetail': '所选运行时不可用。请重试或选择其他安装；如果使用的是内置运行时，可重新安装 Varin 进行修复。',
  'onboarding.localSetup.status.upgradeRequired': '当前 Pi 版本过低',
  'onboarding.localSetup.status.upgradeRequiredDetail': '已安装的 {currentVersion} 低于最低要求 {targetVersion}。请升级此安装；Varin 不会降级更新的 Pi。',
  'onboarding.localSetup.status.failed': '本地工作区运行时启动失败',
  'onboarding.localSetup.status.hostEntryUnavailable': 'Varin 安装需要修复',
  'onboarding.localSetup.status.hostEntryUnavailableDetail': '启动工作区运行时所需的应用 Host 文件缺失或无法访问。请重新下载并安装 Varin；升级或改选 Pi 无法修复这些应用文件。',
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': '技术详情',
  'onboarding.localSetup.status.checking': '正在启动工作区运行时',
  'onboarding.localSetup.status.checkingDetail': '正在启动 Varin 工作区运行时…',
  'onboarding.localSetup.status.installing': '正在安装 Pi',
  'onboarding.localSetup.status.upgrading': '正在升级 Pi',
  'onboarding.localSetup.status.discovering': '正在启动工作区运行时',
  'onboarding.localSetup.status.probing': '正在检查工作区运行时',
  'onboarding.localSetup.errors.timeout': '工作区运行时握手超时。请重试，或连接远程服务器。',
  'onboarding.localSetup.errors.managerUnavailable': '当前界面无法管理本地工作区运行时。',
  'onboarding.localSetup.runtime.piVersion': 'Pi',
  'onboarding.localSetup.runtime.hostVersion': 'Varin 主机',
  'onboarding.localSetup.runtime.nodeVersion': 'Node.js',
  'onboarding.localSetup.runtime.source': '来源',
  'onboarding.localSetup.runtime.source.system': '系统',
  'onboarding.localSetup.runtime.source.standalone': '独立安装',
  'onboarding.localSetup.runtime.source.custom': '自定义',
  'onboarding.localSetup.runtime.source.development': '开发',
  'onboarding.localSetup.runtime.source.bundled': 'Varin 内置',
  'onboarding.localSetup.runtime.commandPath': '命令',
  'onboarding.localSetup.actions.continue': '使用本地工作区',
  'onboarding.localSetup.actions.useThisPi': '使用此 Pi',
  'onboarding.localSetup.actions.installPi': '安装 Pi',
  'onboarding.localSetup.actions.upgradePi': '升级 Pi',
  'onboarding.localSetup.actions.selectExisting': '选择已有安装',
  'onboarding.localSetup.actions.retryDetect': '重新检测',
  'onboarding.localSetup.actions.downloadVarinAgain': '重新下载 Varin',
  'onboarding.localSetup.customPath.placeholder': 'Pi 软件包根目录路径',
  'onboarding.localSetup.customPath.apply': '使用此路径',
  'onboarding.localSetup.installPlan.summary': '将通过 {manager} 安装 {version}。',
  'onboarding.localSetup.installPlan.location': '位置：{location}',
  'onboarding.localSetup.actions.continuing': '正在打开…',
  'onboarding.localSetup.actions.checking': '检测中…',
  'onboarding.localSetup.actions.retry': '重试',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Varin 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Varin 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Varin。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Varin，但与此应用版本不兼容。请更新服务器上的 Varin 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Varin。请确认地址是否指向 Varin 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地工作区运行时不可用',
  'onboarding.desktopRecovery.localUnavailable.description': '本地工作区运行时无法启动。请重试运行时，或改为连接远程服务器。',
  'onboarding.desktopRecovery.localUnavailable.retry': '重试本地运行时',
  'onboarding.desktopRecovery.localUnavailable.useLocal': '使用本地运行时',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Varin。请确认地址是否指向 Varin 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Varin 服务器与此应用版本不兼容。请更新服务器上的 Varin 后重试。',
  ...
  'startup.initRecovery.description': 'Varin 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  'startup.initRecovery.retry': '重试',
  'startup.initRecovery.retrying': '重试中…',
  'workbench.recovery.title': '工作台不可用',
  'workbench.recovery.description': '所选工作台 Shell 无法运行。请重新启用其扩展、选择其他配置，或打开扩展设置。',
  'workbench.recovery.reenable': '重新启用 Shell',
  'workbench.recovery.chooseProfile': '选择其他配置',
  'workbench.recovery.openExtensions': '打开扩展',
  ...
  'updateDialog.header.restarting': '正在重启 Varin…',
  'updateDialog.changelog.title': '更新内容',
  'updateDialog.status.installingUpdate': '正在安装更新...',
  'updateDialog.status.serverRestarting': '服务器正在重启...',
  'updateDialog.status.desktopRestarting': '正在重启以安装更新…',
  'updateDialog.status.desktopRestartingHint': 'Varin 正在关闭后台服务并交给安装程序处理，请稍候。',
  ...
  'updateDialog.actions.restarting': '正在重启…',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：varin update',
  ...
  'varinLogo.aria.logo': 'Varin 标志',
  'splash.aria.loading': '正在加载 Varin',
  'splash.aria.switching': '正在切换工作台 Profile',
  'splash.switching': '正在切换工作台',
  'splash.switchingTo': '正在切换到 {profile}',
  'splash.status.startingDesktop': '正在启动桌面外壳',
  'splash.status.connectingRuntime': '正在启动工作区',
  'splash.status.preparingWorkspace': '正在准备工作区',
  'splash.status.desktopFailed': '桌面启动失败，请重启应用。',
  'splash.status.desktopSlow': '启动时间比预期长',
  ...
  'markdownRenderer.code.actions.showCode': '显示代码',
  'markdownRenderer.code.actions.preview': '预览',
  'markdownRenderer.code.actions.previewHtml': '预览 HTML',
  'markdownRenderer.code.actions.downloadHtml': '下载 HTML',
  'markdownRenderer.code.actions.copyCode': '复制代码',
  'markdownRenderer.code.actions.copied': '已复制',
  'markdownRenderer.code.previewTitle': 'HTML 预览',
  'previewToggle.switchToEdit': '切换到编辑模式',
  'previewToggle.switchToPreview': '切换到预览模式',
  'previewToggle.edit': '编辑',
  'previewToggle.preview': '预览',
  'chat.userTextPart.collapse': '折叠',
  'header.actions.openGitSidebar': '打开 Git 侧边栏',
  'header.actions.closeGitSidebar': '关闭 Git 侧边栏',
  ...
  'contextPanel.mode.recovery': '恢复',
  'contextRail.surface.recovery.description': '工作区检查点与对话联合恢复',
  'contextPanel.recovery.combinedUnavailable': '当前会话无法同时回退会话与文件。请启用支持联合撤销的恢复提供方。',
  'contextPanel.recovery.sessionBusy': '请等待当前 Pi 任务结束后再更改历史。',
  'contextPanel.recovery.actions.undo': '撤销',
  'contextPanel.recovery.actions.redo': '重做',
  'contextPanel.recovery.actions.checkpoint': '创建检查点',
  'contextPanel.recovery.checkpoint.placeholder': '检查点名称',
  'contextPanel.recovery.native.openWorkspace': '请打开一个绑定工作区的对话，查看它的恢复时间线。',
  'contextPanel.recovery.native.description': '查看受影响文件检查点、联合恢复操作和按路径撤销。',
  'contextPanel.recovery.native.checkpointDescription': '给当前文件变更时间线添加命名标记，不扫描整个工作区。',
  'contextPanel.recovery.native.operations': '恢复操作',
  'contextPanel.recovery.native.timeline': '工作区时间线',
  'contextPanel.recovery.native.noOperations': '还没有联合恢复操作。',
  'contextPanel.recovery.native.noCheckpoints': '还没有受影响文件检查点。',
  'contextPanel.recovery.native.combinedOperation': '对话与工作区恢复',
  'contextPanel.recovery.native.undoOperation': '恢复撤销',
  'contextPanel.recovery.native.undoConfirm': '撤销这次已完成的恢复，并还原涉及的文件和对话吗？',
  'contextPanel.recovery.native.undoComplete': '恢复操作已撤销',
  'contextPanel.recovery.actions.repair': '修复提示词',
  'contextPanel.recovery.actions.repairTypo': '修复拼写错误',
  'contextPanel.recovery.actions.repairDestructive': '破坏性修复',
  'contextPanel.recovery.toast.failed': '恢复失败：{message}',
  'contextPanel.recovery.toast.applied': '已由 {provider} 完成恢复',
  'contextPanel.recovery.toast.cancelled': '{provider} 已取消恢复',
  'contextPanel.recovery.toast.delegated': '恢复已交给 {provider}；插件会报告最终结果',
  'contextPanel.recovery.destructive.description': '破坏性修复会重写 Pi 会话历史，无法撤销，也不会还原文件或外部副作用。',
  ...
  'walkthrough.blocked.chooseModel': '选择其他模型',
  ...
  'walkthrough.blocked.serverUnsupported.description': '当前连接的 Varin 服务器未响应导读 API。请更新 Varin 后刷新。',
