...
export const dict = {
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Piarium state, OpenCode health, directories, and projects.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Piarium open.',
