...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Piarium for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Piarium installed',
  ...
  'mobile.connect.welcome.title': 'Connect to Piarium',
  ...
  'mobile.connect.password.placeholder': 'Piarium password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Piarium connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Piarium server.',
  ...
  'sessions.sidebar.footer.actions.aboutPiarium': 'About Piarium',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Piarium — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'workbench.ide.run.emptyTasks': 'No tasks are defined. Add a piarium.tasks.json file with a node script.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in Piarium. Download it to open with another app.',
  ...
  'header.services.shutdownDev': 'Stop Piarium',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Piarium needs access to this folder.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Piarium efficiently',
  ...
  'header.actions.openAppMenu': 'Piarium menu',
  'header.actions.openAppMenuAria': 'Open Piarium menu',
  ...
  'piariumDiagnosticsDialog.title': 'Piarium Diagnostics',
  'piariumDiagnosticsDialog.description': 'Inspect the active Pi runtime and a credential-safe summary of packages, plugins, sessions, and project state.',
  'piariumDiagnosticsDialog.actions.copy': 'Copy',
  'piariumDiagnosticsDialog.actions.refresh': 'Refresh',
  'piariumDiagnosticsDialog.empty.noData': 'No diagnostics available.',
  'piariumDiagnosticsDialog.state.collecting': 'Collecting diagnostics...',
  'piariumDiagnosticsDialog.state.failed': 'Failed to collect diagnostics: {error}',
  'piariumDiagnosticsDialog.toast.copiedTitle': 'Copied',
  'piariumDiagnosticsDialog.toast.copiedDescription': 'Diagnostics copied to clipboard',
  'piariumDiagnosticsDialog.toast.copyFailed': 'Failed to copy diagnostics',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Piarium from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Piarium',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Piarium servers',
  ...
  'multiRun.window.description': 'Piarium Multi-Run window.',
  ...
  'onboarding.chooser.description': "Use Pi included with Piarium, choose another local installation in Settings, or connect to a remote Piarium server.",
  ...
  'onboarding.localSetup.description': "Piarium includes Pi, so no separate installation is required. The default local runtime is ready to start; you can choose another local installation in Settings.",
  ...
  'onboarding.localSetup.status.missingDetail': "The selected runtime is unavailable. Retry or choose another installation; if you were using the bundled runtime, reinstall Piarium to repair it.",
  'onboarding.localSetup.status.upgradeRequired': "This Pi is too old",
  'onboarding.localSetup.status.upgradeRequiredDetail': "Installed {currentVersion} is below the minimum {targetVersion}. Upgrade this install; Piarium will not downgrade a newer Pi.",
  'onboarding.localSetup.status.failed': "Local workspace runtime could not start",
  'onboarding.localSetup.status.hostEntryUnavailable': "Piarium installation needs repair",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "The application Host files needed to start the workspace runtime are missing or inaccessible. Download and reinstall Piarium; upgrading or choosing another Pi will not repair them.",
  ...
  'onboarding.localSetup.status.checkingDetail': "Starting the Piarium workspace runtime…",
  ...
  'onboarding.localSetup.runtime.hostVersion': "Piarium host",
  ...
  'onboarding.localSetup.runtime.source.bundled': "Included with Piarium",
  ...
  'onboarding.localSetup.actions.downloadPiariumAgain': "Download Piarium again",
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Piarium server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Piarium server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Piarium version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Piarium but is not compatible with this app version. Update Piarium on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Piarium. Verify the address points to an Piarium server.',
  ...
  'startup.initRecovery.description': 'Piarium could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Piarium...',
  'updateDialog.header.restarting': 'Restarting Piarium…',
  ...
  'updateDialog.status.desktopRestartingHint': 'Piarium is closing background services and handing off to the installer. This may take a moment.',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: piarium update',
  'mobileUpdate.toast.available.title': 'Piarium update available',
  ...
  'piariumLogo.aria.logo': 'Piarium logo',
  'splash.aria.loading': 'Loading Piarium',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The connected Piarium server did not answer the walkthrough API. Update Piarium, then refresh.',
