...
export const dict = {
  ...
  'contextSidebar.section.memory': 'Memory',
  'contextSidebar.memory.effective': 'Effective mode: {mode}',
  'contextSidebar.memory.inherited': 'Using the global setting',
  'contextSidebar.memory.override': 'Session override',
  'contextSidebar.memory.mode.inherit': 'Inherit global setting',
  'contextSidebar.memory.mode.off': 'Off',
  'contextSidebar.memory.mode.assist': 'Maintain and inject (assist)',
  'contextSidebar.memory.mode.takeover': 'Maintain and take over compaction when ready (takeover)',
  'contextSidebar.memory.status.updating': 'Updating memory mode…',
  'contextSidebar.memory.status.updateFailed': 'Could not update memory mode.',
  'contextSidebar.memory.status.keeperFailed': 'Memory keeper failed recently.',
  'contextSidebar.memory.status.compactionFailed': 'Memory compaction failed recently.',
