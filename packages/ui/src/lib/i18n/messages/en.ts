...
export const dict = {
  ...
  'chat.recoveryDialog.noFileChanges': 'This checkpoint has no file changes relative to the current workspace.',
  'chat.recoveryDialog.confirmSelection': 'Continue with selected recovery',
  'chat.recoveryDialog.modeConflict': 'This recovery already started with another option. Close this dialog and choose again.',
