...
export const dict = {
  ...
  'tasksHub.paused': "Paused",
  'tasksHub.completed': "Completed",
  'tasksHub.scheduledDescription': "Let the agent run tasks on your schedule.",
  'followupEditor.create': "New follow-up",
  'followupEditor.edit': "Edit follow-up",
  'followupEditor.description': "Continue in the selected conversation. If the condition is already met, it may resume immediately.",
  'followupEditor.session': "Conversation to continue",
  'followupEditor.chooseSession': "Choose a conversation",
  'followupEditor.noSessions': "Choose an existing conversation linked to a project.",
  'followupEditor.instruction': "What should happen next?",
  'followupEditor.condition': "When to continue",
  'followupEditor.at': "Date and time",
  'followupEditor.path': "Workspace-relative file path",
  'followupEditor.branch': "Branch (blank uses the current branch)",
  'followupEditor.invalidTime': "Choose a valid date and time.",
  'followupEditor.keepSource': "Keep the existing condition",
  'followupEditor.chooseExperiment': "Choose an experiment",
  'followupEditor.kind.time': "At a specified time",
  'followupEditor.kind.file': "File condition",
  'followupEditor.kind.experiment': "Experiment finishes",
  'followupEditor.kind.external': "Pull request status",
  'followupEditor.kind.manual': "Wake manually",
  'followupEditor.file.exists': "File appears",
  'followupEditor.file.changed': "Every file change",
  'followupEditor.file.ready': "File is ready",
  'followupEditor.pr.exists': "PR exists",
  'followupEditor.pr.open': "PR is open",
  'followupEditor.pr.merged': "PR is merged",
  'followupEditor.pr.closed': "PR is closed",
  'tasksHub.title': "Scheduled & follow-ups",
  'tasksHub.scheduled': "Scheduled tasks",
  'tasksHub.followUps': "Follow-ups",
  'tasksHub.followUpsDescription': "Waits across conversations on this host. When the time or condition is met, the original conversation continues.",
  'tasksHub.active': "Waiting",
  'tasksHub.history': "History",
  'tasksHub.search': "Search conditions, instructions or conversations",
  'tasksHub.refresh': "Refresh",
  'tasksHub.empty': "No pending follow-ups. Ask the agent in a conversation to continue at a specified time or when a condition is met.",
  'tasksHub.emptyHistory': "No follow-up history yet.",
  ...
  'research-workbench.mainline': "Research mainline",
  'research-workbench.latestFinding': "Latest result",
  'research-workbench.branchesAndMaterials': "Research branches & materials",
  'research-workbench.retry': "Retry",
  'research-facts.summary': "{attempts} experiment attempts · {machines} machines · {sources} sources",
  'research-facts.attempts': "Experiments",
  'research-facts.machines': "Machines",
  'research-facts.sources': "Sources",
  'research-facts.emptyAttempts': "No experiment attempts recorded.",
  'research-facts.emptyMachines': "No execution targets registered.",
  'research-facts.cancel': "Cancel",
  'research-facts.collect': "Collect",
  'research-facts.capacity': "capacity",
  'research-facts.capacityUnknown': "capacity unknown",
  'research-facts.usage': "usage",
  'research-facts.usageUnread': "usage unread",
  'research-facts.stale': "stale",
  'research-facts.commitments': "{count} commitments",
  'research-facts.queued': "queued",
  'research-facts.sourceRetired': "retired",
  'research-facts.attempt.submitted': "Submitted",
  'research-facts.attempt.queued': "Queued",
  'research-facts.attempt.running': "Running",
  'research-facts.attempt.stopping': "Stopping",
  'research-facts.attempt.completed': "Completed",
  'research-facts.attempt.failed': "Failed",
  'research-facts.attempt.cancelled': "Cancelled",
  'research-facts.attempt.lost': "Lost",
  'research-facts.machine.available': "Available",
  'research-facts.machine.degraded': "Degraded",
  'research-facts.machine.offline': "Offline",
  'research-facts.machine.retired': "Retired",
  'research-facts.connection.connected': "connected",
  'research-facts.connection.degraded': "degraded",
  'research-facts.connection.offline': "offline",
  'research-facts.connection.unknown': "connection unknown",
  'research-facts.collection.pending': "collecting",
  'research-facts.collection.done': "collected",
  'research-facts.collection.failed': "collection failed",
  'research-facts.attempt.unknown': "Unknown state",
  'research-facts.source': "source",
  'research-facts.observedAt': "observed {time}",
  'research-facts.checkedAt': "checked {time}",
  'research-facts.viewDetails': "View details",
  'research-facts.hideDetails': "Hide details",
  'research-facts.loadingDetails': "Loading attempt details…",
  'research-facts.detailsUnavailable': "Attempt details unavailable.",
  'research-facts.logs': "Logs",
  'research-facts.log.stdout': "stdout",
  'research-facts.log.stderr': "stderr",
  'research-facts.loadLog': "Load",
  'research-facts.loadMore': "Load more",
  'research-facts.noLog': "No log output.",
  'research-facts.artifacts': "Artifacts",
  'research-facts.noArtifacts': "No artifacts collected.",
  'research-facts.download': "Download",
  'research-facts.artifactUnavailable': "Unavailable",
  'research-facts.refreshFailed': "Refresh failed; showing the previous facts.",
  'research-facts.target': "target",
  'research-facts.targetSource.desktop-host': "desktop host",
  'research-facts.targetSource.ssh-instance': "SSH instance",
  'research-facts.targetSource.configured-host': "configured host",
  'research-facts.capabilities': "capabilities",
  'research-facts.coordinator': "coordinator Host",
  'research-facts.coordinatorUnavailable': "Coordinator Host is unavailable; queued work needs it online.",
  'research-facts.backend': "backend",
  'research-facts.sourceThread': "source Thread",
  'research-facts.sourceRun': "source Run",
  'research-facts.awaitingCoordinator': "awaiting coordinator",
  'research-facts.remoteAccepted': "Accepted by the remote target; it can continue after this desktop closes.",
  'research-facts.remoteArtifact': "remote",
  'research-facts.remoteUnreachable': "Remote artifact unavailable",
  'research-facts.remoteExpired': "Remote artifact expired",
  'research-facts.targetDetails': "Target details",
  'research-facts.resourceDetails': "Resource details",
  'research-facts.remoteJobsSurviveDisconnect': "Accepted jobs survive client disconnect",
  'research-facts.remoteJobsMayStopWithClient': "Accepted jobs may stop with the client",
  'research-facts.unassignedNeedsCoordinator': "Unassigned work needs the coordinator online",
  'research-facts.unassignedCoordinatorOptional': "Unassigned work does not require this coordinator",
  'research-facts.gpuProbe': "GPU probe",
  'research-facts.selectAttempt': "Select attempt {attempt}",
  'research-facts.executionCwd': "working directory",
  'research-facts.executionRoot': "execution root",
  'research-facts.technicalDetails': "Technical details",
  'research-facts.jobState': "job state",
  'research-facts.retryOf': "retry of",
  'research-facts.rerun': "Rerun",
  'research-facts.selectedCount': "{count} selected",
  'research-facts.cancelSelected': "Cancel selected",
  'research-facts.rerunSelected': "Rerun selected",
  'research-facts.actionFailed': "Action failed",
  'research-facts.unknownTarget': "unknown target",
  'workFocus.label': "Work focus",
  'workFocus.code': "General",
  'workFocus.research': "Research",
  'workFocus.codeDescription': "Coding and everyday tasks, with tools as needed.",
  'workFocus.researchDescription': "Investigate questions, compare explanations, and develop experiments.",
  'workFocus.pending': "Applies to the next run",
  'workFocus.nextTurn': "Changes apply when the next run starts. The current run and its queued follow-ups keep their focus.",
  'workFocus.fromProject': "Captured from the project default when this conversation was created.",
  'workFocus.failed': "Could not apply; still using {focus}. Send again to retry.",
  'workFocus.useProjectDefault': "Use project default: {focus}",
  'workFocus.projectDefault': "Default work focus",
  'workFocus.projectDefaultDescription': "Used by new conversations. Existing conversations keep their own focus.",
  ...
  'harness.overview.description': 'Plan, changes, subtasks, sources, and durable session context.',
  'harness.overview.review': 'Needs your review',
  'harness.overview.reviewCount': '{count} pending',
  'harness.overview.plan': 'Plan',
  'harness.overview.planProgress': '{done}/{total}',
  'harness.overview.outputs': 'Outputs & changes',
  'harness.overview.workspaceChanges': 'Current workspace',
  'harness.overview.outputFiles': '{count} files',
  'harness.overview.outputDiff': '{files} files · +{insertions} −{deletions}',
  'harness.overview.moreItems': '{count} more',
  'harness.overview.viewChanges': 'View changes',
  'harness.overview.pendingThreadChanges': 'Subtask changes',
  'harness.overview.pendingThreadChangesDescription': 'Changes from isolated subtasks that are not yet integrated into the parent workspace.',
  'harness.overview.threads': 'Subtasks',
  'harness.overview.threadsSummary': '{active} active · {completed} completed',
  'harness.overview.sources': 'Sources',
  'harness.overview.memory': 'Memory & decisions',
  'harness.overview.memoryProgress': 'Current progress',
  'harness.overview.memoryDecisions': 'Key decisions',
  'harness.overview.runDetails': 'Run details',
  'harness.overview.summary.attention': '{count} subtasks need attention',
  'harness.overview.summary.blocked': '{count} plan items blocked',
  'harness.overview.summary.running': '{count} subtasks running',
  'harness.overview.summary.plan': 'In progress · {done}/{total} tasks',
  'harness.overview.summary.review': '{count} items waiting for review',
  'harness.overview.summary.done': 'Plan complete · {done}/{total}',
  'harness.overview.summary.changed': '{count} changed files',
  'harness.overview.summary.context': 'Current work context',
  'harness.blocks.title': 'Memory & plan',
  'harness.blocks.edit': 'Edit block',
  'harness.blocks.cancel': 'Cancel',
  'harness.blocks.save': 'Save',
  'harness.blocks.conflict': 'This block changed in the background. The latest version was reloaded; review it before saving again.',
  'harness.knowledge.title': 'Knowledge review',
  'harness.knowledge.scope.workspace': 'Workspace',
  'harness.knowledge.scope.user': 'User',
  'harness.knowledge.content': 'Knowledge content',
  'harness.knowledge.trigger': 'Recall trigger',
  'harness.knowledge.triggerPlaceholder': 'When should this be recalled?',
  'harness.knowledge.supersedes': 'Replace accepted knowledge',
  'harness.knowledge.dismiss': 'Dismiss',
  'harness.knowledge.save': 'Save',
  'harness.knowledge.accept': 'Accept',
  'harness.knowledge.rememberWorkspace': 'Project',
  'harness.knowledge.rememberUser': 'User',
  'harness.knowledge.created': 'Added to knowledge review',
  ...
  'harness.sources.remove': 'Remove source',
  ...
  'harness.pdf.textView': 'Current page text',
  ...
  'harness.threads.discussion': 'Discussion thread',
  'harness.threads.userThread': 'User thread',
  'harness.threads.kind.discussion': 'Discussion',
  'harness.threads.kind.implementation': 'Implementation',
  'harness.threads.convert': 'Convert to implementation',
  'harness.threads.converting': 'Converting…',
  'harness.threads.convertFailed': 'Could not convert the discussion thread',
  'harness.threads.ask': 'Ask',
  'harness.threads.askPlaceholder': 'Ask or direct this thread…',
  'harness.threads.fresh': 'Fresh',
  'harness.threads.note': 'Note',
  'harness.threads.sendFailed': 'Could not deliver the message',
  'harness.threads.peer.user': 'user',
  'harness.threads.peer.session': 'parent session',
  'harness.threads.msg.inform': 'note',
  'harness.threads.msg.request': 'request',
  'harness.threads.msg.held': 'held for the next run',
  'harness.threads.merge': 'Merge result',
  'harness.threads.merging': 'Merging…',
  'harness.threads.mergeFailed': 'Could not merge the thread result',
  'harness.threads.undoMerge': 'Undo editor merge',
  'harness.threads.undoUnavailable': 'The editor merge can no longer be undone',
  'harness.threads.chooseParent': 'Keep parent',
  'harness.threads.chooseChild': 'Use child',
  'harness.threads.chooseBase': 'Use baseline',
  'harness.threads.unavailable': 'Unavailable targets',
  'harness.threads.surfacePending': 'Editor drafts',
  'harness.threads.previewStale': 'This preview is no longer current',
  'harness.threads.previewApplicability': 'Merge preview describes applicability only; it is not a test result.',
  'harness.threads.verification.child': 'Result checks (r{revision})',
  'harness.threads.verification.childEmpty': 'No commands recorded for this result',
  'harness.threads.verification.childUncertain': 'Binding uncertain: {reason}',
  'harness.threads.verification.command': 'exit {code} · {command}',
  'harness.threads.verification.merge': 'Merge applicability',
  'harness.threads.verification.parent': 'Parent checks after merge',
  'harness.threads.verification.parentUnsaved': 'Draft merge did not save; disk commands cannot verify unsaved buffers',
  'harness.threads.verification.parentNone': 'No parent-session check recorded for this merge',
  'harness.threads.verification.review': 'Review (r{revision})',
  'harness.threads.verification.reviewRunning': 'Review running',
  'harness.threads.verification.reviewNone': 'Not reviewed',
  'harness.threads.state.dirty': 'Has unpublished result',
  'chat.messageBody.actions.openThreadAria': 'Open a discussion thread from this message',
  'chat.messageBody.actions.openThread': 'Open a thread from here',
  'chat.messageBody.actions.openThreadWithoutBlocks': 'Open without memory blocks',
  'chat.messageBody.actions.openThreadFailed': 'Could not open a discussion thread from this message',
  ...
  'harness.threads.state.completed': 'Completed',
  'harness.threads.state.failed': 'Failed',
  'harness.threads.state.cancelled': 'Cancelled',
  'harness.threads.state.interrupted': 'Interrupted',
  'harness.threads.state.merge-ready': 'Ready to merge',
  'harness.threads.state.conflict': 'Conflict',
  'harness.threads.state.merged': 'Merged',
  'harness.threads.state.archived': 'Archived',
  'harness.threads.archive': 'Archive',
  'harness.threads.archiving': 'Archiving…',
  'harness.threads.archiveFailed': 'Could not archive the thread',
  'harness.threads.restore': 'Restore',
  'harness.threads.restoring': 'Restoring…',
  'harness.threads.restoreFailed': 'Could not restore the thread',
  'harness.threads.reclaim': 'Reclaim directory',
  'harness.threads.reclaiming': 'Reclaiming…',
  'harness.threads.reclaimFailed': 'Could not reclaim the thread directory',
  'harness.threads.keepWorktree': 'Keep directory',
  ...
  'harness.threads.hideArchived': 'Hide archived',
  'harness.threads.space.title': 'Occupancy',
  'harness.threads.space.bytes': '{bytes} B',
  'harness.threads.space.unknownSize': 'unknown',
  'harness.threads.space.logical': 'Dir {bytes}',
  'harness.threads.space.overBudget': 'Over the configured worktree budget',
  'harness.threads.space.lowFree': 'Free space is below the configured minimum',
  'harness.threads.space.enospc': 'The volume is out of space',
  'harness.threads.space.kept': 'Kept: {reason}',
  'harness.threads.empty': 'No threads in this view',
  'harness.threads.history.open': 'History results',
  'harness.threads.history.title': 'Thread result history',
  'harness.threads.history.loading': 'Loading history results…',
  'harness.threads.history.loadFailed': 'Could not load thread result history',
  'harness.threads.history.retry': 'Retry',
  'harness.threads.history.empty': 'This thread has no native results.',
  'harness.threads.history.revision': 'Result r{revision}',
  'harness.threads.history.select': 'Select result r{revision} for release',
  'harness.threads.history.bytes': '{bytes} B',
  'harness.threads.history.retainedBytesNote': 'Content referenced by this version. Shared content is reclaimed after all references are released.',
  'harness.threads.history.protected': 'Protected: {reasons}',
  'harness.threads.history.protected.branchHead': 'branch head',
  'harness.threads.history.protected.currentResult': 'current result',
  'harness.threads.history.protected.runInput': 'active Run input',
  'harness.threads.history.protected.review': 'review in progress',
  'harness.threads.history.protected.integration': 'pending integration',
  'harness.threads.history.release': 'Release {count} selected',
  'harness.threads.history.releasing': 'Releasing…',
  'harness.threads.history.releaseFailed': 'Could not release selected results',
  'harness.threads.history.confirmTitle': 'Release selected results?',
  'harness.threads.history.confirmDescription': 'Release {count} selected result(s) from this thread?',
  'harness.threads.history.confirmWarning': 'Released versions can no longer be read or merged. Reports, transcripts, and content referenced by other owners are retained.',
  'harness.threads.history.cancel': 'Cancel',
  'harness.threads.history.confirm': 'Release results',
  'harness.threads.history.released': 'Released {count} result(s).',
  'harness.threads.history.missing': '{count} selected result(s) were already missing.',
  'harness.threads.history.cleanupComplete': 'Cleanup removed {objects} object(s) and reclaimed {bytes} B.',
  'harness.threads.history.cleanupFailed': 'History versions were removed; cleanup is incomplete: {message}',
  'harness.threads.history.retryCleanup': 'Retry cleanup',
  ...
  'mobile.connect.welcome.title': 'Connect to Varin',
  ...
  'mobile.connect.password.placeholder': 'Varin password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Varin connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Varin server.',
  ...
  'sessions.sidebar.grouping.generalChat': 'General chat',
  'sessions.sidebar.grouping.recent': 'Recent',
  ...
  'sessions.scheduledTasks.dialog.confirm.deleteLoopFile': 'Delete the loop file for "{taskName}"?',
  'sessions.scheduledTasks.dialog.loopFile.project': 'Project loop',
  'sessions.scheduledTasks.dialog.loopFile.user': 'User loop',
  'sessions.scheduledTasks.loopEditor.title': 'Edit loop',
  'sessions.scheduledTasks.loopEditor.description': 'Edit the authoritative Markdown loop file.',
  'sessions.scheduledTasks.loopEditor.confirmDiscard': 'Discard unsaved loop changes?',
  ...
  'sessions.scheduledTasks.editor.validation.cronInvalid': 'Invalid cron expression',
  ...
  'sessions.scheduledTasks.editor.cronExpression.nextRuns': 'Next runs',
  'sessions.scheduledTasks.editor.cronExpression.examples': 'Examples',
  'sessions.scheduledTasks.editor.cronExpression.examples.every5min': 'Every 5 minutes',
  'sessions.scheduledTasks.editor.cronExpression.examples.everyHour': 'Every hour',
  'sessions.scheduledTasks.editor.cronExpression.examples.monday9am': 'Every Monday at 9am',
  'sessions.scheduledTasks.editor.cronExpression.examples.9am5pm': '9am and 5pm daily',
  'sessions.scheduledTasks.editor.cronExpression.examples.firstOfMonth': 'First of every month',
  ...
  'sessions.sidebar.footer.actions.aboutVarin': 'About Varin',
  ...
  'sessions.sidebar.project.actions.pin': 'Pin to top',
  'sessions.sidebar.project.actions.archiveChats': 'Archive chats',
  'sessions.sidebar.project.actions.remove': 'Remove project',
  'sessions.sidebar.project.reveal.error': 'Could not open the project directory',
  'sessions.sidebar.dialogs.removeProject.title': 'Remove project?',
  'sessions.sidebar.dialogs.removeProject.description': '“{projectTitle}” will be removed from the sidebar. Its chats and files will be kept.',
  ...
  'sessions.sidebar.session.menu.restore': 'Restore session',
  ...
  'sessions.sidebar.session.unarchive.success': 'Session restored',
  'sessions.sidebar.session.unarchive.error': 'Failed to restore session',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Varin — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.splitEditor': 'Split editor',
  'filesView.editor.pinTab': 'Pin tab',
  'filesView.editor.unpinTab': 'Unpin tab',
  'filesView.editor.moveTab': 'Move to other group',
  ...
  'filesView.editor.languageStarting': 'Starting language features…',
  'filesView.editor.languageDegraded': 'Some language features are unavailable: {message}',
  'filesView.editor.languageFailed': 'Language features could not start: {message}',
  'filesView.workspaceEdit.renameTitle': 'Preview rename',
  'filesView.workspaceEdit.actionTitle': 'Preview changes',
  'filesView.workspaceEdit.descriptionSingle': '{count} file will be changed. Review it before applying.',
  'filesView.workspaceEdit.descriptionMany': '{count} files will be changed. Review them before applying.',
  'filesView.workspaceEdit.files': 'Files to change',
  'filesView.workspaceEdit.editCountSingle': '{count} edit',
  'filesView.workspaceEdit.editCountMany': '{count} edits',
  'filesView.workspaceEdit.showFocused': 'Show changed area',
  'filesView.workspaceEdit.showFull': 'Show full file',
  'filesView.workspaceEdit.before': 'Before',
  'filesView.workspaceEdit.after': 'After',
  'filesView.workspaceEdit.noChanges': 'No text changes',
  'filesView.workspaceEdit.apply': 'Apply changes',
  'filesView.workspaceEdit.renameDescription': 'Rename to {name}. Review every affected file before applying.',
  'filesView.workspaceEdit.unavailable': 'No rename or action is available at this location.',
  'filesView.workspaceEdit.stale': 'The document or language provider changed. Try again.',
  'filesView.workspaceEdit.cancelled': 'Changes were not applied.',
  'filesView.workspaceEdit.failed': 'Could not apply language changes',
  'filesView.workspaceEdit.appliedSingle': 'Changed {count} file',
  'filesView.workspaceEdit.appliedMany': 'Changed {count} files',
  'filesView.workspaceEdit.undo': 'Undo',
  'filesView.workspaceEdit.undone': 'Changes undone',
  'filesView.workspaceEdit.undoUnavailable': 'These changes can no longer be undone as one operation.',
  ...
  'workbench.panel.problems': 'Problems',
  'workbench.panel.output': 'Output',
  'workbench.panel.problemsEmpty': 'No problems in this workspace.',
  'workbench.panel.outputEmpty': 'No output channels.',
  'workbench.panel.problemsFailed': 'Problems could not be loaded: {message}',
  'workbench.panel.problemsItem': '{resourceId}: {message}',
  'workbench.panel.problemsItemAtLine': '{resourceId}:{line}: {message}',
  'workbench.panel.problemsOpenAria': 'Open {resourceId}',
  'workbench.panel.outputFailed': 'Output could not be loaded: {message}',
  'workbench.panel.changes': 'Changes',
  'workbench.panel.changesEmpty': 'No Agent or unsaved file changes in this workspace.',
  'workbench.panel.changesOpenAria': 'Open {resourceId}',
  'workbench.panel.changesConflict': 'conflict',
  'workbench.panel.changesDirty': 'unsaved',
  'workbench.panel.changesAgent': 'Agent',
  'workbench.panel.changesOpen': 'open',
  'workbench.panel.changesItem': '{resourceId} · {state} · {revision}',
  'workbench.attachment.chipUnsaved': 'Unsaved snapshot: {name}',
  'workbench.attachment.chipSaved': 'Saved file: {name}',
  'workbench.attachment.chipSelection': 'Selection: {name}',
  'workbench.attachment.chipDiagnostic': 'Problem: {name}',
  'workbench.attachment.chipDiff': 'Diff: {name}',
  'workbench.attachment.attachDiff': 'Attach diff to Agent',
  'workbench.attachment.removeAria': 'Remove {name} from Agent context',
  'workbench.attachment.unsavedBadge': 'unsaved snapshot',
  'workbench.attachment.missing-editor': 'No active editor is available to attach.',
  'workbench.attachment.missing-selection': 'Select text in the editor first.',
  'workbench.attachment.missing-document': 'That document is not open in the workbench.',
  'workbench.attachment.wrong-runtime': 'This attachment belongs to a different Agent runtime.',
  'workbench.attachment.no-session': 'Open an Agent session before attaching editor context.',
  'workbench.patch.acceptHunk': 'Keep hunk',
  'workbench.patch.rejectHunk': 'Revert hunk',
  'workbench.patch.applyAccepted': 'Apply kept hunks',
  'workbench.patch.revertRejected': 'Revert rejected hunks',
  'workbench.patch.written': 'The patch was applied to the editor buffer. Save when you are ready.',
  'workbench.patch.conflict': 'The file has unsaved edits or a newer revision. Resolve the editor conflict first.',
  'workbench.patch.failed': 'The patch could not be applied: {message}',
  'workbench.ide.title': 'IDE Workbench',
  'workbench.ide.activity.explorer': 'Explorer',
  'workbench.ide.activity.search': 'Search',
  'workbench.ide.activity.git': 'Git',
  'workbench.ide.activity.run': 'Run and Test',
  'workbench.ide.activity.extensions': 'Extensions',
  'workbench.ide.activity.explorerAria': 'Show Explorer',
  'workbench.ide.activity.searchAria': 'Show Search',
  'workbench.ide.activity.gitAria': 'Show Git',
  'workbench.ide.activity.runAria': 'Show Run and Test',
  'workbench.ide.activity.extensionsAria': 'Show Extensions',
  'workbench.ide.sidebar.hideSecondary': 'Hide Agent sidebar',
  'workbench.ide.sidebar.showSecondary': 'Show Agent sidebar',
  'workbench.ide.sessions': 'Sessions',
  'workbench.ide.sessionsAria': 'Open session list',
  'workbench.ide.search.placeholder': 'Search files by name',
  'workbench.ide.search.empty': 'No matching files.',
  'workbench.ide.search.failed': 'Search failed: {message}',
  'workbench.ide.search.noWorkspace': 'Open a workspace to search files.',
  'workbench.ide.search.searching': 'Searching...',
  'workbench.ide.search.filesTab': 'Files',
  'workbench.ide.search.contentTab': 'Text',
  'workbench.ide.search.contentPlaceholder': 'Search text in the workspace',
  'workbench.ide.search.contentEmpty': 'No matching text.',
  'workbench.ide.search.contentFailed': 'Text search failed: {message}',
  'workbench.ide.search.contentNoWorkspace': 'Open a workspace to search text.',
  'workbench.ide.search.filesAria': 'Search files by name',
  'workbench.ide.search.contentAria': 'Search text in files',
  'workbench.ide.run.unavailableTitle': 'Run and Test are not available yet',
  'workbench.ide.run.unavailableDescription': 'Debug adapters and test providers ship in a later workbench update. Editing, search, Git, the terminal, and Agent stay available.',
  'workbench.ide.run.noWorkspace': 'Open a workspace to run, debug, and test.',
  'workbench.ide.run.tasks': 'Tasks',
  'workbench.ide.run.runTask': 'Run {label}',
  'workbench.ide.run.emptyTasks': 'No tasks are defined. Add a varin.tasks.json file with a node script.',
  'workbench.ide.run.tasksFailed': 'Tasks could not be loaded: {message}',
  'workbench.ide.run.unsupported': 'Run, debug, and test are not available in this runtime.',
  'workbench.ide.debug.title': 'Debug',
  'workbench.ide.debug.start': 'Start',
  'workbench.ide.debug.stop': 'Stop',
  'workbench.ide.debug.continue': 'Continue',
  'workbench.ide.debug.stepOver': 'Step over',
  'workbench.ide.debug.stepInto': 'Step into',
  'workbench.ide.debug.stepOut': 'Step out',
  'workbench.ide.debug.programAria': 'Program to debug',
  'workbench.ide.debug.paused': 'Paused',
  'workbench.ide.debug.running': 'Running',
  'workbench.ide.debug.failed': 'Debug failed: {message}',
  'workbench.ide.debug.absent': 'No debug session',
  'workbench.ide.debug.breakpoints': 'Breakpoints',
  'workbench.ide.debug.breakpointsEmpty': 'No breakpoints. Toggle a breakpoint from the editor.',
  'workbench.ide.debug.callStack': 'Call stack',
  'workbench.ide.debug.variables': 'Variables',
  'workbench.ide.debug.watch': 'Watch',
  'workbench.ide.debug.watchAdd': 'Add',
  'workbench.ide.debug.watchRemove': 'Remove',
  'workbench.ide.debug.console': 'Debug console',
  'workbench.ide.debug.consolePlaceholder': 'Evaluate an expression',
  'workbench.ide.debug.evaluate': 'Evaluate',
  'workbench.ide.tests.title': 'Tests',
  'workbench.ide.tests.run': 'Run tests',
  'workbench.ide.tests.discover': 'Discover',
  'workbench.ide.tests.empty': 'No tests were found.',
  'workbench.ide.tests.failedLoad': 'Tests could not be loaded: {message}',
  'workbench.ide.tests.failedItem': '{label} failed',
  'workbench.ide.tests.passedItem': '{label} passed',
  'workbench.ide.tests.runningItem': '{label} running',
  'workbench.attachment.chipTestFailure': 'Test failure: {name}',
  'workbench.attachment.chipStack': 'Stack: {name}',
  'workbench.attachment.missing-test': 'No test failure is available to attach.',
  'workbench.attachment.missing-stack': 'No stack frame is available to attach.',
  'workbench.ide.extensions.openSettings': 'Open Extensions settings',
  'workbench.ide.extensions.empty': 'No extensions are loaded.',
  'workbench.ide.status.noWorkspace': 'No workspace',
  'workbench.ide.status.noBranch': 'No branch',
  'workbench.ide.commandPalette': 'Command Palette',
  'workbench.ide.commandPaletteAria': 'Open Command Palette',
  'workbench.ide.settings': 'Settings',
  'workbench.ide.settingsAria': 'Open Settings',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in Varin. Download it to open with another app.',
  ...
  'filesView.document.conflict.title': 'This file changed on disk',
  'filesView.document.conflict.description': 'Your unsaved edits differ from the latest file contents.',
  'filesView.document.conflict.agentDescription': 'The Agent or another process changed this file while you had unsaved edits.',
  'filesView.document.conflict.keepEdits': 'Keep my edits',
  'filesView.document.conflict.reloadDisk': 'Reload from disk',
  'filesView.document.conflict.ancestor': 'Original',
  'filesView.document.conflict.yours': 'Your edits',
  'filesView.document.conflict.disk': 'On disk',
  'filesView.document.conflict.merge': 'Review three-way merge',
  'filesView.document.conflict.acceptOurs': 'Keep mine',
  'filesView.document.conflict.acceptTheirs': 'Take disk',
  'filesView.document.conflict.editHunk': 'Edit merged text',
  'filesView.document.conflict.applyEdited': 'Save edited merge',
  'filesView.document.deleted.title': 'This file was deleted',
  'filesView.document.deleted.description': 'Your unsaved edits are still here. Saving will recreate the file.',
  'filesView.document.outsideWorkspace': 'This path is outside the workspace and cannot be edited here.',
  ...
  'contextSidebar.section.contextPreparation': 'Context preparation',
  'contextSidebar.context.preparation.disabled': 'Background preparation off',
  'contextSidebar.context.candidate.none': 'Idle',
  'contextSidebar.context.candidate.preparing': 'Preparing summary',
  'contextSidebar.context.candidate.ready': 'Summary ready',
  'contextSidebar.context.status.preparationFailed': 'Background preparation failed recently.',
  'contextSidebar.context.status.compactionFailed': 'Compaction submission failed recently.',
  ...
  'contextSidebar.tokens.cacheWrite1h': '1h Cache Write',
  ...
  'header.services.shutdownDev': 'Stop Varin',
  ...
  'chat.followup.status.waiting': 'Waiting',
  'chat.followup.status.triggered': 'Triggered',
  'chat.followup.status.delivered': 'Delivered',
  'chat.followup.status.cancelled': 'Cancelled',
  'chat.followup.status.superseded': 'Superseded',
  'chat.followup.status.unavailable': 'Unavailable',
  'chat.followup.action.check': 'Check',
  'chat.followup.action.checkHint': 'Check the source now without invoking the agent',
  'chat.followup.action.fire': 'Run now',
  'chat.followup.action.fireHint': 'Fire the follow-up and invoke the agent',
  'chat.followup.action.cancel': 'Cancel',
  'chat.followup.action.cancelHint': 'Stop waiting — the watched work keeps running',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Varin needs access to this folder.',
  ...
  'pi.interaction.extensionFallback': 'Pi extension',
  'pi.interaction.trust.description': 'Pi found project-provided extensions and resources in this workspace. Trusting them allows their code to run.',
  'pi.interaction.trust.remember': 'Remember this decision for the workspace',
  'pi.interaction.trust.title': 'Trust project extensions?',
  'pi.interaction.trust.workspace': 'Workspace',
  'aboutDialog.actions.openDiagnostics': 'Open diagnostics',
  'aboutDialog.diagnosticsDescription': 'Inspect the Pi runtime, packages, plugins, sessions, and project context.',
  'aboutDialog.footerNote': 'Made with love for the community',
  'helpDialog.title': 'Keyboard Shortcuts',
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Varin efficiently',
  ...
  'header.actions.openAppMenu': 'Varin menu',
  'header.actions.openAppMenuAria': 'Open Varin menu',
  ...
  'chat.piComposer.sendResultUnknown': 'The connection was lost after sending. The result is unknown; check the session before sending it again.',
  ...
  'chat.timeline.loadFailed': 'The session tree could not be loaded',
  'chat.timeline.retry': 'Retry',
  'chat.timeline.refresh': 'Refresh session tree',
  'chat.timeline.attachmentsUnsupported': 'Remove attachments before opening /tree',
  ...
  'chat.piActivity.title': 'Activity',
  ...
  'commandPalette.item.splitEditor': 'Split Editor',
  'commandPalette.item.splitEditorOrthogonal': 'Split Editor Orthogonal',
  'commandPalette.item.closeEditor': 'Close Editor',
  'commandPalette.item.saveActiveFile': 'Save File',
  'commandPalette.item.saveAllFiles': 'Save All Files',
  'commandPalette.item.findInFile': 'Find in File',
  'commandPalette.item.replaceInFile': 'Replace in File',
  'commandPalette.item.goToLine': 'Go to Line',
  'commandPalette.item.goToSymbol': 'Go to Symbol',
  'commandPalette.item.formatDocument': 'Format Document',
  'commandPalette.item.renameSymbol': 'Rename Symbol',
  'commandPalette.item.quickFix': 'Quick Fix',
  'commandPalette.item.goToDefinition': 'Go to Definition',
  'commandPalette.item.findReferences': 'Find References',
  'commandPalette.item.foldRegion': 'Fold Region',
  'commandPalette.item.unfoldRegion': 'Unfold Region',
  'commandPalette.item.toggleEditorWrap': 'Toggle Line Wrap',
  'commandPalette.item.toggleEditorMinimap': 'Toggle Minimap',
  'commandPalette.item.addCursorAbove': 'Add Cursor Above',
  'commandPalette.item.addCursorBelow': 'Add Cursor Below',
  'commandPalette.item.focusPreviousEditorGroup': 'Focus Previous Editor Group',
  'commandPalette.item.focusNextEditorGroup': 'Focus Next Editor Group',
  'commandPalette.session.untitled': 'Untitled Session',
  'varinDiagnosticsDialog.title': 'Varin Diagnostics',
  'varinDiagnosticsDialog.description': 'Inspect the active Pi runtime and a credential-safe summary of packages, plugins, sessions, and project state.',
  'varinDiagnosticsDialog.actions.copy': 'Copy',
  'varinDiagnosticsDialog.actions.refresh': 'Refresh',
  'varinDiagnosticsDialog.empty.noData': 'No diagnostics available.',
  'varinDiagnosticsDialog.state.collecting': 'Collecting diagnostics...',
  'varinDiagnosticsDialog.state.failed': 'Failed to collect diagnostics: {error}',
  'varinDiagnosticsDialog.toast.copiedTitle': 'Copied',
  'varinDiagnosticsDialog.toast.copiedDescription': 'Diagnostics copied to clipboard',
  'varinDiagnosticsDialog.toast.copyFailed': 'Failed to copy diagnostics',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Varin from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Varin',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Varin servers',
  ...
  'multiRun.window.description': 'Varin Multi-Run window.',
  ...
  'onboarding.chooser.description': "Use Pi included with Varin, choose another local installation in Settings, or connect to a remote Varin server.",
  'onboarding.chooser.tabs.localInstall': "Local workspace",
  'onboarding.chooser.tabs.connectRemote': "Connect Remote",
  'onboarding.localSetup.title': "Local workspace runtime",
  'onboarding.localSetup.description': "Varin includes Pi, so no separate installation is required. The default local runtime is ready to start; you can choose another local installation in Settings.",
  'onboarding.localSetup.status.ready': "Local workspace runtime is ready",
  'onboarding.localSetup.status.readyWithVersion': "Pi {version} is ready",
  'onboarding.localSetup.status.readyDetail': "{source} at {commandPath}",
  'onboarding.localSetup.status.missing': "Local workspace runtime unavailable",
  'onboarding.localSetup.status.missingDetail': "The selected runtime is unavailable. Retry or choose another installation; if you were using the bundled runtime, reinstall Varin to repair it.",
  'onboarding.localSetup.status.upgradeRequired': "This Pi is too old",
  'onboarding.localSetup.status.upgradeRequiredDetail': "Installed {currentVersion} is below the minimum {targetVersion}. Upgrade this install; Varin will not downgrade a newer Pi.",
  'onboarding.localSetup.status.failed': "Local workspace runtime could not start",
  'onboarding.localSetup.status.hostEntryUnavailable': "Varin installation needs repair",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "The application Host files needed to start the workspace runtime are missing or inaccessible. Download and reinstall Varin; upgrading or choosing another Pi will not repair them.",
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "Technical details",
  'onboarding.localSetup.status.checking': "Starting workspace runtime",
  'onboarding.localSetup.status.checkingDetail': "Starting the Varin workspace runtime…",
  'onboarding.localSetup.status.installing': "Installing Pi",
  'onboarding.localSetup.status.upgrading': "Upgrading Pi",
  'onboarding.localSetup.status.discovering': "Starting workspace runtime",
  'onboarding.localSetup.status.probing': "Checking workspace runtime",
  'onboarding.localSetup.errors.timeout': 'Workspace runtime handshake timed out. Retry or connect to a remote server.',
  'onboarding.localSetup.errors.managerUnavailable': "This surface cannot manage the local workspace runtime.",
  'onboarding.localSetup.runtime.piVersion': "Pi",
  'onboarding.localSetup.runtime.hostVersion': "Varin host",
  ...
  'onboarding.localSetup.runtime.source.standalone': "Standalone",
  'onboarding.localSetup.runtime.source.custom': "Custom",
  'onboarding.localSetup.runtime.source.development': "Development",
  'onboarding.localSetup.runtime.source.bundled': "Included with Varin",
  'onboarding.localSetup.runtime.commandPath': "Command",
  'onboarding.localSetup.actions.continue': "Use local workspace",
  'onboarding.localSetup.actions.useThisPi': "Use this Pi",
  'onboarding.localSetup.actions.installPi': "Install Pi",
  'onboarding.localSetup.actions.upgradePi': "Upgrade Pi",
  'onboarding.localSetup.actions.selectExisting': "Choose existing",
  'onboarding.localSetup.actions.retryDetect': "Detect again",
  'onboarding.localSetup.actions.downloadVarinAgain': "Download Varin again",
  'onboarding.localSetup.customPath.placeholder': "Path to a Pi package root",
  'onboarding.localSetup.customPath.apply': "Use path",
  'onboarding.localSetup.installPlan.summary': "Will use {manager} to install {version}.",
  'onboarding.localSetup.installPlan.location': "Location: {location}",
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Varin server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Varin server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Varin version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Varin but is not compatible with this app version. Update Varin on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Varin. Verify the address points to an Varin server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': "Local Workspace Runtime Unavailable",
  'onboarding.desktopRecovery.localUnavailable.description': "The local workspace runtime could not be started. Retry the runtime or connect to a remote server instead.",
  'onboarding.desktopRecovery.localUnavailable.retry': 'Retry Local Runtime',
  'onboarding.desktopRecovery.localUnavailable.useLocal': "Use Local Runtime",
  ...
  'startup.initRecovery.description': 'Varin could not finish initialization. Check that the server is running, then retry.',
  'startup.initRecovery.retry': 'Retry',
  'startup.initRecovery.retrying': 'Retrying…',
  'workbench.recovery.title': 'Workbench unavailable',
  'workbench.recovery.description': 'The selected workbench shell cannot run. Re-enable its extension, choose another profile, or open Extensions settings.',
  'workbench.recovery.reenable': 'Re-enable shell',
  'workbench.recovery.chooseProfile': 'Choose another profile',
  'workbench.recovery.openExtensions': 'Open Extensions',
  ...
  'updateDialog.header.updating': 'Updating Varin...',
  'updateDialog.header.restarting': 'Restarting Varin…',
  ...
  'updateDialog.status.desktopRestarting': 'Restarting to install the update…',
  'updateDialog.status.desktopRestartingHint': 'Varin is closing background services and handing off to the installer. This may take a moment.',
  ...
  'updateDialog.actions.restarting': 'Restarting…',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: varin update',
  'mobileUpdate.toast.available.title': 'Varin update available',
  ...
  'varinLogo.aria.logo': 'Varin logo',
  'splash.aria.loading': 'Loading Varin',
  'splash.aria.switching': 'Switching workbench profile',
  'splash.switching': 'Switching workbench',
  'splash.switchingTo': 'Switching to {profile}',
  'splash.status.startingDesktop': 'Starting the desktop shell',
  'splash.status.connectingRuntime': 'Starting the workspace',
  'splash.status.preparingWorkspace': 'Preparing the workspace',
  'splash.status.desktopFailed': 'Desktop startup failed. Restart the app.',
  'splash.status.desktopSlow': 'Startup is taking longer than expected',
  ...
  'chat.recoveryDialog.description': 'Choose how to handle the affected files before returning the conversation.',
  'chat.recoveryDialog.filesAffected': 'Affected paths',
  'chat.recoveryDialog.reviewRequired': 'Review required',
  'chat.recoveryDialog.incompleteCheckpoint': 'This turn includes shell or external file changes that were not captured before they happened. You can still return the conversation only.',
  ...
  'contextPanel.recovery.native.undoConfirm': 'Undo this completed recovery and restore the affected files and conversation?',
  ...
  'walkthrough.blocked.chooseModel': 'Choose another model',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The connected Varin server did not answer the walkthrough API. Update Varin, then refresh.',
