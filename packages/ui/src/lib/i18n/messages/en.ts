...
export const dict = {
  ...
  'chat.workStatus.title': 'Work status',
  'chat.workStatus.section.session': 'Session',
  'chat.workStatus.section.activity': 'Activity',
  'chat.workStatus.section.pinned': 'Pinned context',
  'chat.workStatus.toolCalls': 'Tool calls',
  'chat.workStatus.tokens': 'Tokens',
  'chat.workStatus.queue': 'Queue',
  'chat.workStatus.state.working': 'Working',
  'chat.workStatus.state.compacting': 'Compacting',
  'chat.workStatus.state.retrying': 'Retrying',
  'chat.workStatus.state.idle': 'Idle',
