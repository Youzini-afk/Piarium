...
export const dict = {
  ...
  'onboarding.localSetup.description': "Piarium uses the Pi runtime installed on this computer. Install or choose one to continue.",
  'onboarding.localSetup.status.ready': "Pi runtime is ready",
  ...
  'onboarding.localSetup.status.missing': "No Pi runtime found",
  'onboarding.localSetup.status.missingDetail': "Install Pi for this user, or choose an existing installation.",
  ...
  'onboarding.localSetup.status.failed': "Pi runtime could not start",
  'onboarding.localSetup.status.hostEntryUnavailable': "Piarium installation needs repair",
  'onboarding.localSetup.status.hostEntryUnavailableDetail': "The application Host files needed to start Pi are missing or inaccessible. Download and reinstall Piarium; upgrading or choosing another Pi will not repair them.",
  'onboarding.localSetup.status.hostEntryUnavailableDiagnostics': "Technical details",
  'onboarding.localSetup.status.checking': "Connecting to Pi runtime",
  'onboarding.localSetup.status.checkingDetail': "Negotiating the Piarium runtime protocol?",
  'onboarding.localSetup.status.installing': "Installing Pi",
  'onboarding.localSetup.status.upgrading': "Upgrading Pi",
  'onboarding.localSetup.status.discovering': "Looking for a Pi runtime",
  'onboarding.localSetup.status.probing': "Checking the Pi runtime",
  'onboarding.localSetup.errors.timeout': 'Pi runtime handshake timed out. Retry or connect to a remote server.',
  'onboarding.localSetup.errors.managerUnavailable': "This surface cannot manage the local Pi runtime.",
  ...
  'onboarding.localSetup.runtime.source.bundled': "Bundled",
  'onboarding.localSetup.runtime.commandPath': "Command",
  'onboarding.localSetup.actions.continue': "Use local Pi",
  ...
  'splash.status.connectingRuntime': 'Connecting to the Pi runtime',
