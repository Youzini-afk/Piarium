 ...
 * payloads must be parsed for paths, and Piarium's own file tree marks an
...
/** Data type marking a drag that started in Piarium's own file tree. */
export const INTERNAL_FILE_PATH_TYPE = 'application/x-piarium-file-path';
