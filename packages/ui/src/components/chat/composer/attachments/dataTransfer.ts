 ...
 * payloads must be parsed for paths, and Varin's own file tree marks an
...
/** Data type marking a drag that started in Varin's own file tree. */
export const INTERNAL_FILE_PATH_TYPE = 'application/x-varin-file-path';
