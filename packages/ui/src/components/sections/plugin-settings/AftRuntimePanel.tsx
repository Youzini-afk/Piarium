  ...
  return (
    <div className="space-y-4 border-t border-border/60 pt-6">
      <SettingsControlGroup
        title={t('settings.varin.pluginSettings.aft.runtime.title')}
        info={t('settings.varin.pluginSettings.aft.runtime.description')}
        contentClassName="space-y-3"
      >
        <div className="flex items-center justify-between gap-3">
          <span className="typography-meta text-muted-foreground">
            {t(`settings.varin.pluginSettings.aft.runtime.state.${state}` as never)}
          </span>
        ...
        {state === 'not-observed' ? (
          <p className="typography-meta text-muted-foreground">
            {t('settings.varin.pluginSettings.aft.runtime.notObserved')}
          </p>
        ) : null}
      </SettingsControlGroup>
    </div>
