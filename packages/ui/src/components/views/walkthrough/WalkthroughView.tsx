...
const WALKTHROUGH_GUIDE_URL = 'https://github.com/Youzini-afk/Piarium/blob/main/packages/web/server/lib/walkthrough/DOCUMENTATION.md';
      ...
      <header className="flex shrink-0 flex-wrap items-center gap-2 border-b border-border/60 px-3 py-2">
        ...
        <div className="ml-auto flex min-w-0 items-center gap-1">
          ...
          {isGeneratingEntry ? (
            ...
            >
              <Icon name={view ? 'refresh' : 'compass-3'} className="size-3.5" />
        ...
        {blockedReason ? (
          <WalkthroughBlocker
            ...
            onSelectModel={(providerId, modelId) => {
              selectModel(directory, source, `${providerId}/${modelId}`);
            }}
          />
        ) : showStages ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-3 p-8 text-center">
            {entry.status === 'loading' ? (
              ...
              <>
                <Icon name="compass-3" className="size-6 text-muted-foreground" />
