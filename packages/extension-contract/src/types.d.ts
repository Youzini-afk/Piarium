export declare const PIARIUM_EXTENSION_MANIFEST_SCHEMA_VERSION: 1;
export declare const PIARIUM_EXTENSION_CATALOG_SCHEMA_VERSION: 1;
export declare const PIARIUM_EXTENSION_MANIFEST_FILE: "piarium.extension.json";
...
export type PiariumContextExpressionV1 = {
    ...
    op: "equals";
    key: string;
    value: PiariumContextValue;
} | {
    op: "not";
    expression: PiariumContextExpressionV1;
} | {
    op: "all" | "any";
    expressions: PiariumContextExpressionV1[];
};
...
export type PiariumExtensionActivationEvent = "application-startup" | "background" | "command" | "contribution-visible" | "service-request" | "workspace-match";
...
export type PiariumExtensionContributionKind = "command" | "composer-action" | "editor" | "keybinding" | "menu-item" | "message-renderer" | "page" | "panel" | "session-decoration" | "settings-page" | "shell" | "sidebar" | "status-item" | "transition-scene" | "tool-renderer" | "view";
...
export type PiariumExtensionActualStatus = "active" | "activating" | "deactivating" | "failed" | "inactive" | "loading" | "resolving" | "restart-required" | "rolling-back" | "updating" | "waiting";
