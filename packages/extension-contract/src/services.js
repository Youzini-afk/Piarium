...
export const PIARIUM_EDITOR_MONACO_SERVICE_VERSION = 1;
export const PIARIUM_WORKSPACE_RECOVERY_SERVICE_VERSION = 5;
export const PIARIUM_CORE_SERVICE_VERSION = 1;
