...
export type PiariumEditorDocumentApplyEditsResult = {
    snapshot: PiariumEditorDocumentSnapshot;
    status: "applied";
} | {
    snapshot: PiariumEditorDocumentSnapshot;
    status: "conflict";
...
export interface PiariumEditorDocumentController {
    applyEdits(edits: readonly PiariumEditorDocumentEdit[], expectedDocumentVersion: number): Promise<PiariumEditorDocumentApplyEditsResult>;
...
export type PiariumEditorMonacoAbsentReasonV1 = "provider-inactive" | "registration-unavailable" | "view-unavailable";
export type PiariumEditorMonacoStaleReasonV1 = "document-version-changed" | "owner-generation-changed" | "view-generation-changed" | "view-unavailable";
export type PiariumEditorMonacoUnsupportedReasonV1 = "action-unavailable" | "operation-unavailable";
export type PiariumEditorMonacoFailureResultV1 = {
    reason: PiariumEditorMonacoAbsentReasonV1;
    status: "absent";
} | {
    reason: PiariumEditorMonacoStaleReasonV1;
    status: "stale";
} | {
    reason: PiariumEditorMonacoUnsupportedReasonV1;
    status: "unsupported";
};
...
export type PiariumEditorMonacoStateResultV1 = {
    state: PiariumEditorMonacoStateSnapshotV1;
    status: "ready";
} | PiariumEditorMonacoFailureResultV1;
export type PiariumEditorMonacoOperationResultV1 = PiariumEditorMonacoFailureResultV1 | {
...
export interface PiariumEditorMonacoServiceV1 {
    clearDecorations(request: PiariumEditorMonacoClearDecorationsRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoOperationResultV1>;
    executeAction(request: PiariumEditorMonacoExecuteActionRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoOperationResultV1>;
    focus(request?: PiariumEditorMonacoViewRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoOperationResultV1>;
    ...
    getView(request?: PiariumEditorMonacoViewRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoViewResultV1>;
    reveal(request: PiariumEditorMonacoRevealRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoOperationResultV1>;
    setDecorations(request: PiariumEditorMonacoSetDecorationsRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoOperationResultV1>;
    setSelection(request: PiariumEditorMonacoSetSelectionRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoOperationResultV1>;
    waitForState(request: PiariumEditorMonacoWaitForStateRequestV1): PiariumEditorMonacoMaybePromise<PiariumEditorMonacoStateResultV1>;
}
