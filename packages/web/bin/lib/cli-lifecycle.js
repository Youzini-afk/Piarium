...
async function discoverRunningInstances(options = {}) {
  ...
  const getProcessState = typeof options.getPiariumProcessState === 'function'
    ...
    : (pid) => getPiariumProcessState(pid, options);
  try {
...
async function discoverPiariumInstanceOnPort(port, options = {}) {
...
async function discoverLifecycleInstances(options = {}, deps = {}) {
  ...
  const liveInstance = await discoverPiariumInstanceOnPort(options.port, {
    ...deps,
    host: options.host,
    runningInstances,
  });
