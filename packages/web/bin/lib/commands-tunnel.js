      ...
      if (rejectDesktopRuntime) {
        ...
        if (!attachability.attachable) {
          if (attachability.reason === 'desktop') {
            throw new Error(
              `Port ${options.port} is used by Piarium Desktop app. Tunnel attach requires a CLI instance from \`piarium serve\`.`
            );
          }
          throw new Error(
            `Port ${options.port} is not an attachable Piarium tunnel instance. Ensure it is healthy and running Piarium CLI runtime.`
          );
        }
      }
      return found;
