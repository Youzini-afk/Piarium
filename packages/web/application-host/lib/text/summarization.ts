...
export function sanitizeForTTS(text: unknown): string {
...
function sanitizeForNotification(text: unknown): string {
  if (!text || typeof text !== 'string') return '';
...
export function sanitizeForNote(text: unknown): string {
  if (!text || typeof text !== 'string') return '';
...
function sanitizeByMode(text: unknown, mode: string): string {
...
function distillNoteFallback(text: unknown, maxLength: number): string {
...
function distillNotificationFallback(text: unknown, maxLength: number): string {
...
function fallbackByMode(text: unknown, maxLength: number, mode: string): string {
