...
import type { WalkthroughLanguage, WalkthroughSource } from './types.js';
...
const PROMPT_INPUT: Parameters<typeof buildPrompt>[0] = {
  digest: { files: [] },
  fileCount: 1,
  hunkCount: 1,
  source: SOURCE,
...
const keyFor = (language: WalkthroughLanguage) => buildCacheKey({
  repoRoot: '/repo',
