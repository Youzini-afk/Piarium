...
export const createWebLanguageServicesAPI = (): LanguageServicesAPI => ({
  ...
  hover: (request) => feature<string>('hover', request),
  definition: (request) => feature<PiariumLanguageLocation[]>('definition', request),
  ...
  rename: (request) => feature<PiariumLanguageLocation[]>('rename', request),
